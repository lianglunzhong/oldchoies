...
rangeInput.change(options.onChange);
    ...
    jQuery(document).click(function(){
        if (rp.is(':visible')) {
            var rp_active = rp.find('li.ui-state-active');
            if( (rp_active.is('.ui-daterangepicker-dateRange') || rp_active.is('.ui-daterangepicker-specificDate') || rp_active.is('.ui-daterangepicker-allDatesBefore') || rp_active.is('.ui-daterangepicker-allDatesAfter')) ){            
                options.onRangeComplete();
            }
            hideRP();
        }
