...
<div>
    ...
    <form class="adminform" method="post" id="adminform" name="manager_add_form" action="<?php echo url::current(); ?>">
	...
	<p class="submit">
	    <input type="submit" name="submit" class="button-primary" value="Sign in" tabindex="100" />
	</p>
    </form>
</div>
