...
<div id="do_right">
        <div class="box">
                <h3>Freetrial Reports Edit</h3>
                <form method="post" action="#" name="ptype_add_form" class="need_validation">
                        <ul>
                                <li>
                                        <label>Sku<span class="req">*</span></label>
                                        <div><input id="sku" name="sku" value="<?php echo Product::instance($report['product_id'])->get('sku'); ?>" class="short text required" type="text"></div>
                                </li>
                                
                                <li>
                                        <label>Name<span class="req">*</span></label>
                                        <div><input id="name" name="name" value="<?php echo $report['name']; ?>" class="short text required" type="text"></div>
                                </li>
                                
                                <li>
                                        <label>Age<span class="req">*</span></label>
                                        <div><input id="age" name="age" value="<?php echo $report['age']; ?>" class="short text required" type="text"></div>
                                </li>
                                
                                <li>
                                        <label>Profession<span class="req">*</span></label>
                                        <div><input id="profession" name="profession" value="<?php echo $report['profession']; ?>" class="short text required" type="text"></div>
                                </li>
                                
                                <li>
                                        <label>Comments<span class="req">*</span></label>
                                        <div><textarea id="comments" name="comments" cols="50" rows="10" class="short text required" type="text"><?php echo $report['comments']; ?></textarea></div>
                                </li>
                                ...
                                <li>
                                        ...
                                        <div id="image_preview" style="margin-bottom:15px;">
                                                <div>
                                                <img src="<?php echo 'http://' . Site::instance()->get('domain') . '/simages/' . $report['image']; ?>" />
                                                </div>
                                        </div>
