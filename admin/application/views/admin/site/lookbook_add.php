                ...
                <form method="post" action="#" name="ptype_add_form" class="need_validation">
                        <ul>
                                <li>
                                        ...
                                        <div><input id="name" name="lookbook[title]" class="short text required" type="text"></div>
                                </li>
                                ...
                                <li>
                                        ...
                                        <div>
                                                <input type="radio" checked="checked" value="1" name="lookbook[visibility]" class="radio"> Visible
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" value="0" name="lookbook[visibility]" class="radio"> Invisible
                                        </div>
                                </li>
