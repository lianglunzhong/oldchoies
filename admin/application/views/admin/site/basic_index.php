...
<div id="do_right">
    <div class="box">
        ...
        <form action="/admin/site/basic/index" method="post" name="form1" id="form1" class="need_validation">
            <ul>
                <li>
                ...
                <li>
                    <label>Line:</label>
                    <div>
                        <select id="slt-line" name="line_id">
                            <option value="0">-- select a product line --</option>
                            <?php foreach ($lines as $line): ?>
                            <option value="<?php print $line->id; ?>" <?php if ($site->line_id == $line->id){print 'selected="selected"'; } ?>><?php print $line->name; ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </li>
				 <li>
                    <label>Secure:</label>
                    <div style="margin-top:2px;"><input type="checkbox" id="ssl" name="ssl" value="1" <?php echo $site->ssl == 1 ? 'checked' : ''; ?>> <label class="note">SSL</label></div>
                </li>
                <!--li>
				...
				<li>
                    ...
                    <div><input class="medium text" type="text" id="forum_moderators" name="forum_moderators" value="<?php echo $site->forum_moderators;?>"> <label class="note">User ID, separated by "<strong style="color:blue;">,</strong>"</label></div>
                </li>
                <li>
