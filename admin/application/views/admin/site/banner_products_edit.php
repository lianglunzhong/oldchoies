...
<script type="text/javascript">
  $(function(){
        jQuery("#toolbar").jqGrid({
            url:'/admin/site/banner/data',
            datatype: "json",
            height: 450,
            width: 800,
            colNames:['ID','product_id','sku','mark_name','created'],
            colModel:[
                {name:'id',index:'id', width:40},
                {name:'product_id',index:'product_id', width:60},
                {name:'sku',index:'sku', width:150},
...
<table id="toolbar"></table>
        ...
        <h3>Products Add</h3>
            ...
            <form enctype="multipart/form-data" method="post" action="/admin/site/banner/products_edit" class="lang_hidden">
