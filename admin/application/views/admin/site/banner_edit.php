...
<script type="text/javascript">
    config = {};
    config['image_tempfolder'] = 'http://<?php echo Site::instance()->get('domain'); ?>/uploads/1/simages/';
    config['catalog_id'] = '';
            ...
            <ul>
                ...
                <li>
                    ...
                    <div id="image_preview" style="margin-bottom:15px;">
                        <div>
                            ...
                            <img src="<?php echo '/file.php?path=simages&name=8_' . $banner['image']; ?>" style="display:none;" />
                        </div>
                    </div>
	           ...
	           <li>
                ...
                <li>
                    ...
                    <div>
                        <textarea name="map" id="map" rows="6" cols="60" class="textarea"><?php echo $banner['map']; ?></textarea>
                    </div>
                </li>
