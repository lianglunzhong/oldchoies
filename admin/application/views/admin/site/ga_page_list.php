...
<div id="do_right">
        <h3>Google Analytics Page Views<span style="float:right;">FROM: <?php echo $date_start . ' TO ' . $date_end; ?></span></h3>
        ...
        <table id="orderline-list">
                ...
                <?php foreach ($data as $metric => $val): ?>
                        <tr>
                                ...
                                <td><?php print $val['ga:pageviews']; ?></td>
                                <td><?php print $val['ga:uniquePageviews']; ?></td>
        ...
        <fieldset>
                ...
                <form id="frm-customer-export" method="post" action="/admin/site/ga/page_export">
