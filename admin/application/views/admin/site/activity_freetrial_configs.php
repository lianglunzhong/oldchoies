...
<script type="text/javascript">
        $(function(){
                jQuery("#toolbar").jqGrid({
                        url:'/admin/site/activity/freetrial_configs_data',
                        datatype: "json",
                        height: 480,
                        width: 1100,
                        colNames:['ID','Products','Chances','End time','Winners','Created','Action'],
                        colModel:[
                                {name:'id',index:'id', width:30},
                                {name:'products',index:'products', width:100},
                                {name:'chances',index:'chances',width:100},
                ...
                $('.edit').live('click',function(){
                        ...
                        $.post(
                                '/admin/site/activity/freetrial_configs_ajaxdata',
                                {
                                        id: id
                                },
                                function(data)
...
<div id="do_right">
        ...
        <div class="box" style="overflow:hidden;">
                <h3>Freetrial Configs List</h3>
                <br/>
                <fieldset>
                        <legend style="font-weight:bold">Add Celebrity Fee</legend>
                        <div>
                                <form action="/admin/site/activity/freetrial_config_add" method="post" class="need_validation" id="fee_add">
                                        <label for="products">Products: </label>
                                        <input type="text" class="text required" id="products" name="products" style="width: 20%;">
                                        &nbsp;&nbsp;<label for="chances">Chances: </label>
                                        <input type="text" class="text small required" id="chances"  name="chances">
                                ...
                                <div id="cboxContent" style="float: left; width: 344px; height: 370px;">
                                        <div id="cboxLoadedContent" style="display: block; width: 344px; overflow: auto; height: 375px;">
                                                <div style="padding:10px; background:#fff;" id="inline_example2">
                                                        <h4>Edit Freetrial Config:</h4>
                                                        <form action="/admin/site/activity/freetrial_config_edit" method="post">
                                                                ...
                                                                <ul>
                                                                        ...
                                                                        <li>
                                                                                <label>Chances: </label>
                                                                                <input type="text" class="text required" id="chances1" name="chances" style="width: 20%;">
                                                                        </li>
                                                                        <li>
                                                                                <label>Winners: </label>
