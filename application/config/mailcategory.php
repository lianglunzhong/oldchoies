    ...
    'en' => array
            (
                ...
                '6' =>array
                    ...
                    'content'=>'<p>Welcome to {site_link} !</p><p>Valued Subscriber,</p><p>Thanks for signing up for the {site} Newsletter,&nbsp;from which&nbsp;you will find the latest style, great discount, gift idea and more. <br />&nbsp;<br />Here is a <strong>10% discount code: {discount_num}(Expiration date: {expiration_date})</strong>,</p><p>which will save you 10% of the price for the products.</p><p>To make sure you can receive our mails to your inbox but not spam box, please add us to your mailing list.</p><p>If you have any questions, please feel free to contact us through {server_email_link}.</p><p>Yours sincerely,</p><p>{site} Customer Service</p>',
                    'add_time'=>1259042481,
                    'is_default'=>1,
                    'active'=>1,
                    ),
