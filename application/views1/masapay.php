                            ...
                            <div class="shipping-information">
                                ...
                                <div class="payment-wrap">
                                    <div class="payment-p">
                                        ...
                                        <form id="ipay" action="/payment/masapay_inner_pay" method="post">
            ...
            <ul>
                ...
                <li class="states2">
                    ...
                    foreach ($stateArr as $country => $states)
                    {
                        ...
                        ?>
                        <div class="all2 JS_drop" id="all2_<?php echo $country; ?>" style="<?php if($billAddress['country']!=$country){echo 'display:none;';}else{$onshow = 1;}?>">
                            <select  class="select-style col-xs-12 col-md-9 s_state" >
                                ...
                                foreach ($states as $coun => $state)
                                {
                                    if (is_array($state))
                                    {
                                        ...
                                        {
                                            ?>
                                            <option value="<?php echo $s; ?>" <?php  if($s == $billAddress['state'])echo "selected='selected';"?> > <?php echo $s; ?></option>
                                            <?php
                                        }
                                        echo '</optgroup>';
                                    }
                                    ...
                                    {
                                        ?>
                                        <option value="<?php echo $state; ?>" <?php  if($state == $billAddress['state'])echo "selected='selected'"?> ><?php echo $state; ?></option>
                                        <?php
                                    }
                                }
                                ?>
                    ...
                    <input type="text" class="text col-xs-12 col-md-9" id="state" name="state" value="<?php if($onshow)echo $billAddress['state'];?>" style="<?php if($onshow)echo 'display:none;';?>">
