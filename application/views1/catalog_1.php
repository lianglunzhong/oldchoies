...
<div class="site-content">
    <div class="main-container clearfix">
        <div class="container">
            <div class="crumbs">
                <div class="fll">
                    <a href="<?php echo LANGPATH; ?>/" class="home"><?php echo $lists['home']; ?></a>
                    <?php
            ...
            ?>
                ...
                <div class="font18 mt20 ml20 hide" id="no_result"><?php echo $lists['Sorry, no results found']; ?></div>
...
<!--                             <?php if ($product_inf['type'] != 0): ?>
                            ...
                            <div class="add_to_wishlist" data-product="<?php echo $product_id; ?>">
                                <a class="wish-title" data-reveal-id="myModal2" id="wish1_<?php echo $product_id; ?>"><?php echo $lists['Add to wishlist']; ?>
                                <i class="fa fa-heart add_wishlist" id="wish_<?php echo $product_id; ?>"></i></a>
                            </div>
                            <?php }else{ ?>
                            <div class="add_to_wishlist" data-product="<?php echo $product_id; ?>">
                                <a class="wish-title" id="wish1_<?php echo $product_id; ?>"><?php echo $lists['Add to wishlist']; ?>
                                <i class="fa fa-heart add_wishlist" id="wish_<?php echo $product_id; ?>"></i></a>
                            </div>
                            <?php } ?>
                            </div>
                            <div class="sign-warp" id="sc_<?php echo $product_id; ?>">
                                ...
                                <div class="wishlist_success">
                                    ...
                                    <p class="wish"><i class="fa fa-heart"></i><?php echo $lists['Wishlist']; ?></p>
                                </div>
                            </div>
                            <?php
                            $onsale = 0;
                            ...
                            if($product_inf['status']>0 and$product_inf['instock']>0)
                            {
                                $onsale = 1;
                            }
                            ...
                            if ($onsale == 0)
                            {
                                echo '<span class="outstock">'. $lists["Sold Out"]. '</span>';
                            }
                            else
                            {
            ...
            {
                ?>
                <div class="font18 mt20"><?php echo $lists['Sorry, no results found'];?></div>
                <?php
            }
        }
        ?>
                ...
                $.each(product,function(i,pdata){
                    ...
                    <li class="pro-item col-xs-6 col-sm-3">\
                        ...
                        product_li += '<div class="add_to_wishlist" data-product="' + pdata['product_id'] + '">\
                            <a class="wish-title" data-reveal-id="myModal2" id="wish1_' + pdata['product_id'] + '">'+"<?php echo $lists['Add to wishlist'];?>"+' <i class="fa fa-heart add_wishlist" id="wish_' + pdata['product_id'] + '"></i></a></div>';

                        <?php }else{ ?>
                        product_li +=  
                            '<div class="add_to_wishlist" data-product="' + pdata['product_id'] + '">\
                                <a class="wish-title" id="wish1_' + pdata['product_id'] + '">'+"<?php echo $lists['Add to wishlist'];?>"+' \
                        ...
                        if(pdata['mark']=='outstock'){
                            product_li += '<span class="outstock">'+"<?php echo $lists['Sold Out'];?>"+'</span>';
            ...
            success: function(res){
                for(var p in res){
                    if(res[p]){
                        ...
                        if(res[p]=='outstock')
                        {
                            $("#mark_"+p).html("<?php echo $lists['out of stock'];?>");
                        }
                    }
                }
            }
                ...
                success:function(rs){
                    if(rs.success == 1)
                    {
                        ...
                        var str="";
                         ...
                         str +="<a href='"+"<?php echo LANGPATH;?>"+"/customer/summary'>My Account</a>";
                         str +="</dd>";
                         str +="<dd class='drop-down-option'>";
                         str +="<a href='"+"<?php echo LANGPATH;?>"+"/customer/orders'>My Order</a>";
                         str +="</dd>";
                         str +="<dd class='drop-down-option'>";
                         str +="<a href='"+"<?php echo LANGPATH;?>"+"/tracks/track_order'>Track Order</a>";
                         str +="</dd>";
                         str +="<dd class='drop-down-option'>";
                         str +="<a href='"+"<?php echo LANGPATH;?>"+"/customer/wishlist'>My Wishlist</a>";
                         str +="</dd>";
                         str +="<dd class='drop-down-option'>";
                         str +="<a href='"+"<?php echo LANGPATH;?>"+"/customer/profile'>My Profile</a>";
                         str +="</dd>";
                         str +="<dd class='drop-down-option'>";
                         str +="<a href='"+"<?php echo LANGPATH;?>"+"/customer/logout'>Sign Out</a>";
                         str +="</dd></dl></li>";
...
<script type="text/javascript">
    $(function(){
        ...
        $(".pagination_div").find("a").live('click', function(){
            ...
            if(typeof page_url != 'undefined')
            {
                ...
                // var current_url = '<?php //echo BASEURL ; ?>' + path + page_url;
                var current_url = 'https://' + host + path + page_url;
                var type = 'init';
                var size_value = '';
    ...
    {
        $(".loading").show();
        var lang_url = '<?php echo LANGPATH; ?>';
            ...
            success: function(filters){
                ...
                for(color in filters['color'])
                {
                    if(color && filters['color'][color] > 0)
                    {
                        ...
                        {
                            trans_color = filters['color_names'][color];
                        }else {
                            trans_color = color;
                        }
