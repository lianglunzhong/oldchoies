    ...
    <div class="container">
        <div class="crumbs">
            <div>
                ...
                <a href="<?php echo LANGPATH; ?>/customer/summary"> > Личный кабинет</a> > Редактировать ваш адрес
            </div>
...
<?php echo View::factory(LANGPATH .'/customer/left_1'); ?>
        ...
        <em style="display:block;">Если вы не используете Индекс в вашем регионе, пожалуйста, введите 0000 вместо.</em>
                            ...
                            <li>
                                <label class="col-sm-3 xs-hidden">&nbsp;</label>
                                <div class="btn-grid12 col-sm-9 col-xs-12">
                                    <input class="btn btn-primary btn-sm" type="submit" value="Сохранить и добавить новый адрес">
                                    <input class="btn btn-default btn-sm" type="reset" value="Отмена">
                                </div>
                            </li>
                        </ul>
                    </form>
