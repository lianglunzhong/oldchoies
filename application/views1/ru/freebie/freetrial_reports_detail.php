                ...
                <div class="report_details fix">
                    ...
                    <div class="right">
                        <div class="right_top">
                            ...
                            <span>Товар#: <?php echo $product->get('sku'); ?></span>
                            <p class="price">Цена: <?php echo Site::instance()->price($product->price(), 'code_view'); ?> <a href="<?php echo $product->permalink(); ?>" class="view_btn btn26 btn40">КУПИТЬ СЕЙЧАС</a></p>
                        </div>
                        <div class="right_trial">
                            <div class="right_tit"><h4>Отчеты испытания</h4></div>
                            <div class="right_con">
