                ...
                <div class="bottom fix">
                    ...
                    <div class="flr">
                        <span class="share flr">
                            ...
                            $domain = URLSTR;
                            ?>
                            <a target="_blank" href="http://twitter.com/share?url=https%3A%2F%2F<?php echo $domain; ?>%2Fproduct%2F<?php echo $product->get('link'); ?>" class="a1"></a>
                            <a target="_blank" href="http://www.facebook.com/sharer.php?u=https%3A%2F%2F<?php echo $domain; ?>%2Fproduct%2F<?php echo $product->get('link'); ?>" class="a2"></a>
