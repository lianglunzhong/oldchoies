                ...
                <div class="container">
                    <div class="crumbs">
                        <div class="fll">
                            ...
                            <a href="<?php echo BASEURL ;?>/apparels" rel="nofollow">Шоу Покупателей</a>&gt; 
        ...
        <?php echo message::get(); ?>
                ...
                ?>                  
                 ...
                 <form action="<?php echo LANGPATH; ?>/customer/login" method="post" class="form form1 user_form" id="loginForm">
                            <input type="hidden" value="<?php echo BASEURL . '/lookbook/' . $c_images['id'] . '-1#pagefocus'; ?>" name="referer">
                                    <ul>
                                        <li>
                                            <div>
                                        ...
                                        <li>
                                            <a class="facebook-btn" href="https://www.facebook.com/dialog/oauth?client_id=274338969357670&redirect_uri=https%3A%2F%2F<?php echo URLSTR; ?>%2F&state=1520f2d6acc5f5f2f6f7ea4e936dde9c&scope=email"></a>
                                        </li>
                                    </ul>
                                </form>
                        <script>
