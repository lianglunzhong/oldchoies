...
?>
        <section id="main">
            ...
            <p>Если у вас есть свой аккаунт на youtube, где баннер не допускается, вы можете использовать нашу ссылку <a href="<?php echo LANGPATH; ?>/" title="choies.com" class="red"> <?php echo BASEURL ;?></a> .</p>
                        </div>
