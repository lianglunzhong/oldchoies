                    ...
                    <div class="step-nav step-nav1">
                        <ul class="clearfix">
                           <li>Модные программы<em></em><i></i></li>
                            ...
                            <li class="current">Представить информацию<em></em><i></i></li>
    ...
    <?php echo Message::get(); ?>
            <article class="row blogger-form">
                ...
                <div class="col-sm-8 col-xs-12">
                    <div class="fashion-tit">Представить информацию</div>
                    <div>
                        <div class="sub-info">
                            <form class="form" id="submitInfo" method="post" action="">
                                <ul>
                                    <li>
                                        <label class="col-sm-2 col-xs-12"><span>*</span> Адрес Электронной Почты:</label>
                                    ...
                                    <li>
                                        <label class="col-sm-2 col-xs-12"><span>*</span> Пол:</label>
                                        <div class="col-sm-7 col-xs-12">
                                    ...
                                    <li>
                                        <label class="col-sm-2 col-xs-12"><span>*</span>  Страна:</label>
                                        <div class="col-sm-7 col-xs-12">
                                    ...
                                    <li>
                                        <table id="tab" class="col-xs-12">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <label class="col-sm-2 col-xs-12"><span>*</span> Тип Основной Сайта: </label>
                                                        <div class="col-sm-7 col-xs-12">
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="col-sm-2 col-xs-12"><span>*</span> URL Основной Сайта:  </label>
                                                        <div class="col-sm-5 col-xs-12">
                                                            <input type="text" class="sub-info-text col-xs-12" name="sites[url][]" id="url">
                                                        </div>
                                                        <label class="col-sm-2 col-xs-12"><span>*</span>  Поклонники/ Последователи: </label>
                                    ...
                                    <li style="margin-top:0;">
                                        ...
                                        <div class="col-sm-7 col-xs-12">
                                            <input type="button" onclick="AddNewRow()" value="Добавить еще один сайт" class="add-more" name="Submit">
                                        </div>
                                    ...
                                    <li>
                                        <label class="col-sm-2 col-xs-12"><span>*</span> Сообщение:</label>
                                        <div class="col-sm-7 col-xs-12">
                                            <textarea onfocus="this.value=(this.value=='Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!')?'':this.value" value="Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!" onblur="this.value=(this.value=='')?'Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!':this.value"
                                            class="input textarea sub-info-text3 col-xs-12" rows="10" id="input_comment" name="comment">Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!</textarea>
                                        </div>
                                    </li>
                                    <li>
                                        <label class="col-sm-2 col-xs-12"></label>
                                        <div class="col-sm-7 col-xs-12">
                                            <input type="submit" value="ДАЛЬШЕ" class="btn btn-primary btn-lg" id="inforSubmit">
                                        </div>
                                        <label class="col-sm-3 hidden-xs"></label>
                                    </li>
                                </ul>
...
<div class="clsbtn close-btn3" style="right: 3px;top: 3px;"></div>
        ...
        function findObj(theObj, theDoc) {
                ...
                function AddNewRow() {
                    ...
                    for (var i = 0; i < columnLength1; i++) {
                        if (i == 0) {//第一列:序号
                            newTR1.insertCell(i).innerHTML = "<label class='col-sm-2 col-xs-12'><span>*</span>URL Основной Сайта:</label><div class='col-sm-5 col-xs-12'><input type='text' id='url_"+i+"' name='sites[url][]' class='sub-info-text col-xs-12'></div><label class='col-sm-2 col-xs-12'><span>*</span>Поклонники/ Последователи:</label><div class='col-sm-2 col-xs-12'><input id='flow_"+i+"' class='sub-info-text col-xs-12' type='text' name='sites[flow][]'></div><div align='left' class='col-sm-1 col-xs-12'><a style='color:black;text-decoration:underline;' href='javascript:' onclick=\"DeleteSignRow('SignItem" + (rowID+1) + "')\">Удалить</a></div>";
                        } 
                    }
                    //将行号推进下一行
        ...
        <script>
            ...
            $("#submitInfo").validate({
                ...
                $('#catalog_link').show();
                var message = '<h3>Извините!</h3><p>этот электронной почты был использован.</p>';
                ...
                $('#catalog_link').appendTo('body').fadeIn(320);
                $('#catalog_link').show();
                var message = '<h3>Спасибо!</h3><p>Мы свяжемся с Вами в течение одной недели после того, как вы отправите заявку.</p>';
                $('.fashion_thank').html(message);
                setTimeout(function() {
                $("#submitInfo").submit();
                }, 3000);
