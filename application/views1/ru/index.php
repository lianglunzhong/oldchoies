        ...
        <div class="container container-xs">
            ...
            <div class="index-fashion hidden-xs">
                <div class="fashion-top w-tit">
                    <h2><a href="<?php echo LANGPATH;?>/lookbook"><span><b>FASHION </b>Шоу наших покупателей</span></a></h2>
                </div>
            ...
            <div class="features">
                <div class="fashion-top w-tit">
                    <h2><a href=""><span class="mr5">CHOIES'</span><span><b> ОСОБЕННЫЕ РЕКОМЕНДУЕМЫЕ</b></span> </a></h2>
                </div>
                <div class="phone-fashion-top w-tit">
                    <h2>Особенные Рекомендуемые</h2>
                </div>
                <div class="row">
			...
			<table class="phone-hot">
				<tbody>
					<tr>
						<td class="col-xs-6"><a href="/ru/choies-design-c-607"><img src="<?php echo STATICURL; ?>/assets/images/ru/1512/home-phone1-12-1.jpg"></a></td>
						<td class="col-xs-6"><a href="/ru/activity/flash_sale"><img src="<?php echo STATICURL; ?>/assets/images/ru/1512/home-phone2-12-1.jpg"></a></td>
					</tr>
					<tr>
						<td class="col-xs-6"><a href="/ru/knitwear-sweaters-c-619"><img src="<?php echo STATICURL; ?>/assets/images/phone-home-ru3.jpg"></a></td>
						<td class="col-xs-6"><a href="/ru/hottest-newbies-c-809"><img src="<?php echo STATICURL; ?>/assets/images/phone-home-ru4.jpg"></a></td>
					</tr>
					<tr>
						<td class="col-xs-6"><a href="/ru/coats-jackets-c-45"><img src="<?php echo STATICURL; ?>/assets/images/phone-home-ru5.jpg"></a></td>
						<td class="col-xs-6"><a href="/ru/party-dresses-c-205"><img src="<?php echo STATICURL; ?>/assets/images/phone-home-ru6.jpg"></a></td>
					</tr>
				</tbody>
			</table>
			<!-- HIGHLY RECOMMEND TAB页切换 -->
			<div class="phone-recommend mt10">
				<h2 >НАСТОЯТЕЛЬНО РЕКОМЕНДУЮ</h2>
				<div class="pr-tab">
					<nav>
  ...
  foreach ($banners as $k=>$banner)
                {
                    $a = $k+1; ?>
        ga('ec:addPromo',{
          'name': '<?php echo $banner["title"]; ?>',  // Promotion Name - Type: string 
          'position': 'banner_<?php echo $a; ?>' // Position of the creative ad - Type: string
        });


   <?php         }  ?>

function onPromoClick(a,b) {
  ga('ec:addPromo', {
  'name': a,  // Promotion Name - Type: string
  'position': b // Position of the creative ad - Type: string
 
  });

ga('ec:setAction', 'promo_click');
ga('send', 'event', 'Internal Promotions', 'click', a);
    ...
    $(function(){
        if(winWidth <= 768)
        {
            $(".buys-show").removeClass('buys-show');
        }
    })
</script>