    ...
    <div class="container">
      <div class="homecoming-top">
            ...
            <div class="back-to-school-filter ">
               ...
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=709"><li class=" current" style="margin-left:13%;"><span>Топ</span></li></a>
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=710"><li class=""><span>Боттомс</span></li></a>
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=711"><li class=""><span>Платье</span></li></a>
                    <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=712"><li class=""><span>Обувь</span></li></a>
                    <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=713"><li class=""><span>Аксессуары</span></li></a>
                </ul>                     
          </div>    
        </div>  
	  <div class="pro-list">
