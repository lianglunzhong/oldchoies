                            ...
                            <div class="vote-box col-xs-12 col-sm-6">
                                ...
                                <div class=" vote-sub">
                                    ...
                                    <div class="sns clearfix mt20 mb20" style="line-height:32px; text-transform:uppercase">
                                        <div style="display:inline-block; margin-right:10px;"><a rel="nofollow" href="http://pinterest.com/pin/create/button/?url=<?php echo BASEURL ;?>/activity/model_vote&media=http://cloud.choies.com/assets/images/activity/votepin.jpg&description=Vote To Get Rewarded!" target="_blank" class="sns5"></a>pinterest</div>
                                        <div style="display:inline-block"><a rel="nofollow" href="http://www.facebook.com/sharer.php?u=https%3A%2F%2F<?php echo URLSTR; ?>%2Factivity%2Fmodel_vote" target="_blank" class="sns1"></a>facebook</div>
                                    </div>
