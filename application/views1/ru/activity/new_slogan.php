            ...
            $("#sloganForm").validate({
                ...
                <div class="lp_vote_share">
                    ...
                    <div>Share to Get More Chances to Win a FREE ITEM: 
                        <a target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo urlencode(BASEURL.'/activity/new_slogan'); ?>" class="a1">facebook</a>
                        <a target="_blank" href="http://twitter.com/share?url=<?php echo urlencode(BASEURL.'/activity/new_slogan'); ?>" class="a2">twitter</a>
                        <a target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(BASEURL.'/activity/new_slogan'); ?>&media=<?php echo BASEURL ;?>/images/activity/slogan_img.jpg&description=New slogan" class="a3">pinterest</a></div>
