        ...
        <section id="container" class="flr">
            ...
            <div class="fix find">
                <div>
                    ...
                    <a href="<?php echo BASEURL; ?>/find-something" target="_blank"><img src="<?php echo STATICURL; ?>/ximg/activity/end_2.jpg" alt="Find Something" style="display:block;" border="0" title="Find Something"/></a>
                    <a href="<?php echo BASEURL; ?>/find-something" target="_blank"><img src="<?php echo STATICURL; ?>/ximg/activity/end_3.jpg" alt="Find Something" title="Find Something" style="display:block;" border="0"/></a>
                    <a href="<?php echo BASEURL; ?>/find-something" target="_blank"><img src="<?php echo STATICURL; ?>/ximg/activity/end_4.jpg" alt="Find Something" title="Find Something" style="display:block;" border="0"/></a>
