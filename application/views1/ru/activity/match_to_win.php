                                                            ...
                                                            <li>
                                                                    ...
                                                                    <div class="share_con">
                                                                            <p>
                                                                                    <b>Share to:</b>
                    <?php $domain = URLSTR; ?>
                                                                                    <a rel="nofollow" target="_blank" class="share1"  href="http://www.facebook.com/sharer.php?u=<?php echo urlencode(BASEURL.'/activity/matchtowin'); ?>"> FACEBOOK</a>
                                                                                    <a rel="nofollow" target="_blank" class="share2"  href="http://twitter.com/share?url=<?php echo urlencode(BASEURL.'/activity/matchtowin'); ?>"> TWITTER</a>
                                                                                    <a rel="nofollow" target="_blank" class="share3"  href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(BASEURL.'/activity/matchtowin'); ?>&media=<?php echo BASEURL ;?>/images/activity/match_img1.jpg&description=<?php echo urlencode("Choies \"Let's Play & Win\" Season 2 --- Play the game and win free items + points ! Don't miss it!"); ?>"> PIN IT</a>
                                                                            </p>
