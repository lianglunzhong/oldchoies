        ...
        <section id="container" class="flr">
                        ...
                        <div class="pinToWin">
                                ...
                                <div class=" rules">
                                        ...
                                        <p>2. Pin 5 hottest summer items in your opinion from <a href="<?php echo LANGPATH; ?>/summer-new-in-2" target="_blank"><?php echo BASEURL ;?>/summer-new-in-2</a> to your " Choies Summer Wishlist" Board, add #choies to every item you pin (<em> P.S.</em> Please remember this board can only contain 5 items from <a href="<?php echo LANGPATH; ?>/summer-new-in-2" target="_blank"><?php echo BASEURL ;?>/summer-new-in-2</a> and don't repin items from other pinners, hope you could kindly understand.)</p>
