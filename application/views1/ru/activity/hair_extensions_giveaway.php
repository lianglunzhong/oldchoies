                                        ...
                                        <form id="giveawayForm" method="post" action="" class="formArea pl90">
                                                ...
                                                <div class="shareto mt10">
                                                        <div class="fix mt15 ml10">
                                                                ...
                                                                <div class="fll mr10 ml5"><span class="shareto3 fll"></span><a rel="nofollow" target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(BASEURL'/activity/hair_extensions_giveaway'); ?>&media=<?php echo BASEURL ;?>/images/activity/giveaway1.jpg&description=giveaway"> PIN IT</a></div>
                                                        </div>
