...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Home</a>  >  Thanksgiving Sale</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
                        ...
                        <div class="lp_thanksgiving">
                                <p><img src="<?php echo STATICURL; ?>/ximg/activity/thanksgiving_ad.jpg" /></p>
                                <div class="tit">
                                        <div class="titcon" id="Z_TMAIL_SIDER_V2">
                                                <img src="<?php echo STATICURL; ?>/ximg/activity/thanksgiving_tit.png" border="0" usemap="#Map" />
                                                <map name="Map" id="Map">
