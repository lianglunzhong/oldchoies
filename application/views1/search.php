...
if(empty(LANGUAGE))
{
    $lists = Kohana::config('/search/search.en');
}
else
{
    $lists = Kohana::config('/search/search.'.LANGUAGE);
}
$gets = array();
...
<div class="site-content">
    <div class="main-container clearfix">
        <div class="container">
            <div class="crumbs">
                <div class="fll">
                    ...
                    &gt;<span><?php echo $lists['Search'];?> : <strong><?php echo $keywords; ?></strong></span>
                </div>
            </div>
            <div class="list-main">
                    ...
                    <ul class="bar-r">
                        <li class=" item-r pick">
                            ...
                            if (!empty($gets1))
                            {
                                ...
                                $gets1[] = 'pick=1';
                            ?>
                            <a href="<?php echo '?' . Security::xss_clean(implode('&', $gets1)); ?>" class=""> <?php echo $lists['Icon\'s Pick'];?></a>
                        </li>
        ...
        <div class="other-customers" id="alsoview" style="display:none">
            <div class="w-tit">
                <h2><?php echo $lists['Recommended Products'];?></h2>
            </div>
            <div class="box-dibu1">
