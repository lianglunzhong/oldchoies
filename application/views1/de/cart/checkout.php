        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="step-nav">
                        <ul class="clearfix">
                            <li class="current">Bestellung Aufgeben<em></em><i></i></li>
                            <li style="padding-left:15px;">Bezahlen<em></em><i></i></li>
                            <li style="padding-left:15px;">Erfolgreich<em></em><i></i></li>
                        </ul>
                    </div>  
                </div>
            </div>
    ...
    <form action="<?php echo LANGPATH; ?>/cart/edit_shipping" method="post" class="form payment-form" onsubmit="return setShipping(this);">
        ...
        <div class="shipping-methods s_price_list">
            <ul class="clearfix">
                ...
                {
                    $name1 = '10-15 Arbeitstage Standard Versand';
                    $site_shipping[1]['name'] = $name1;
                    $name2 = '4-7 Arbeitstage Express Versand';
            ...
            <p><input type="submit" value="BESTÄTIGEN" class="btn btn-default"></p>
        </div>
    </form>
</div>
                    ...
                    <div class="shipping-information">
                        ...
                        <div id="shippingAddressInfo" <?php if (!$show_address) echo 'style="display:none;"'; ?>>
                            <div class="information-con">
                                ...
                                ?>
                                    <dt>
                                        Lieferadresse  <a href="javascript:;" class="red"  data-reveal-id="myModal10" onclick="return edit_address(<?php echo $cart['shipping_address']['shipping_address_id']; ?>, 1);">Editieren</a>
                                        <?php
                                        if($count_address > 1)
                                        {
                                        ?>
                                            <a href="javascript:;" class="red" onclick="return change_address_show();">Wechseln</a>
                                        <?php
                                        }
                                        ?>
                                    </dt>
                                    ...
                                    <dd><label>Adresse:</label><span><?php echo $cart['shipping_address']['shipping_address'] . ' ' . $cart['shipping_address']['shipping_city'] . ', ' . $cart['shipping_address']['shipping_state'] . ' ' . $shipping_country . ' ' . $cart['shipping_address']['shipping_zip']; ?></span></dd>
                                <?php
                                }
                                ?>
                                </dl>
                                <dl class="col-xs-12 col-md-6">
                                    <dt>Versandarten <!--   <a href="#" class="red JS-popwinbtn2" id="ship_edit" <?php //if(in_array($cart['shipping_address']['shipping_country'], $no_express_countries)) echo 'style="display:none;"'; ?>>Editieren</a> --></dt>
                ...
                <input type="hidden" id="shipping_price" value="<?php echo $default_shipping; ?>" name="shipping_price" />
                                    ...
                                    <dd id="shipping_price_list_<?php echo $key; ?>" <?php if(in_array($cart['shipping_address']['shipping_country'], $no_express_countries) && $key==2) echo 'style="display:none;"'; ?>
                                      ...
                                      /*  }*/
                                        ...
                                        <dd id="aaab">
                                            ...
                                            <div class="method">    
                                                <p style="width:78%;">Versandversicherung für  Ihre Bestellung Hinzufügen</p> 
                                                <p style="width:20%;"><?php echo Site::instance()->price(0.99, 'code_view'); ?></p>
                                                <div class="insurance cs-show">
                                                    <b>Warum Versandversicherung wichtig ist?</b>
                                                    <div class="ins-info cs-list" >
                                                        <b class="arrow-up"></b>
                                                        <div class="ins-tipscon">Versandversicherung schützt Ihre Güter gegen Verlust  und Beschädigung unterwegs. Wir werden Ihr Paket sofort kostenlos erneut versenden, wenn es  verloren oder beschädigt war.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <form action="" method="post" name="shipping_address_radio">
                                        ...
                                        <li id="address_li_<?php echo $value['id']; ?>">
                                            <div class="clearfix">
                                                ...
                                                <label for="radio<?php echo $key; ?>">
                                                    ...
                                                    {
                                                        ?>
                                                            <p class="col-md-4 col-sm-12"><span class="b address-detault" id="detault_<?php echo $value['id']; ?>">Default</span>
                                                            <a href="javascript:;" class="a-underline address-detault-a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);" style="display:none;">Als Default festlegen</a></p>
                                                            <p class="col-md-8 col-sm-12"><a href="javascript:;" class="btn btn-primary btn-sm"  data-reveal-id="myModal10" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Editieren</a>
                                                            <a href="javascript:;" class="btn btn-default btn-sm"  data-reveal-id="myModal6" onclick="delete_address(<?php echo $value['id']; ?>);">Löschen</a></p>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                            <p class="col-md-4 col-sm-12"><span class="b address-detault" id="detault_<?php echo $value['id']; ?>" style="display:none;">Default</span>
                                                            <a href="javascript:;" class="a-underline address-detault-a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);">Als Default festlegen</a></p>
                                                            <p class="col-md-8 col-sm-12"><a href="javascript:;" class="btn btn-primary btn-sm" data-reveal-id="myModal10" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Editieren</a>
                                                            <a href="javascript:;" class="btn btn-default btn-sm"  data-reveal-id="myModal6" onclick="delete_address(<?php echo $value['id']; ?>);">Löschen</a></p>
                                                        <?php
                                                    }
                                    ...
                                    <ul class="shipping-address">
                                        <li class="clearfix last">
                                            <a href="javascript:;" class="a-underline" id="add_new_address"  data-reveal-id="myModal10" onclick="return new_address_show();">+NEUE ADRESSE HINZUFÜGEN</a>
                                        </li>
                                    </ul>
                                    </form>
                                </dd>
                        ...
                        <div class="address-fill" id="shippingAddressFill" <?php if($has_address) echo 'style="display:none;";' ?>>
                            ...
                            <form action="" method="post" class="form payment-form form2" onsubmit="return update_address(this);">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div>
                                            ...
                                            <label class="a1 error" style="display:none;"  generated="true" id="guo_con1"></label>
                                    ...
                                    <li class="states2">
                                        ...
                                        foreach ($stateCalled as $name => $called)
                                        {
                                            ...
                                            <div class="col-xs-12 col-md-3 call2" id="call2_<?php echo $name; ?>" <?php if ($name != 'Default') echo 'style="display:none;"'; ?>>
                                                <label for="state"><span>*</span> <font id="">Bundesland / Provinz</font>:</label>
                                            </div>
                                            <?php
                                        }
                                        ...
                                        <div class="" id="all2_default">
                                            ...
                                            <label class="error a3" style="display:none;"  generated="true" id="guo_don1">Bitte wählen Sie ihr Land.</label>
                                        </div>
                                        <script>
                                            ...
                                            function changeSelectCountry1(){
                                                ...
                                                {   
                                                    ...
                                                    var aa = $("#guo_con1");
                                                        aa.show();
                                                    aa.html('請輸入中文地址(Bitte geben Sie die Adresse auf Chinesisch ein.)');
                                                }
                                                else
                                                {
                                                    $("#shipping_cpf").hide();
                                    ...
                                    <li>
                                        ...
                                        <label class="error a4" style="display:none;" generated="true" id="guo_eon1">Stadt / Ort mit Ziffern? Bitte überprüfen Sie es noch einmal.</label>
                                    </li>
                                    <li>
                                        ...
                                        <label class="error" style="display:none;" generated="true" id="guo_fon1">Es scheint, dass es keine Ziffern in der PLZ gibt, überprüfen Sie sie bitte erneut.</label>
                                        <p class="phone_tips phone-t">Bitte geben Sie Ihre Postleitzahl ein (oder 0000, wenn keine Postleitzahl in Ihrem Land erforderlich ist).</p>  
                                    </li>
                                    <li>
                                ...
                                <div class="shipping-methods">
                                    ...
                                    <li class="col-xs-12">
                                                    <div class="method">
                                                        ...
                                                        <p class="me-wt">Versandversicherung für  Ihre Bestellung Hinzufügen</p> 
                                ...
                                <p><input id="spgInfoCountinue" type="submit" value="BESTÄTIGEN" class="btn btn-primary btn-lg"></p>
                            </form>
                        </div>
                    </div>
                        ...
                        <form id="payment_form" method="post" action="" class="form">
                            ...
                            ?>
                                ...
                                <dd class="shipping-infor" id="ideal" <?php if($cart['shipping_address']['shipping_country'] != 'NL') echo 'style="display:none;";' ?>>                              
                                 ...
                                 <h2 class="visible-xs-block hidden-sm hidden-md hidden-lg">GUTSCHEINE UND PUNKTE</h2>
                                    <div class="promo-choies visible-xs-block hidden-sm hidden-md hidden-lg" style="background:none;">
                                    <ul>
                                        <li class="promo-code">
                                            <div class="pc-apply">
                                                <div class="ml10">
                                                    <span class="fll" style="font-weight:bold;">Gutschein Code Verwenden&nbsp;&nbsp;</span> 
                                        ...
                                        <li class="promo-code">
                                            <div class="pc-apply">
                                                <div class="ml10">
                                                    <span style="font-weight:bold;">Choies Punkte Verwenden</span>
                                                    <span>(10 Punkte=$0.1)</span>
                                               ...
                                               <?php
                                                if ($points_avail >= 0){
                                                    ?>
                                                        ...
                                                        Punkte können für diese Zeit verwendet werden.
                                                   <?php
                                               }else{
                                             ...
                                             <script type="text/javascript">
                                                ...
                                                function point_redeem()
                                                {
                                                    ...
                                                    if (points > <?php print $points_avail; ?>) {
                                                        indow.alert('Nicht genug Punkte zur Verfügung stellen');
                                                        return false;
                                                    }
                                                    else
                                                    {
                                ...
                                <ul class="total visible-xs-block hidden-sm hidden-md hidden-lg">
                                    <li class="font14">
                                        ...
                                        <span>
                                           <?php 
                                            if(isset($savearray['product_amount']))
                                            {
...
<span id="totalPrice" class="font18"><?php echo $cart['amount']['shipping'] ? Site::instance()->price($cart['amount']['total'] + $insurance, 'code_view') : Site::instance()->price($cart['amount']['total'] + $default_shipping + $insurance, 'code_view'); ?>
                            ...
                            <p class="mt20">
                                <input type="submit" class="btn btn-primary btn-lg" id="checkoutbtn" value="Bestätigen und Bezahlen" onclick="return btn_loading();">
                                <div id="loadingbtn" style="display:none;">
                                    <button type="button" class="btn btn-primary btn-lg" disabled="disabled">Bestätigen und Bezahlen</button>
                ...
                <div class="col-xs-12 col-sm-4 col-sm-offset-1 hidden-xs">
                    <div class="order-summary">
                        ...
                        foreach (array_reverse($cart['products']) as $key => $product):
                            ...
                            <li class="clearfix">
                                ...
                                <div class="right">
                                    ...
                                    <p class="color666">Artikel: #<?php echo $sku; ?></p>
                                    ...
                                    <p>
                                        ...
                                        if (isset($product['attributes'])):
                                            foreach ($product['attributes'] as $attribute => $option):
                                                ...
                                                $option = str_replace('one size', 'eine Größe', $option);
                                    ...
                                    <p>Menge: <?php echo $product['quantity']; ?></p>
                                </div>
                            </li>
                            <?php
                        ...
                        <ul class="total">
                            <li class="font14"><label>Teilsumme: </label>
                            <span>
                                <?php 
                                if(isset($savearray['product_amount']))
                                {
                            ...
                            <li><label>Verpackung & Versand: </label><span id="shipping_total_pc"><?php echo $cart_shipping == -1 ? Site::instance()->price($site_shipping[2]['price'], 'code_view') : Site::instance()->price($cart_shipping, 'code_view'); ?></span></li>
                        <li class="last" id="oii_insurance_pc" <?php  if($session_insurance == -1) echo 'style="display:none;"'; ?>>
                            ...
                            <li id="coupon_points_save_pc" <?php if(!$coupon_points_save) echo 'style="display:none;"'; ?>>
                                <label>Gutscheine & Punkte eingelöst: </label><span id="save_total_pc"><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span>
                            </li>
                            <?php
                            $saving = $cart['amount']['items'] + $cart['amount']['shipping'] - $cart['amount']['total'];
                            $item_saving = round($saving - $cart['amount']['coupon_save'] - $cart['amount']['point'], 2);
                       ...
                       <?php
                            ...
                            if($saving <= 0)
                                $saving = 0;
                            ?>
                            <li class="last red"><label>Sparend: </label><span id="cart_saving_pc"><?php echo Site::instance()->price($saving, 'code_view'); ?></span></li>
                            <li class="total-num font14"><label>Gesamtbetrag: </label>
                      <?php  if($session_insurance != -1){ 
                                    $insurance = 0.99;
                                  }else{
                                    $insurance = 0;
                        ...
                        <div class="promo-choies">
                                  ...
                                  <span style="display:inline-block;">
                                        ...
                                        <div class="pc-ibutton">
                                            <form method="post" action="<?php echo LANGPATH; ?>/cart/set_coupon" onsubmit="return setCoupon();">
                                                ...
                                                <button type="submit" class="btn btn-default btn-xs fll">BEWERBEN</button>
                                            </form>
                                            <!-- <a class="J-pop-btn a-underline flr">Codeliste</a> -->
                                            <!-- codelist_con -->
                            ...
                            <span style="font-weight:bold;">Choies Punkte Verwenden</span>
                                                    <span>(10 Punkte=$0.1)</span>
                                        <!-- <a href="javascript:;" title="Use it Now">Verwenden </a> -->
                                        ...
                                        <div class="pc-ibutton">
                                            <form method="post" action="<?php echo LANGPATH; ?>/cart/point" class="form" id="point_form" onsubmit="return setPoints();">
                                                ...
                                                <button type="submit" class="btn btn-default btn-xs fll" onclick="return point_redeem();">EINLÖSEN</button>
                                            </form>
                                            <div class="clearfix"></div>
                                            <div class="points-info" style="font-size:11px;">
                                            <!-- Speichern: <span class="red">$ <span id="dollar">0</span></span><br> -->
                                                ...
                                                ?>
                                                <br>
                                                <!-- <a class="a-underline JS-popwinbtn" style="display: inline;">VIP Politik</a> -->
                                            </div>
                                            <script type="text/javascript">
                                                var xhr = null;
                                                var amount_left = $('#amount_left').text();
                        ...
                        <div class="additional-payment mt20">
                            <form action="<?php echo LANGPATH; ?>/cart/set_message" method="post" class="form user-message" onsubmit="return setMessage();">
                                ...
                                <b>Nachricht:</b>
                                <br /><label style="color:#878787;height:20px;">(5-100 Zeichen)</label>
                                <div class="right-box">
                                <?php
                                ...
                                ?>
                                    ...
                                    <a href="javascript:;" onclick="editMessage();" id="message_edit" style="text-decoration: underline;<?php if(!$cart_message) echo 'display:none;'; ?>">Editieren</a>
                                    <button class="btn btn-default btn-xs mt10" type="submit" id="message_submit" <?php if($cart_message) echo 'style="display:none;"'; ?>>SENDEN</button>
                                </div>
                            </form>
                            <p class="mt10">
                                Zusätzliche Zahlungssicherheit mit:
                            </p>
...
<div id="myModal10" class="reveal-modal large">
    ...
    <div class="address-fill">
        ...
        <form onsubmit="return update_address(this);" method="post" class="form payment-form form1">
            ...
            <ul>
                ...
                <li class="states2">
                    ...
                    <div id="all2_default">
                        ...
                        <div class="errorInfo"></div>
                        <label class="error a3" style="display:none;"  generated="true" id="guo_don">Bundesland / Provinz mit Ziffern? Bitte überprüfen Sie es noch einmal.</label>
                    </div>
                    <script>
                ...
                <li>
                    ...
                    <p class="mt5 col-md-offset-3 col-xs-12 col-md-9 phone_tips">Bitte geben Sie Ihre Postleitzahl ein (oder 0000, wenn keine Postleitzahl in Ihrem Land erforderlich ist).</p>
                </li>
                <li>
                    <label class="col-xs-12 col-md-3"><span>*</span> Telefon:</label>
            ...
            <p class="col-md-offset-3 col-xs-12 col-md-9"><input type="submit" value="BESTÄTIGEN" class="btn btn-default"></p>
        </form>
    </div>
</div>
<!-- JS-popwincon3 -->
<div id="myModal6" class="reveal-modal medium" id="cart_delete">
    ...
    <div class="order-addtobag">
        <div class="prompt">Sind Sie sicher, dass Sie diese Adresse löschen wollen? Es kann nicht rückgängig gemacht werden.</div>
            ...
            success: function(result){
                if(result.success == 1){
                    ...
                    if(result.count_address > 1)
                        change = '<a href="javascript:;" class="red" onclick="change_address_show();">Wechseln</a>';
                    var shipping_address_list = '<dt>Lieferadresse  <a href="javascript:;" class="red"  data-reveal-id="myModal10" onclick="return edit_address('+result.address_id+');">Editieren</a>'+change+'</dt>'+
                                                ...
                                                '<label for="radio'+result.count_address+'">'+
                                                    ...
                                                    '<div class="flr">'+
                                                        '<span class="b address_detault" id="detault_'+result.address_id+'" style="display:none;">Default</span>'+
                                                            '<a href="javascript:;" class="a_underline address_detault_a" id="address_detault_'+result.address_id+'" onclick="default_address('+result.address_id+');">Als Default festlegen</a>'+
                                                            '<a href="javascript:;" class="view_btn btn40"  data-reveal-id="myModal10" onclick="edit_address('+result.address_id+', 1);">Editieren</a>'+
                                                            '<a href="javascript:;" class="view_btn btn26 delete_address" data-reveal-id="myModal6" onclick="delete_address('+result.address_id+');">Löschen</a>'+
                                                    '</div>'+
                                                ...
                                                '<label for="radio'+result.count_address+'">'+
                                                    ...
                                                    '<div class="flr">'+
                                                        '<span class="b address-detault" id="detault_'+result.address_id+'" style="display:none;">Default</span>'+
                                                            '<a href="javascript:;" class="a-underline address-detault-a" id="address_detault_'+result.address_id+'" onclick="default_address('+result.address_id+');">Als Default festlegen</a>'+
                                                            '<a href="javascript:;" class="view_btn  btn btn-primary btn-sm btn40"  data-reveal-id="myModal10" onclick="edit_address('+result.address_id+', 1);">Editieren</a>'+
                                                            '<a href="javascript:;" class="view_btn btn26 delete_address btn btn-default btn-sm" data-reveal-id="myModal6" onclick="delete_address('+result.address_id+');">Löschen</a>'+
                                                    '</div>'+
                                                    '<p class="bottom" id="address_list_'+result.address_id+'">'+
                                                        '<span>'+datas.firstname+' '+datas.firstname+'</span>'+
                                                        '<span class="tel">'+datas.phone+'</span>'+
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.count_address > 1)
                change = '<a href="javascript:;" class="red" onclick="change_address_show();">Wechseln</a>';
            var shipping_address_list = '<dt>Lieferadresse  <a href="javascript:;" class="red" data-reveal-id="myModal10" onclick="return edit_address('+res.shipping_address_id+');">Editieren</a>'+change+'</dt>'+
                    ...
                    '<dd class="fix"><label>Adresse:</label><span>'+res.shipping_address+', '+res.shipping_city+' '+res.shipping_state+', '+res.shipping_country+' '+res.shipping_zip+'</span></dd>';
            document.getElementById('shipping_address_list').innerHTML = '';
            document.getElementById('shipping_address_list').innerHTML = shipping_address_list;
...
function ace2(acese)
{
    ...
    {
            $("#guo_con_1").show();
            $("#guo_con_1").html("Es scheint, dass Sie eine E-Mail-Adresse eingegeben haben, aber wir brauchen eine Lieferadresse.");   
            $("#guo_con_2").show();
...
function acecoun(){
    ...
    if(re.test(scon)){  
            $("#guo_don1").show();
            $("#guo_don1").html('Bundesland / Provinz mit Ziffern? Bitte überprüfen Sie es noch einmal.');
        }else{
            $("#guo_don1").hide();
        }   
}
...
function acedoun(){
    ...
    if(re.test(s2)){    
            $("#guo_eon1").show();
            $("#guo_eon1").html('Stadt / Ort mit Ziffern? Bitte überprüfen Sie es noch einmal.');
        }else{
            $("#guo_eon1").hide();
        }   
}
...
function ace(){
    ...
    var reg = new RegExp("[\\u4E00-\\u9FFF]+","g");
        ...
        $("#guo_fon1").show();
        $("#guo_fon1").html("Es scheint, dass es keine Ziffern in der PLZ gibt, überprüfen Sie sie bitte erneut.");
    }else{
        $("#guo_fon1").hide();
    }
}
...
function check_address(datas)
{
    ...
    // if(re.test(s)){
        // $("#guo222").show();
        // $("#guo222").html("Es scheint, dass es keine Ziffern in der PLZ gibt, überprüfen Sie sie bitte erneut.");
    // }else{
        // $("#guo222").hide();
    // }
