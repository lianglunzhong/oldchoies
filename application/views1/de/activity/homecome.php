    ...
    <div class="container">
      <div class="homecoming-top">
            ...
            <div class="back-to-school-filter ">
               ...
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=709"><li class=" current" style="margin-left:13%;"><span>Oberteile</span></li></a>
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=710"><li class=""><span>Unterteile</span></li></a>
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=711"><li class=""><span>Kleider</span></li></a>
                    <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=712"><li class=""><span>Schuhe</span></li></a>
                    <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=713"><li class=""><span>Accessories</span></li></a>
                </ul>                     
          </div>    
        </div>  
	  <div class="pro-list">
