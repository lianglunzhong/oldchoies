...
<?php echo View::factory(LANGPATH . '/customer/left'); ?>
    ...
    <!-- 有物流 -->
       ...
       <?php }else{ ?>
        <p class="color666">Sorry, the tracking No. you have entered is wrong, please check your order history again or <a href="<?php echo LANGPATH; ?>/contact-us" class="a_red a-underline" style="display:inline;">contact us</a>.</p>
        <?php } ?>
	</div>
		<!--无物流 -->
    <?php }else{ ?>
		<div id="msg" class="track-con-no col-xs-12 col-sm-9">
			<p class="red" style="">Sorry, no tracking information found by your order No. or tracking code please <a href="<?php echo LANGPATH; ?>/contact-us" class="a_red a-underline" style="display:inline;">contact us</a>.</p>
		</div>
	<?php } ?>
