			...
			<div class="main-container clearfix">
				...
				<div class="crumbs">
                    ...
                    <div>
                        <p class="mb25">
	                        <a href="">
	                            <img src="<?php echo STATICURL;?>/assets/images/en.jpg" alt="">
	                        </a>
	                    </p>
                    </div>
					<div class="pro-list">
						...
						<?php foreach($blackarr as $k=>$v){ ?>
							<li class="pro-item col-xs-6 col-sm-3">
								...
								<div class="title">
									<a href="<?php echo LANGPATH.'/product/'.$v['link'].'_p'.$v['id'];?>" target="_blank"><i class="myaccount"></i><?php echo $v['name'];?></a>
								</div>
								<p class="price">
									 <span class="priceold">$<?php echo $blackprice[$k][0]; ?></span>
								</p>
								<p class="price" style="font-size:16px;">
									 <span class="pricenow">Black Friday Price:<span class="red">$<?php echo $blackprice[$k][2]; ?></span></span>
								</p>
