...
.fix::after {
    ...
    <div class="container">
      ...
      <div class="vip-top col-xs-12">
          <p><a href="<?php echo LANGPATH; ?>/vip-policy" target="_blank"><img src="<?php echo STATICURL; ?>/assets/images/en/1604/vip-banner1.jpg"></a></p>
    ...
    <div class="pro-list">
            ...
            <?php foreach($skuArr as $k=>$v){ ?>
              <li class="pro-item col-xs-6 col-sm-3">
                ...
                <p class="price">
                            ...
                            {
                             ?>
                   <span style="color:#999;font-size:12px;">Originalpreis:</span><span class="priceold"><?php echo Site::instance()->price($orig_price, 'code_view'); ?></span>
                   <span class="pricenew" style="color:#444;font-weight:normal;">Verkaufspreis:<?php echo Site::instance()->price($price, 'code_view'); ?></span>
                            ...
                            {
                                ?>
                                <span class="pricenew" style="color:#444;font-weight:normal;">Verkaufspreis:<?php echo Site::instance()->price($product_inf['price'], 'code_view'); ?></span>
                                <?php
                            }
                            ?>           
                </p>  
				<!--
				<p class="price">
					<span class="pricenew" style="color:red;font-weight:bold;">VIP Preis:<?php  //echo Site::instance()->price($vip_promotion_price, 'code_view'); ?></span>
				</p>
				-->
				</li>
          ...
          <div class="vip-top col-xs-12" style="margin-top:40px;">
                     <!--    <p style="font-size:18px;font-weight:bold;font-family:Trebuchet MS, Arial,sans-serif;"><span style="font-size:26px;">Überraschung Nr. 2</span><br>Jede Bestellung $49+ Machen,  <span class="red">TWOP0122B209A</span> zum Preis $5,99 bekommen.</p> -->
