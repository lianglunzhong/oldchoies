            ...
            <div class="main-container clearfix">
                <div class="container">
                            ...
                            <?php foreach($skuArr as $k=>$v){
                             ...
                             <li class="pro-item col-xs-6 col-sm-3">
                                    ...
                                    <div class="title clearfix mb10">
                                        ...
                                        <div class="flr"><a href=""><i class="myaccount"></i><b class="red"><?php echo isset($votes[$v]) && $votes[$v] ? $votes[$v] : 0; ?> Stimmen</b></a></div>
                                    </div>
                                </li>
                            <?php } ?>
                            ...
                            <div class="vote-box col-xs-12 col-sm-6">
                                <div class="clearfix vote-textarea">
                                    ...
                                    <textarea class="textarea-long" name="comment" maxlength="500" 
                                                style="width: 100%; height: 63px;color: #878787;background-color: #fff;" onfocus="this.value=''; this.onfocus=null;" value="">Ihren Kommentar Hinterlassen...</textarea>
                                </div>
                                <div class=" vote-sub">
                    ...
                    <p class="red">Je mehr Sie teilen, desto mehr Möglichkeiten haben Sie, $100 Geschenkkarte zu gewinnen . </p>
                                    ...
                                    <button type="button" id="bu" class="btn btn-default btn-lg mt20">SENDEN</button>
                                </div>
                            </div>
                        </form>
