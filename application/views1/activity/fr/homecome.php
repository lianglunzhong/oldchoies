    ...
    <div class="container">
      <div class="homecoming-top">
            ...
            <div class="back-to-school-filter ">
               ...
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=709"><li class=" current" style="margin-left:13%;"><span>Tops</span></li></a>
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=710"><li class=""><span>Bas</span></li></a>
               <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=711"><li class=""><span>Robes</span></li></a>
                    <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=712"><li class=""><span>Chaussures</span></li></a>
                    <a href="<?php echo LANGPATH; ?>/activity/back_to_school?type=713"><li class=""><span>Accessoires</span></li></a>
                </ul>                     
          </div>    
        </div>  
	  <div class="pro-list">
