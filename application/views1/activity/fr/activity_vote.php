                        ...
                        <div class="vote-bottom">
                            ...
                            <div class="vote-box col-xs-12 col-sm-6">
                                <div class="clearfix vote-textarea">
                                    <span><input name="Fruit" type="checkbox" value="" />Je veux donner quelques suggestions à CHOIES sur les mannequins/tenues.</span>
                                    <textarea class="textarea-long" name="comment" maxlength="500" 
                                                style="width: 100%; height: 63px;color: #878787;background-color: #fff;" onfocus="this.value=''; this.onfocus=null;" value="Leave your comment...">Donner votre avis...</textarea>
                                </div>
                                <div class=" vote-sub">
                                    <p>Partagez-le avec vos amis sur Facebook ou sur Pinterest pour voter ensemble.</p>
                                    <p class="red">Plus vous partagez, plus vous gagnez la carte-cadeau de $100. </p>
                                    ...
                                    <button type="button" id="bu" class="btn btn-default btn-lg mt20">SOUMETTRE</button>
                                </div>
                            </div>
                        </form>
