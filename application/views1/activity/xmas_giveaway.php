...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo Site::instance()->version_file('/assets/css/style.css'); ?>" media="all" id="mystyle" />
        ...
        <link rel="image_src" href="<?php echo BASEURL ;?>/images/activity/xmas_giveaway.jpg"/>
        <meta property="og:title" content="Choies Xmas Giveaway" />
        <meta property="og:url" content="<?php echo BASEURL ;?>/activity/c_xmas_giveaway" />
        ...
        <meta property="og:image" content="<?php echo BASEURL ;?>/images/activity/xmas_giveaway.jpg">
    </head>
    ...
    <body>
        ...
        <img src="<?php echo BASEURL ;?>/images/activity/xmas_giveaway.jpg" style="display:none;">
        <section id="main">
            <!-- crumbs -->
            <div class="layout">
            ...
            <section class="layout fix">
                ...
                <div class="ml48 f16 tips" id="skuLi">
                    <ul>
                        <li><a href="<?php echo BASEURL ;?>/product/multi-plaid-raw-edge-scarf_p35915" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway4.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio1" value="SCAR1029A138A"/> <label for="radio1">SCAR1029A138A</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/white-chiffon-shift-dress-with-slip-sleeves_p29413" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway5.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio2" value="CDZY4383"/> <label for="radio2">CDZY4383</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/black-floral-embroidery-skate-dress_p35688" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway6.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio3" value="DRES1027A134A"/> <label for="radio3">DRES1027A134A</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/asymmetric-layered-coat-with-zipper-detail_p31729" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway7.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio4" value="CCPC0140"/> <label for="radio4">CCPC0140</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/white-blouse-in-lack-on-shoulders_p13742" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway8.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio5" value="CSZY0868"/> <label for="radio5">CSZY0868</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/black-bat-cape-coat_p32259" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway9.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio6" value="CZZY4701"/> <label for="radio6">CZZY4701</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/3d-ponytail-spoof-skull-print-sweatshirt_p30796" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway10.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio7" value="CRWC4533"/> <label for="radio7">CRWC4533</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/red-long-sleeve-high-waist-skater-dress_p35714" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway11.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio8" value="DRES1023A164G"/> <label for="radio8">DRES1023A164G</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/white-sakura-skater-skirt-with-pleat_p27080" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway12.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio9" value="CKYY1131"/> <label for="radio9">CKYY1131</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/black-crochet-lace-long-sleeve-top-with-mesh-panel_p24093" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway13.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio10" value="CTWC3747"/> <label for="radio10">CTWC3747</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/mini-skirt-with-structured-pleats-1_p18464" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway14.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio11" value="CKSM0007"/> <label for="radio11">CKSM0007</label></div></li>
                        <li><a href="<?php echo BASEURL ;?>/product/white-crochet-lace-long-sleeve-top-with-mesh-panel_p24092" target="_blank"><img src="//d1cr7zfsu1b8qs.cloudfront.net/ximg/activity/giveaway15.jpg" width="215" height="288"/></a><div><input type="radio" name="radio" id="radio12" value="CTWC3746"/> <label for="radio12">CTWC3746</label></div></li>
                    </ul>
                </div>
                <div id="step4"></div>
                    ...
                    <div class="card">
                        <p>
                            ...
                            <map name="Card" id="Card">
                                <area shape="rect" coords="88,2,193,62" href="https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf/splash.fdf&dn=<?php echo URLSTR; ?>&lang=en" target="_blank" />
                            </map>
                        </p>
                    </div>
                </div>
