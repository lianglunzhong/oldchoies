    ...
    <div class="main-container clearfix">
        <div class="container">
            ...
            <div id="homeBigBanner" class="flexslider">
                <ul class="slides">
                    <li><img src="<?php echo STATICURL; ?>/ximg/activity/skirt_looks/skirt-01.jpg"  /></li>
                </ul>
            </div>
            <div class="pro-list">
                <ul class="row skirt">
                    ...
                    <li class="pro-item col-xs-6 col-sm-3">
                        ...
                        <div class="ski"><a class="vi" target="_blank" href="<?php echo $value['product_url'];?>">View Detail >></a><a data-reveal-id="myModal" class="flr btn btn-default btn-xs hidden-xs" title="<?php echo $value['link_sku'];?>" onclick="load_data('<?php echo $value['link_sku'];?>')" >Get the Look </a></div>
                    </li>
                    <?php } ?>
                </ul>
                <div class="skirtban" style="display:none;"><a target="_blank" href="/skirt-c-99"><img src="<?php echo STATICURL; ?>/ximg/activity/skirt_looks/skirt-05.jpg" /></a></div>
            </div>
        </div>
    </div>
</div>
...
function load_data(skus){
    $.post(
        ...
        function (data) {
            ...
            $('.add-wishlist').attr('href','/wishlist/add_more/'+wishlist_href)
...
<div id="myModal" class="reveal-modal xlarge">
    ...
    <div class="look-pro">
        <form action="/cart/add_more" method="post" class="form3" id="form">
            ...
            <div class="add-bag">
                <input value="ADD TO BAG" class="btn btn-primary btn-lg" type="submit"><a href="/wishlist/add_more/" class="a-underline add-wishlist">Add to wishlist</a>
            </div>
        </form>
        <script>
            $("#form").validate({
