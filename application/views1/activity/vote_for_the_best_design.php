...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="image_src" href="<?php echo BASEURL ;?>/images/activity/vote-fb.jpg"/>
        ...
        <meta property="og:image" content="<?php echo BASEURL ;?>/images/activity/vote-fb.jpg">
        <style>
    ...
    <body>
        ...
        <!-- main begin -->
        <img src="<?php echo BASEURL ;?>/images/activity/vote-fb.jpg" style="display:none;">
        <section id="main">
            <!-- crumbs -->
            <div class="layout">
