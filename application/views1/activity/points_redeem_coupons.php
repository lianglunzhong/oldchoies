...
<body>
		<div class="site-content" id="phone-main">
			<div class="points-banner hidden-xs">
				<div class="container">
					<img  src="/assets/images/en/1601/points-banner-pc-18.jpg">
				</div>
			</div>
			...
			<div class="points-banner-login-mobile  hidden-sm hidden-md hidden-lg">
				<div class="container" >
					<img  src="/assets/images/en/1601/points-banner-mobile-18.jpg">
					<?php
						if(!$user_session['id'])
						{
					?>
				...
				<div class="container">
					...
					<div class="points-notes">
						<p>
							...
							1.By <strong>Feb.20th, 2016</strong>, all points will be reset. Please use them to redeem coupons as soon as possible.<br>
							...
							4. Activity time: <strong>Ends Feb. 20th EST</strong>.<br>
