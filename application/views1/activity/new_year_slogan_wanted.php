            ...
            <div class="lp_slogan layout fix">
                ...
                <div class="lp-main">
                    ...
                    <div class="lp_vote_share">
                        <div>
                            <a target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo urlencode(BASEURL . '/activity/new_year_slogan_wanted'); ?>" class="a1">facebook</a>
                            <a target="_blank" href="http://twitter.com/share?url=<?php echo urlencode(BASEURL . '/activity/new_year_slogan_wanted'); ?>" class="a2">twitter</a>
