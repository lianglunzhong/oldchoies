        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="step-nav">
                        <ul class="clearfix">
                            <li class="current">Passer Commande<em></em><i></i></li>
                            <li>Payer<em></em><i></i></li>
                            <li>Réussir<em></em><i></i></li>
                        </ul>
                    </div>  
                </div>
            </div>
    ...
    <form action="<?php echo LANGPATH; ?>/cart/edit_shipping" method="post" class="form payment-form" onsubmit="return setShipping(this);">
        ...
        <div class="shipping-methods s_price_list">
            <ul class="clearfix">
                ...
                {
                    $name1 = '10-15 jours ouvrables de livraison gratuite';
                    $site_shipping[1]['name'] = $name1;
                    $name2 = '4-7 jours ouvrables de livraison express';
            ...
            <p><input type="submit" value="VALIDER" class="btn btn-default"></p>
        </div>
    </form>
</div>
                    ...
                    <div class="shipping-information">
                        ...
                        <div id="shippingAddressInfo" <?php if (!$show_address) echo 'style="display:none;"'; ?>>
                            <div class="information-con">
                                ...
                                ?>
                                    <dt>
                                        Adresse de livraison <a href="javascript:;" class="red" data-reveal-id="myModal10" onclick="return edit_address(<?php echo $cart['shipping_address']['shipping_address_id']; ?>, 1);">Rédiger</a>
                                        <?php
                                        if($count_address > 1)
                                        {
                                        ?>
                                            <a href="javascript:;" class="red" onclick="return change_address_show();">Changer</a>
                                        <?php
                                        }
                                        ?>
                                    </dt>
                                    <dd><label>NOM:</label><span><?php echo $cart['shipping_address']['shipping_firstname'] . ' ' . $cart['shipping_address']['shipping_lastname']; ?></span></dd>
                                    <dd><label>Téléphone:</label><span><?php echo $cart['shipping_address']['shipping_phone']; ?></span></dd>
                                ...
                                <dl class="col-xs-12 col-md-6">
                                    <dt>Mode De Livraison <!-- <a href="javacript:;" class="red JS-popwinbtn2" id="ship_edit" <?php // if(in_array($cart['shipping_address']['shipping_country'], $no_express_countries)) echo 'style="display:none;"'; ?>>Rédiger</a> --></dt>
                ...
                { ?>
                                    ...
                                    <?php
                                      ...
                                      <dd id="aaab">
                                            ...
                                            <div class="method">    
                                                <p style="width:78%;">Ajouter l’assurance transport pour votre commande</p> 
                                                <p style="width:20%;"><?php echo Site::instance()->price(0.99, 'code_view'); ?></p>
                                                <div class="insurance cs-show">
                                                    <b>Quelle est l'assurance transport?</b>
                                                    <div class="ins-info cs-list">
                                                        <b class="arrow-up"></b>
                                                        <div class="ins-tipscon">L'assurance transport offre la protection supérieure et la sécurité pour vos articles de valeur pendant la livraison internationale. Nous réexpédierons votre colis immédiatement sans coût supplémentaire s'il est déclaré perdu ou endommagé.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <form action="" method="post" name="shipping_address_radio">
                                        ...
                                        <li id="address_li_<?php echo $value['id']; ?>">
                                            <div class="clearfix">
                                                ...
                                                <label for="radio<?php echo $key; ?>">
                                                    ...
                                                    {
                                                        ?>
                                                            <p class="col-md-4 col-sm-12"><span class="b address-detault" id="detault_<?php echo $value['id']; ?>">Par Défaut</span>
                                                            <a href="javascript:;" class="a-underline address-detault-a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);" style="display:none;">régler l'adresse par défaut</a></p>
                                                            <p class="col-md-8 col-sm-12"><a href="javascript:;" class="btn btn-primary btn-sm" data-reveal-id="myModal10" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Rédiger</a>
                                                            <a href="javascript:;" class="btn btn-default btn-sm"  data-reveal-id="myModal6" onclick="delete_address(<?php echo $value['id']; ?>);">Supprimer</a></p>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                            <p class="col-md-4 col-sm-12"><span class="b address-detault" id="detault_<?php echo $value['id']; ?>" style="display:none;">Par Défaut</span>
                                                            <a href="javascript:;" class="a-underline address-detault-a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);">régler l'adresse par défaut</a></p>
                                                            <p class="col-md-8 col-sm-12"><a href="javascript:;" class="btn btn-primary btn-sm" data-reveal-id="myModal10" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Rédiger</a>
                                                            <a href="javascript:;" class="btn btn-default btn-sm"  data-reveal-id="myModal6" onclick="delete_address(<?php echo $value['id']; ?>);">Supprimer</a></p>
                                                        <?php
                                                    }
                                    ...
                                    <ul class="shipping-address">
                                        <li class="clearfix last">
                                            <a href="javascript:;" class="a-underline" id="add_new_address"  data-reveal-id="myModal10" onclick="return new_address_show();">+Ajouter Une Nouvelle Adresse</a>
                                        </li>
                                    </ul>
                                    </form>
                                </dd>
                        ...
                        <div class="address-fill" id="shippingAddressFill" <?php if($has_address) echo 'style="display:none;";' ?>>
                            ...
                            <form action="" method="post" class="form payment-form form2" onsubmit="return update_address(this);">
                                ...
                                <ul>
                                    <li>
                                        <label class="col-xs-12 col-md-3"><span>*</span> Prénom:</label>
                                        <input type="text" value="" name="firstname"  id="s_firstname" class="text col-xs-12 col-md-9">
                                    </li>
                                    <li>
                                        <label class="col-xs-12 col-md-3"><span>*</span> Nom:</label>
                                    ...
                                    <li>
                                        <label class="col-xs-12 col-md-3"><span>*</span> Pays:</label>
                                         ...
                                         if($country == "US")
                                            ...
                                            <div class="all2 JS_drop" id="all2_<?php echo $country; ?>" style="display:none;">
                                                <select name="" class="select-style col-xs-12 col-md-9 s_state" onblur="$('#billing_state1').val($(this).val());" onchange="acecoun()">
                                                    <option value="">[Sélectionnez l'un/l'une]</option>
                                        ...
                                        <script>
                                            ...
                                            function changeSelectCountry1(){
                                                ...
                                                {   
                                                    ...
                                                    var aa = $("#guo_con1");
                                                        aa.show();
                                                        aa.html("請輸入中文地址(Veuillez entrer l'adresse en chinois.)");
                                                }
                                                else
                                                {
                                                    $("#shipping_cpf").hide();
                                    ...
                                    <li>
                                        <label class="col-xs-12 col-md-3"><span>*</span>Ville / Commune:</label>
                                    ...
                                    <li>
                                        <label class="col-xs-12 col-md-3"><span>*</span> Code postal:</label>
                                        ...
                                        <p class="mt5 col-md-offset-3 col-xs-12 col-md-9 phone_tips">Si votre région n'utilise pas de code postal, veuillez saisir 0000.</p>  
                                    </li>
                                    <li>
                                        <label class="col-xs-12 col-md-3"><span>*</span> Téléphone:</label>
                                   ...
                                   <p class="me-wt"><?php echo $price['name']; ?> </p> 
                                    ...
                                    <li class="col-xs-12">
                                                    <div class="method">
                                                        ...
                                                        <p class="me-wt">Ajouter l’assurance transport pour votre commande</p> 
                                ...
                                <p><input id="spgInfoCountinue" type="submit" value="Confirmer et payer" class="btn btn-primary btn-lg"></p>
                            </form>
                        </div>
                    </div>
                        ...
                        <form id="payment_form" method="post" action="" class="form">
                            ...
                            ?>
                                ...
                                <dd class="shipping-infor" id="ideal" <?php if($cart['shipping_address']['shipping_country'] != 'NL') echo 'style="display:none;";' ?>>                              
                                   ...
                                   <h2 class="visible-xs-block hidden-sm hidden-md hidden-lg">COUPONS ET POINTS</h2>
                                    <div class="promo-choies visible-xs-block hidden-sm hidden-md hidden-lg" style="background:none;">
                                    <ul>
                                        <li class="promo-code">
                                            <div class="pc-apply">
                                                <div class="ml10">
                                                    <span class="fll" style="font-weight:bold;">Utilisez le code promo&nbsp;&nbsp;</span> 
                                        ...
                                        <li class="promo-code">
                                            <div class="pc-apply">
                                                <div class="ml10">
                                                    <span style="font-weight:bold;">Utilisez Points Choies</span>
                                               ...
                                               <?php
                                                if ($points_avail >= 0){
                                                    ?>
                                                        ...
                                                        points disponibles pour cette commande.
                                                   <?php
                                               }else{
...
<span id="totalPrice" class="font18"><?php echo $cart['amount']['shipping'] ? Site::instance()->price($cart['amount']['total'] + $insurance, 'code_view') : Site::instance()->price($cart['amount']['total'] + $default_shipping + $insurance, 'code_view'); ?>
                            ...
                            <p class="mt20">
                                <input type="submit" class="btn btn-primary btn-lg" id="checkoutbtn" value="Confirmer et payer" onclick="return btn_loading();">
                                <div id="loadingbtn" style="display:none;">
                                    <button type="button" class="btn btn-primary btn-lg" disabled="disabled">Confirmer et payer</button>
                ...
                <div class="col-xs-12 col-sm-4 col-sm-offset-1 hidden-xs">
                    <div class="order-summary">
                        ...
                        foreach (array_reverse($cart['products']) as $key => $product):
                            ...
                            <li class="clearfix">
                                ...
                                <div class="right">
                                    ...
                                    <p class="color666">Article: #<?php echo $sku; ?></p>
                        ...
                        <ul class="total">
                            <li class="font14"><label>Sous-total:  </label>
                            <span>                                           
                            <?php 
                                if(isset($savearray['product_amount']))
                                {
                            ...
                            <li><label>Livraison:  </label><span id="shipping_total_pc"><?php echo $cart_shipping == -1 ? Site::instance()->price($site_shipping[2]['price'], 'code_view') : Site::instance()->price($cart_shipping, 'code_view'); ?></span></li>
                        <li class="last" id="oii_insurance_pc" <?php  if($session_insurance == -1) echo 'style="display:none;"'; ?>>
                            ...
                            <li id="coupon_points_save_pc" <?php if(!$coupon_points_save) echo 'style="display:none;"'; ?>>
                                <label>COUPONS & POINTS:  </label><span id="save_total_pc"><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span>
                            </li>
                            <?php
                            $saving = $cart['amount']['items'] + $cart['amount']['shipping'] - $cart['amount']['total'];
                            $item_saving = round($saving - $cart['amount']['coupon_save'] - $cart['amount']['point'], 2);
                            ...
                            if($saving <= 0)
                                $saving = 0;
                            ?>
                            <li class="last red"><label>Économiser: </label><span id="cart_saving_pc"><?php echo Site::instance()->price($saving, 'code_view'); ?></span></li>
                            ...
                            <span style="display:inline-block;">
                                        ...
                                        <div class="pc-ibutton">
                                            <form method="post" action="<?php echo LANGPATH; ?>/cart/set_coupon" onsubmit="return setCoupon();">
                                                ...
                                                <button type="submit" class="btn btn-default btn-xs fll">Appliquer</button>
                                            </form>
                                            <!-- <a class="J-pop-btn a-underline flr">Liste De Code</a> -->
                                            <!-- codelist_con -->
...
<span style="font-weight:bold;">Utilisez Points Choies</span>
                                        ...
                                        <div class="po-equal">= &nbsp;&nbsp;$</div>
                                                ...
                                                <button type="submit" class="btn btn-default btn-xs fll" onclick="return point_redeem();">Racheter</button>
                                            </form>
                                            <div class="clearfix"></div>
                                            <div class="points-info" style="font-size:11px;">
                                           <!-- Économiser:<span class="red">$ <span id="dollar">0</span></span><br> -->
                                               <!--  (10 Points=$0.1)  --> 
                                                <?php
                                                if ($points_avail >= 0):
                                                    ?>
                                                ...
                                                ?>
                                                <br>
                                                <!-- <a class="a-underline JS-popwinbtn" style="display: inline;">politique vip</a> -->
                                            </div>
                                            <script type="text/javascript">
                                                var xhr = null;
                                                var amount_left = $('#amount_left').text();
                        ...
                        <div class="additional-payment mt20">
                            <form action="<?php echo LANGPATH; ?>/cart/set_message" method="post" class="form user-message" onsubmit="return setMessage();">
                                ...
                                <b>Message:</b>
                                <br /><label style="color:#878787;height:20px;">(5-100 caractères)</label>
                                <div class="right-box">
                                    ...
                                    onfocus="if(this.value=='Laissez un message concernant le placement de commande, le changement de produit ou les options de livraison. Tous les messages seront répondus dans les 24 heures.') 
                                    {this.value='';}this.style.color='#000';" onblur="if(this.value=='') {this.value='Laissez un message concernant le placement de commande, le changement de produit ou les options de livraison. Tous les messages seront répondus dans les 24 heures.';this.style.color='#878787';}"
                                    ><?php if($cart_message) {echo $cart_message;} else { echo 'Laissez un message concernant le placement de commande, le changement de produit ou les options de livraison. Tous les messages seront répondus dans les 24 heures.'; } ?></textarea>
                                    ...
                                    <a href="javascript:;" onclick="editMessage();" id="message_edit" style="text-decoration: underline;<?php if(!$cart_message) echo 'display:none;'; ?>">Modifier</a>
                                    <button class="btn btn-default btn-xs mt10" type="submit" id="message_submit" <?php if($cart_message) echo 'style="display:none;"'; ?>>GARDER</button>
                                </div>
                            </form>
                            <p class="mt10">
                                Sécurité de paiement supplémentaire avec:
                            </p>
        ...
        <form onsubmit="return update_address(this);" method="post" class="form payment-form form1">
            ...
            <ul>
                ...
                <li>
                    ...
                    <p class="mt5 col-md-offset-3 col-xs-12 col-md-9 phone_tips">Veuillez laisser le numéro de téléphone correct et complet pour la livraison précise du facteur.</p>
                </li>
                <li class="hide" value="0">
                    <label class="col-xs-12 col-md-3"><span>*</span>o cadastro de pessoa Física:</label>
            ...
            <p class="col-md-offset-3 col-xs-12 col-md-9"><input type="submit" value="VALIDER" class="btn btn-default"></p>
        </form>
    </div>
</div>
<!-- JS-popwincon3 -->
<div id="myModal6" class="reveal-modal medium" id="cart_delete">
    ...
    <div class="order-addtobag">
        <div class="prompt">Êtes- vous sûr pour le supprimer? Il ne peut pas d’être révoqué.</div>
    ...
    <div class="vip">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>$1 - $199</td>
                <td>/</td>
                <td rowspan="5"><div>Obtenir des points doubles d'achat pendant les grandes fêtes.
Les cadeaux d’anniversaire spéciaux,
etc...
                    </div>
                </td>
            </tr>
        ...
        $.ajax({
            ...
            success: function(result){
                if(result.success == 1){
                    ...
                    var shipping_address_list = '<dt>Adresse de livraison   <a href="javascript:;" class="red" data-reveal-id="myModal10" onclick="return edit_address('+result.address_id+');">Edit</a>'+change+'</dt>'+
                                    '<dd class="fix"><label>NOM:</label><span>'+datas.firstname+' '+datas.lastname+'</span></dd>'+
                                    '<dd class="fix"><label>Téléphone:</label><span>'+datas.phone+'</span></dd>'+
                                                ...
                                                '<b class="s1">Adresse'+result.count_address+'</b></label>'+
                                                    '<div class="flr">'+
                                                        '<span class="b address-detault" id="detault_'+result.address_id+'" style="display:none;">Default</span>'+
                                                            ...
                                                            '<a href="javascript:;" class="view_btn  btn btn-primary btn-sm btn40" data-reveal-id="myModal10" onclick="edit_address('+result.address_id+', 1);">Edit</a>'+
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.count_address > 1)
                change = '<a href="javascript:;" class="red" onclick="change_address_show();">Changer</a>';
            var shipping_address_list = '<dt>Adresse de livraison   <a href="javascript:;" class="red" data-reveal-id="myModal10" onclick="return edit_address('+res.shipping_address_id+');">Rédiger</a>'+change+'</dt>'+
                    '<dd class="fix"><label>NOM:</label><span>'+res.shipping_firstname+' '+res.shipping_lastname+'</span></dd>'+
                    '<dd class="fix"><label>Téléphone:</label><span>'+res.shipping_phone+'</span></dd>'+
...
function ace2(acese)
{
    ...
    {
            $("#guo_con_1").show();
            $("#guo_con_1").html("Il semble que vous avez laissé une adresse de email, mais nous avons besoin d'une adresse de livraison.");   
            $("#guo_con_2").show();
...
function acecoun(){
    ...
    if(re.test(scon)){  
            $("#guo_don1").show();
            $("#guo_don1").html("Nom du comté / de la province avec des chiffres? Veuillez vérifier l'exactitude. ");
        }else{
            $("#guo_don1").hide();
        }   
}
...
$("#guo_eon").html("Nom de la ville avec des chiffres? Veuillez vérifier l'exactitude. ");
    ...
    if(re.test(s2)){    
            $("#guo_eon1").show();
            $("#guo_eon1").html("Nom de la ville avec des chiffres? Veuillez vérifier l'exactitude. ");
        }else{
            $("#guo_eon1").hide();
        }   
}
...
function ace(){
    ...
    var reg = new RegExp("[\\u4E00-\\u9FFF]+","g");
        ...
        $("#guo_fon1").show();
        $("#guo_fon1").html("Il semble qu'il n'y a pas de chiffres dans votre code, veuillez vérifier l'exactitude.");
    }else{
        $("#guo_fon1").hide();
    }
}
    ...
    $(".form1").validate({
        ...
        messages: {
            ...
            city: {
                ...
                maxlength:"La ville/commune dépasse la longueur maximale de 50 caractères."
            },
            country: {
                required: "Veuillez entrer votre pays.",
                maxlength:"Le pays la longueur maximale de 50 caractères."
            },
            state: {
                required: "Veuillez entrer votre Pays/ Région/ Département.",
                maxlength:"Le pays/région dépasse la longueur maximale de 50 caractères."
            },
            phone: {
