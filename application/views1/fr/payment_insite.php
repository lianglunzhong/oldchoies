                    ...
                    <div>
                        <div id="payment_wrap">
                            ...
                            <div class="payment_p">
                                ...
                                <p class="payment_message_p">Nous acceptons les cartes de crédit / débit suivantes.Ne laissez pas jusqu'au retour de résultat de paiement.<br>(Note: Pour des raisons de sécurité, nous ne conserverons aucune donnée de votre carte de crédit.)</p>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">          
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="payment_td_right">Nous Acceptons:</td>
                                                <td width="300">
                                                    <ul class="payment_ul">
                ...
                <div class="order_summary flr">
                    <div class="cart_side">
                            ...
                            foreach ($products as $product):
                                ...
                                <li class="fix">
                                    ...
                                    <div class="right">
                                        ...
                                        <p><?php echo Site::instance()->price($product['price'], 'code_view', NULL, $currency); ?></p>
                                        <p>
                                            <?php
                        ...
                        <ul class="total">
                            ...
                            <li><label>Livraison estimée: </label><span><?php echo $currency['code'] . round($order['amount_shipping'], 2); ?></span></li>
                            <?php
                            ...
                            if ($item_saving > 0):
                                ?>
                                <li><label>remise: </label><span><?php echo $currency['code'] . round($item_saving, 2); ?></span></li> 
                                <?php
                            endif;
                            ?>
                            ...
                            if ($saving):
                                ?>
                                <li class="last red"><label>Économiser: </label><span><?php echo $currency['code'] . round($saving, 2); ?></span></li>
                                <?php
                            endif;
                            ?>
...
<div id="popup_container" style="display:none;position: absolute; z-index: 99999; padding: 0px; overflow-y: hidden; margin: 0px; min-width: 310px; max-width: 310px; top: 240px; left: 300px;" class="ui-draggable">
    ...
    <div id="popup_content" class="alert">
        <div id="popup_message">Le numéro de carte de crédit est incorrect</div>
        <div id="popup_panel">
