    ...
    <div class="container">
        <div class="crumbs">
            <div>
                ...
                <a href="<?php echo LANGPATH; ?>/customer/summary" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > Mon Compte</a> > Carnet d'adresse
            </div>
                    ...
                    <dl class="address-book col-sm-6 col-xs-12">
                        <dd class="last">
                            <div class="address-book-form">
                                <p class="top-btn"><a class="btn btn-primary btn-xs"  href="<?php echo LANGPATH; ?>/address/add">Ajouter une nouvelle adresse</a>
                                </p>
                <?php
                    ...
                    ?>
                                ...
                                if ($address['is_default']):
                                    ?>
                                            <li>
                                                <label>Label:</label>
                                                <div>C’est votre adresse de livraison par défaut</div>
                                            </li>
                            <?php
                                endif;
                                ?>
                                ...
                                <form method="post" action="<?php echo LANGPATH; ?>/address/set_default">
                                    <p class="top-btn">
                                        <a  href="<?php echo LANGPATH; ?>/address/edit/<?php echo $address['id']; ?>" class="a-red edit_address JS_popwinbtn" title="<?php echo $address['id']; ?>" >RÉDIGER</a>
                                        <a class="a-underline delete" href="javascript:delete_address(<?php echo $address['id']; ?>)">SUPPRIMER</a>
                                        ...
                                        <input type="submit" class="btn btn-default btn-xs flr" value="DÉFAUT">
                                        <?php
                                            }
                                            ?>
                                    </p>
...
<input type="hidden" id="e_address_id" name="address_id" value="">
        ...
        <script>
            function changeSelectCountry1(){
                ...
                <li>
                    <label class="col-sm-3 col-xs-12"><span>*</span> Ville/ Commune:</label>
                    <div class="col-sm-9 col-xs-12">
        ...
        <label class="error a4" style="display:none;"  generated="true" id="guo_eon">Please choose your country.</label>
                ...
                <li>
                    <label class="col-sm-3 col-xs-12"><span>*</span>  Code postal:</label>
                    <div class="col-sm-9 col-xs-12">
        ...
        <em style="display:block;">Si votre région n'utilise pas de code postal, veuillez saisir 0000. </em>
                ...
                <li>
                    <label class="col-sm-3 col-xs-12"><span>*</span>Téléphone:</label>
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" id="e_phone" value="" name="phone" class="text text-long col-sm-12 col-xs-12" />
                        <p class="phone-tips">Veuillez laisser le numéro de téléphone correct et complet pour la livraison précise du facteur.</p>
                    </div>
                </li>
    <li id="e_cpf" class="hide">
        ...
        <input type="text" name="cpf" class="text text_long" value="" />
            ...
            <div>
                <label class="col-sm-3 xs-hidden">&nbsp;</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="reset" value="SUPPRIMER" class="btn btn-primary btn-sm" />
                    <input type="submit" value="AJOUTER & GARDER " class="btn btn-primary btn-sm" id="submitAdd" />
                    <input type="submit" id="submitSave" value="GARDER" class="btn btn-primary btn-sm" />
                </div>
            </div>
        </form>
    </div>
