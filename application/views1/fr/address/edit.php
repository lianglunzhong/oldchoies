	...
	<div class="container">
		<div class="crumbs">
			<div>
				...
				<a href="<?php echo LANGPATH; ?>/customer/summary"> >  Carnet d'adresse</a> >RÉDIGER VOTRE ADRESSE
			</div>
...
<?php echo View::factory('customer/left'); ?>
        ...
        <em style="display:block;">Si votre région n'utilise pas de code postal, veuillez saisir 0000.  </em>
							...
							<li>
								<label class="col-sm-3 xs-hidden">&nbsp;</label>
								<div class="btn-grid12 col-sm-9 col-xs-12">
									<input class="btn btn-primary btn-sm" type="submit" value="GARDER">
									<input class="btn btn-default btn-sm" type="reset" value="SUPPRIMER">
								</div>
							</li>
						</ul>
					</form>
