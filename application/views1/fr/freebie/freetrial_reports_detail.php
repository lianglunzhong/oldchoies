            ...
            <div class="trial_report trial_report_list">
                ...
                <div class="report_details fix">
                    ...
                    <div class="left JS_imgbox">
                        <div class="pro_img">
                            <a href="#">
                                <img src="<?php echo Image::link($product->cover_image(), 5); ?>" class="JS_pro_img" width="324" />
                            </a>
                        </div>
                        <div class="pro_small">
                            <div class="pro_items">
                                <ul class="fix JS_pro_small">
                                    ...
                                    foreach ($product->images() as $image):
                                        ...
                                        if ($key > 3)
                                            break;
                                        ?>
                                        <li<?php if ($key == 1) echo ' class="current"'; ?>><img src="<?php echo Image::link($image, 3); ?>" imgb="<?php echo Image::link($image, 5); ?>" width="102px" /></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="right">
                        <div class="right_top">
                            ...
                            <span>Article#: <?php echo $product->get('sku'); ?></span>
                            <p class="price">Prix Maintenant: <?php echo Site::instance()->price($product->price(), 'code_view'); ?> <a href="<?php echo $product->permalink(); ?>" class="view_btn btn26 btn40">ACHETEZ</a></p>
                        </div>
                        <div class="right_trial">
                            <div class="right_tit"><h4>Rapports d'Essai</h4></div>
                            <div class="right_con">
