<link rel="stylesheet" href="/assets/css/style-https.css" media="all" id="mystyle" />
<style>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <div class="step-nav">
                        <ul class="clearfix">
                            <li>Passation<em></em><i></i></li>
                            <li class="current">Paiement<em></em><i></i></li>
                            <li>Expédition<em></em><i></i></li>
                        </ul>
                    </div>  
                </div>  
            </div>
                    ...
                    <div class="shipping-information">
                        <div class="information-con">
                            ...
                            <div class="billing-address" id="payment_address">
                                ...
                                <a href="javascript:;" class="red JS-popwinbtn1">Modifier</a>
                            </div>
                        ...
                        <div class="payment-wrap">
                            <div class="payment-p">
                                <div class="payment-message">
                                    <div class="fll mr20">Montant de la commande:
                                        <span class=" f16 bold"><?php echo round($order['amount'], 2) . ' ' . $order['currency']; ?></span>
                                    </div>
                                    <div class="fll">Numéro de la commande:<span class=" f16 bold"><?php echo $order['ordernum']; ?></span></div>
                                </div>
                                <div class="clearfix"></div>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                    <ul>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Type De Carte De Crédit</label>
                                        ...
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Numéro De Carte De Crédit</label>
                                            <div class="payment-card-time">12-19 chiffres, les espaces ne sont pas autorisés</div>
                                            <div class="card-num">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="card_error">Le numéro de carte de crédit est incorrect.</div>
                                        </li>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Date d'Expiration</label>
                                            <?php
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment-card-time fl">Mois</div>
                                            </div>
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment-card-time fl">Année</div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="expire_error">Le mois de la date d'expiration est incorrect.</div>                                                               
                                        </li>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Code De Sécurité <span style="font-weight:normal; color:#999">(CVV/CVC)</span></label>
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="cvv_error">Veuillez entrer un code CVV/CVC à 3 chiffres.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="PAYER MAINTENANT" id="paybutton" name="paybutton" class="btn btn-primary btn-lg" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                    ...
                    <div class="order-summary">
                        <div class="cart-side">
                            <p>
                                ...
                                Nous acceptons les paiements par VISA, Electron, MasterCard et cartes de crédit VISA ou Mastercard.<br />
                                Si vous utilisez une autre carte (par exemple, Discover ou American Express) veuillez payer par <a style="text-decoration:underline;" href="<?php echo LANGPATH; ?>/order/view/<?php echo $order['ordernum']; ?>" target="_blank">PayPal</a>.
                                <br>
                                <br>
                                <strong>Remboursement 60-jours</strong>
                                Si vous n'êtes pas satisfait de votre achat, simplement nous envoyez un email à 
                                <a style="text-decoration:underline;" href="mailto:service@choies.com" target="_blank">service@choies.com</a> 
                                afin d'obtenir une autorisation de retour (adresse de retour) ou  une autorisation d'échange dans les 60 jours suivant la réception.
                            </p>
                            <div class="add-payment">
                                <strong>Sécurité de paiement supplémentaire avec:</strong>
                                <span class="encryption"><b></b>Paiement Sécurisé  cryptage SSL à 256 bits par Norton</span>
                                <span>
...
<div class="loading" id="payment_wrap2" style="display:none;">
    <div class="loading-box">
        ...
        <div class="loading-prompt">Chargement en cours, veillez attendre un moment!</div>
        </div>
    </div>
</div>
...
<div class="JS-popwincon1 popwincon popwincon-user hide">
    ...
    <div class="address-fill">
        ...
        <form action="/order/edit_address/<?php echo $order['id']; ?>" method="post" class="form payment-form form1">
            ...
            <p class="col-md-offset-3 col-xs-12 col-md-9"><input type="submit" value="CONTINUER" class="btn btn-default"></p>
        </form>
    </div>
</div>
...
function checkFormData()
{
    ...
    if(cardNo.length == 0)
    {
        ...
        $popup_message.innerHTML = 'Veuillez entrer le numéro de carte.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(month == 0)
    {
        ...
        $popup_message.innerHTML = 'Veuillez sélectionner la date d\'expiration.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    { 
        $popup_message = document.getElementById('expire_error');
       $popup_message.innerHTML = 'La date d\'expiration est invalide.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(cvv2.length != 3 || reg.test(cvv2) != true)
    {
        ...
        $popup_message.innerHTML = 'Veuillez entrer un code CVV/CVC à 3 chiffres.';
        $popup_message.style.display = 'block';
        error = 1;
    }
