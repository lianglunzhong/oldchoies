            ...
            <?php foreach($skuArr as $k=>$v){ ?>
              <li class="pro-item col-xs-6 col-sm-3">
                ...
                <p class="price">
                            ...
                            {
                             ?>
                   <span style="color:#999;font-size:12px;">Prix d'origine:</span><span class="priceold"><?php echo Site::instance()->price($orig_price, 'code_view'); ?></span>
                   <span class="pricenew" style="color:#444;font-weight:normal;">Prix de vente:<?php echo Site::instance()->price($price, 'code_view'); ?></span> 
                                <?php
                            }
                            else
                            {
                                ?>
                                <span class="pricenew" style="color:#444;font-weight:normal;">Prix de vente:<?php echo Site::instance()->price($product_inf['price'], 'code_view'); ?></span>
                                <?php
                            }
                            ?>           
                </p>
				<!--
				<p class="price">
				   <span class="pricenew" style="color:red;font-weight:bold;">Prix de VIP:<?php //echo Site::instance()->price($vip_promotion_price, 'code_view'); ?></span>				
				</p>
				-->
			  </li>
