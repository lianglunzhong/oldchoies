            ...
            <div class="blogger-img hidden-xs">
                    <div class="step-nav step-nav1">
                        <ul class="clearfix">
                            ...
                            <li>Lire les politiques<em></em><i></i></li>
                            <li class="current">Soumettre les informations<em></em><i></i></li>
    ...
    <?php echo Message::get(); ?>
            <article class="row blogger-form">
                ...
                <div class="col-sm-8 col-xs-12">
                    <div class="fashion-tit">SOUMETTRE LES INFORMATIONS</div>
                    <div>
                        <div class="sub-info">
                            <form class="form" id="submitInfo" method="post" action="">
                                <ul>
                                    <li>
                                        <label class="col-sm-2 col-xs-12"><span>*</span> Adresse é-mail:</label>
                                    ...
                                    <li>
                                        <label class="col-sm-2 col-xs-12"><span>*</span> Sexe:</label>
                                        <div class="col-sm-7 col-xs-12">
                                   ...
                                   <option value="">Sélectionner votre sexe</option>
                                    ...
                                    <li>
                                        <label class="col-sm-2 col-xs-12"><span>*</span>  Pays:</label>
                                        <div class="col-sm-7 col-xs-12">
                                    ...
                                    <li>
                                        <table id="tab" class="col-xs-12">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <label class="col-sm-2 col-xs-12"><span>*</span>Type du site principal: </label>
                                                        <div class="col-sm-7 col-xs-12">
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="col-sm-2 col-xs-12"><span>*</span>  URL du site principal: </label>
                                                        <div class="col-sm-5 col-xs-12">
                                                            <input type="text" class="sub-info-text col-xs-12" name="sites[url][]" id="url">
                                                        </div>
                                                        <label class="col-sm-2 col-xs-12"><span>*</span> Fans: </label>
                                    ...
                                    <li>
                                        ...
                                        <div class="col-sm-7 col-xs-12">
                                            <textarea onfocus="this.value=(this.value=='Write something to intraduce yourself ,and what\'s your idea about fashion. Thank you !')?'':this.value" value="Écrire quelque chose pour vous présenter et votre opinion sur la fashion. Merci beaucoup!" onblur="this.value=(this.value=='')?'Écrire quelque chose pour vous présenter et votre opinion sur la fashion. Merci beaucoup!':this.value"
                                            class="input textarea sub-info-text3 col-xs-12" rows="10" id="input_comment" name="comment">Écrire quelque chose pour vous présenter et votre opinion sur la fashion. Merci beaucoup!</textarea>
                                        </div>
                                    </li>
                                    <li>
                                        <label class="col-sm-2 col-xs-12"></label>
                                        <div class="col-sm-7 col-xs-12">
                                            <input type="submit" value="SOUMETTRE" class="btn btn-primary btn-lg" id="inforSubmit">
                                        </div>
                                        <label class="col-sm-3 hidden-xs"></label>
                                    </li>
                                </ul>
