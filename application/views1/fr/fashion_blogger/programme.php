...
?>
    <section id="main">
      ...
      <section class="container">
        <div class="blogger-img hidden-xs">
          <div class="step-nav step-nav1">
                        <ul class="clearfix">
                            <li class="current">Programme de Fashion<em></em><i></i></li>
        ...
        <p class="hidden-xs img-active">
          <img src="<?php echo STATICURL; ?>/assets/images/blogger/blogger-fr.jpg" border="0" usemap="#Map" />
                <map name="Map" id="Map">
      ...
      <section class="visible-xs-block hidden-sm hidden-md hidden-lg blogger-step1-phone">
        <div class="col-xs-12">
          <p><a href="<?php echo LANGPATH; ?>/blogger/read_policy">Soumettre les informations</a>
          </p>
          <p><a href="<?php echo LANGPATH; ?>/blogger/get_banner?shortcut">Obtenir un banner.</a>
          </p>
        </div>
      </section>
    </section>
