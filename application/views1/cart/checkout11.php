                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-md-4">
                            <a href="https://trustsealinfo.websecurity.norton.com/splash?form_file=fdf/splash.fdf&amp;dn=<?php echo URLSTR; ?>&amp;lang=en" target="_blank"><img src="/assets/images/card-pay.png"></a>
                        </div>
                    </div>
                </div>
            </div>
...
function btn_loading()
{
    ...
    $.ajax({
        ...
        success: function(data){
            if(data.success == 1){
        $("#payment_form").attr('action',  '<?php echo BASEURL; ?>'+'/payment/gc_pay/'+data.ordernum);
        document.getElementById('checkoutbtn').style.display = 'none';
