	...
	<div class="container">
		<div class="crumbs">
			<div>
				...
				<a href="<?php echo LANGPATH; ?>/mobile-left" class="visible-xs-inline hidden-sm hidden-md hidden-lg"> > HILFE ZENTRUM</a> > Größentabelle
			</div>
		</div>
	</div>
	<!-- main-middle begin -->
...
<?php echo View::factory('/doc/de/left'); ?>
			<article class="user col-sm-9 col-xs-12">
				...
				<div class="doc-box help">
					<p>Wir wollen Ihnen nicht etwas schicken das nicht richtig passt. Bitte benutzen Sie diese Größentabelle, um richtige Größe zu wählen. Wenn Sie Größe wählen, bitte prüfen Sie detaillierte Informationen über jede Produkte, weil die Größe manche Marke anders ausfallen kann. Falls Sie Größe Probleme haben oder weitere Informationen wünschen, kontaktieren Sie bitte unseren Kundenservice.</p>
					
					<h5 class="mb10">So wird gemessen:</h5>
					...
					<ul class="col-xs-12 mb20">
						...
						<li class="col-sm-5 col-xs-12"><img alt="" src="<?php echo STATICURL; ?>/assets/images/<?php echo LANGPATH; ?>/docs/size-guide5.jpg"></li>
					...
					<div class="size-guide-wrapper col-xs-12">
						<div class="clothing-single-size-conversion-wrapper table-responsive">
							<table id="size-guide" class="user-table user-table1" border="0" title="This is a table to display CHOIES size guide data">
								<tbody>
	                                <tr class="caption">
	                                    <th colspan="13">BEKLEIDUNG -  EINZELGRÖSSENKONVERTIERUNG</th>
	                                </tr>
	                                <tr>
	                                ...
	                                <tr>
	                                    <td class="highlight">Australien</td>
	                                    <td>4</td>
	                                    <td>6</td>
	                                    <td>8</td>
	                                    <td>10</td>
	                    ...
	                    <div class="clothing-single-size-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                <tr class="caption">
	                                    <th colspan="25">BEKLEIDUNG - EINZELGRÖSSE</th>
	                                </tr>
	                                <tr>
	                                    <th class="highlight">Einzelgröße</th> <th colspan="2">UK 4</th> <th colspan="2">UK 6</th> <th colspan="2">UK 8</th> <th colspan="2">UK 10</th> <th colspan="2">UK 12</th> <th colspan="2">UK 14</th> <th colspan="2">UK 16</th> <th colspan="2">UK 18</th> <th colspan="2">UK 20</th> <th colspan="2">UK 22</th> <th colspan="2">UK 24</th> <th colspan="2">UK 26</th>
	                                </tr>
	                                <tr class="highlight">
	                                    <td>&nbsp;</td>
	                                    <td>CM</td>
	                    ...
	                    <div class="clothing-dual-size-p1-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                <tr>
	                                    <th class="highlight">Doppelgröße</th> <th colspan="2">UK XS<br />6</th> <th colspan="2">UK S<br />8-10</th> <th colspan="2">UK M<br />12-14</th> <th colspan="2">UK L<br />16-18</th> <th colspan="2">UK XL<br />20</th>
	                                </tr>
	                                <tr class="highlight">
	                                    <td>&nbsp;</td>
	                                    <td>CM</td>
	                    ...
	                    <div class="clothing-dual-size-p2-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                <tr class="caption">
	                                    <th colspan="6">BEKLEIDUNG - DOPPELGRÖSSE</th>
	                                </tr>
	                                <tr>
	                                    <td class="highlight">UK</td>
	                                    <td>XS</td>
	                    ...
	                    <div class="maternity-clothing-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                <tr class="caption">
	                                    <th colspan="15">SCHWANGERSCHAFTSBEKLEIDUNG</th>
	                                </tr>
	                                <tr>
	                                    <th class="highlight">Einzelgröße</th> <th colspan="2">8</th> <th colspan="2">10</th> <th colspan="2">12</th> <th colspan="2">14</th> <th colspan="2">16</th> <th colspan="2">18</th> <th colspan="2">20</th>
	                                </tr>
	                                <tr class="highlight">
	                                    <td>&nbsp;</td>
	                                    <td>CM</td>
	                    ...
	                    <div class="main-range-lengths-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                <tr class="caption">
	                                    <th colspan="11">HAUPTBEREICHSLÄNGE (AUF BASIS DER DURCHSCHNITTLICHEN GRÖSSE 10)</th>
	                                </tr>
	                                <tr class="highlight">
	                                    <th colspan="3">Hosen</th> <th class="table-split" rowspan="11">&nbsp;</th> <th colspan="3">Röcke</th> <th class="table-split" rowspan="11">&nbsp;</th> <th colspan="3">Kleid</th>
	                                </tr>
	                                <tr>
	                                    <td rowspan="2">Kurz</td>
	                                    <td class="highlight">Zoll</td>
	                                    <td>30</td>
	                                ...
	                                <tr>
	                                    <td rowspan="2">Lang</td>
	                                    <td class="highlight">Zoll</td>
	                                    <td>34</td>
	                                    <td rowspan="2">Knie</td>
	                                    <td class="highlight">Zoll</td>
	                                    <td>21&frac12;</td>
	                                    <td rowspan="2">Knie</td>
	                                    <td class="highlight">Zoll</td>
	                    ...
	                    <div class="petite-lengths-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                <tr class="caption">
	                                    <th colspan="11">PETITE LÄNGE (AUF BASIS DER DURCHSCHNITTLICHEN PETITE GRÖSSE 10)</th>
	                                </tr>
	                                <tr class="highlight">
	                                    <th colspan="3">Hosen</th> <th class="table-split" rowspan="11">&nbsp;</th> <th colspan="3">Röcke</th> <th class="table-split" rowspan="11">&nbsp;</th> <th colspan="3">Kleid</th>
	                                </tr>
	                    ...
	                    <div class="daul-sized-swimwear-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                <tr class="caption">
	                                    <th colspan="7">BADEMODE IN DOPPELGRÖSSE</th>
	                                </tr>
	                                <tr>
	                                    <td class="highlight">UK</td>
	                                    <td>8 B/C</td>
	                    ...
	                    <div class="underwear-wrapper table-responsive">
	                        <div class="bra-sizing-wrapper">
	                            <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                                <tbody>
	                                    <tr class="caption">
	                                        <th colspan="4">BH-GRÖSSEN</th>
	                                    </tr>
	                                    <tr class="highlight">
	                                        <th>UK</th> <th>Europa</th> <th>US</th> <th>Australien</th>
	                                    </tr>
	                                    <tr>
	                                        <td>32A</td>
	                                        <td>70A</td>
	                        ...
	                        <div class="hosiery-small-large-wrapper table-responsive">
	                            <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                                <tbody>
	                                    <tr class="caption">
	                                        <th colspan="4">Strumpfwaren (S-L)</th>
	                                    </tr>
	                                    <tr class="highlight">
	                                        <td>&nbsp;</td>
	                                        <td colspan="3">Kleid Größe</td>
	                                    </tr>
	                                    <tr class="increase-height">
	                                        <td class="highlight">Körpergröße</td>
	                                        <td>UK 8-10<br />35-37"</td>
	                                        <td>UK 12-14<br />39-41"</td>
	                                        <td>UK 16-18<br />43-46"</td>
	                                    </tr>
	                                    <tr>
	                                        <td class="highlight">Bis zu 5ft 3"</td>
	                                        <td>S</td>
	                                        <td>M</td>
	                                        <td>L</td>
	                                    </tr>
	                                    <tr>
	                                        <td class="highlight">Bis zu 5ft 6"</td>
	                                        <td>S</td>
	                                        <td>M</td>
	                                        <td>L</td>
	                                    </tr>
	                                    <tr>
	                                        <td class="highlight">Bis zu 5ft 10"</td>
	                                        <td>M</td>
	                                        <td>L</td>
	                                        <td>L</td>
	                                    </tr>
	                                    <tr>
	                                        <td class="highlight" colspan="4">
	                                            <p>*** Wenn Ihre Hüften und Körpergröße an der Grenze einer Größe liegen,<br />passt die nächste Größe Ihnen komfortabler ***</p>
	                                        </td>
	                                    </tr>
	                                </tbody>
	                            </table>
	                        ...
	                        <div class="hosiery-one-size-wrapper table-responsive">
	                            <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                                <tbody>
	                                    <tr class="caption">
	                                        <th colspan="3">STRUMPFWAREN (EINHEITSGRÖSSE)</th>
	                                    </tr>
	                                    <tr class="highlight">
	                                        <td>&nbsp;</td>
	                                        <td colspan="2">Kleid Größe</td>
	                                    </tr>
	                                    <tr class="increase-height">
	                                        <td class="highlight">Körpergröße</td>
	                                        <td>UK 8-10<br />35-37"</td>
	                                    ...
	                                    <tr>
	                                        <td class="highlight">Bis zu 5ft 4"</td>
	                                        <td>Einheitsgröße</td>
	                                        <td>Einheitsgröße</td>
	                                    </tr>
	                                    <tr>
	                                        <td class="highlight" colspan="3">
	                                            <p>*** Strumpfwaren in Einheitsgröße passen komfortabel für die UK-Größen 8-14<br />und eine Höhe von bis zu 5ft 4" ***</p>
	                                        </td>
	                                    </tr>
	                                </tbody>
	                            </table>
	                    ...
	                    <div class="footwear-wrapper table-responsive">
	                        <table class="user-table user-table1" title="This is a table to display CHOIES size guide data" border="0">
	                            <tbody>
	                                ...
	                                <tr>
	                                    <th class="highlight">Australien</th>
	                                    <td>4</td>
	                                    <td>5</td>
	                                    <td>6</td>
	                                    <td>7</td>
