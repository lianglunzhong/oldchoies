    ...
    if(empty(LANGUAGE))
    {
        $lists = Kohana::config('/category/category.en');
    }
    else
    {
        $lists = Kohana::config('/category/category.'.LANGUAGE);
    }
...
//小语言分类名翻译
    if(!empty(LANGUAGE))
    {
        $key = 'catalog_left_'.LANGUAGE.$catalog_id;
        ...
        if(empty($words))
        {
            ...
            foreach ($children as $key=>$v)
            {
                ...
                $children[$key] = array_merge($children[$key],$data);
            }
            Cache::instance('memcache')->set($key, $children, 86400*20);
        }
    }
    //}
    $scroll = 1;
...
<div class="list-main">
    ...
    <aside class="filter-left hidden-xs">
        ...
        <div class="category-list">
            ...
            {
            ?>
                <p class="down "><span class="list-detail-title"><?php echo $lists['Category']; ?></span>
            ...
            ?>
                <h3><?php echo $lists['REFINE BY']; ?>:</h3>
                <ul class="bar-l" id="bar">
                </ul>
                <p class="down no-line"><span class="list-detail-title"><?php echo $lists['Size']; ?></span>
                    <a class="fa fa-angle-up JS_down"></a>
                </p>
                <ul class="menu JS_menu hide double" id="size_ul" style="display: block;">
                </ul>
                <p class="down "><span class="list-detail-title"><?php echo $lists['Color']; ?></span>
                    <a class="fa fa-angle-up JS_down"></a>
                </p>
                <ul class="menu JS_menu hide double" id="color_ul" style="display: block;">
                </ul>
                <p class="down "><span class="list-detail-title"><?php echo $lists['Price']; ?></span>
                    <a class="fa fa-angle-up JS_down"></a>
                </p>
        ...
        <div class="filter-bar">
            ...
            <ul class="bar-r">
                <li class=" item-r pick <?php if($has) echo 'pick-on'; ?>">
                    <a href="<?php echo '?' . implode('&', $gets1); ?>" class=""> <?php echo $lists["Icon's Pick"]; ?></a>
                </li>
                <li class=" drop-down cs-show">
                    <span class="fll"><?php echo $lists['Sort By']; ?>&nbsp;</span>
                    <div class="drop-down-hd">
                            <?php
                            $small['en'] = array("Default","What's New", 'Best Seller', 'Price: Low To High', 'Price: High To Low');
                            $small['de'] = array('Standard','Was ist NEU', 'Bestseller', 'Preis: Niedrig zu Hoch', 'Preis: Hoch zu Niedrig');
                            $small['es'] = array('Defecto', 'Novedades', 'Mejor Vendido', 'Precio De Menor A Mayor', 'Precio De Mayor A Menor');
                            $small['fr'] = array('Défaut','Nouveautés', 'Popularité ', 'Prix Croissants', 'Prix Décroissants');
                            ...
                            $trns = $small[$lang];
                                ...
                                {
                                    $sname = str_replace($small['en'], $trns, $sort_by[$_GET['sort']]['name']);
                                    echo $sname;
                                }
                                else
                                {
                    ...
                    <ul class="drop-down-list cs-list" style="width:110%;">
                        ...
                        foreach ($sort_by as $key => $sort)
                        {
                            ...
                            $sname = str_replace($small['en'], $trns, $sort['name']);
                            ?>
    ...
    <div class="category-sidebar-container">
        <div class="sidebar-nav ">
            <h5 class="sort-nav-toggle JS-toggle">
                <span><b class="visible-phone"><?php echo $lists['SORT']; ?> &amp;</b> <?php echo $lists['REFINE']; ?><i class="fa fa-caret-down"></i></span>
            </h5>
            ...
            <div class="sort-nav-section JS-toggle-box hide" id="phone_filter" style="overflow: hidden; display: none;">
                ...
                ?>
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle " href="javascript:void(0);"><?php echo $lists['Category']; ?><i class="fa fa-caret-down flr"></i></a>
                        </div>
                ...
                ?>
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle " href="javascript:void(0);"><?php echo $lists['Size']; ?><i class="fa fa-caret-down flr"></i></a>
                        </div>
                        <div class="accordion-body JS-toggle-box hide">
                            <div class="accordion-inner">
                    ...
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle " href="javascript:void(0);"><?php echo $lists['Price']; ?><i class="fa fa-caret-down flr"></i></a>
                        </div>
                        <div class="accordion-body JS-toggle-box hide">
                            <div class="accordion-inner">
                    ...
                    <div class="accordion-group visible-phone">
                        <div class="accordion-heading JS-toggle">
                            <a class="accordion-toggle" href="javascript:void(0);"><?php echo $lists['Color']; ?><i class="fa fa-caret-down flr"></i></a>
                        </div>
                        <div class="accordion-body JS-toggle-box hide">
                            <div class="accordion-inner">
...
<div id="bar1" class="hide"><?php echo $lists['Clear All'];?></div>
