...
<link type="text/css" href="<?php echo LANGPATH; ?>/css/freetrial.css" rel="stylesheet">
<style>
...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Home Page</a>  >  Free Trial</div>
        </div>
    </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="trial_report">
                ...
                <ul class="trial_report_listcon fix">
                    ...
                    if (!empty($reports)):
                        ...
                        foreach ($reports as $report):
                            ?>
                            <li>
                                <a href="<?php echo LANGPATH; ?>/freetrial/reports/<?php echo $report['id']; ?>"><img src="<?php echo 'http://img.choies.com/simages/' . $report['image']; ?>" width="255" height="340" /></a>
                ...
                <div class="bottom"><a href="<?php echo LANGPATH; ?>/freetrial/reports">view more >></a></div>
            </div>
        </section>
