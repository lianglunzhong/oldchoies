                ...
                <div class="col-sm-12 col-md-12">
                    <div class="step-nav">
                        <ul class="clearfix">
                            ...
                            <li class="current">Pagar<em></em><i></i></li>
            ...
            <div class="row">
                    ...
                    <div class="shipping-information">
                        <div class="information-con">
                            ...
                            <div class="billing-address" id="payment_address">
                                ...
                                <a href="javascript:;" class="red JS-popwinbtn1">Editar</a>
                            </div>
                        ...
                        <div class="payment-wrap">
                            <div class="payment-p">
                                <div class="payment-message">
                                    <div class="fll mr20">Importe del Pedido: 
                                        <span class=" f16 bold"><?php echo round($order['amount'], 2) . ' ' . $order['currency']; ?></span>
                                    </div>
                                    <div class="fll">Numero de Pedido:<span class=" f16 bold"><?php echo $order['ordernum']; ?></span></div>
                                </div>
                                <div class="clearfix"></div>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                    <ul>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Tipo de Tarjeta de Crédito</label>
                                        ...
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Numero de Tarjeta de Crédito</label>
                                            <div class="payment-card-time">12-19 dígitos, no se permiten espacios</div>
                                            <div class="card-num">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="card_error">El numero de tarjeta de crédito es incorrecto.</div>
                                        </li>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Fecha de Vencimiento</label>
                                            <?php
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment-card-time fl">Mes</div>
                                            </div>
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment-card-time fl">Año</div>
                                            </div>
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="expire_error">El mes de la fecha de vencimiento es incorrecto.</div>                                                               
                                        </li>
                                        <li class="clearfix">
                                            <label class="payment-td-right bold"><em>*</em>Código de Seguridad <span style="font-weight:normal; color:#999">(CVV/CVC)</span></label>
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="error hide" id="cvv_error">Por favor introduzca un 3-dígito CVV/CVC código.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="PAGAR AHORA" id="paybutton" name="paybutton" class="btn btn-primary btn-lg" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                ...
                <div class="col-xs-12 col-sm-4 col-sm-offset-1">
                    <div class="order-summary">
                        <div class="cart-side">
                            <p>
                                <strong>Tarjetas de crédito acceptadas</strong>
                                Aceptamos VISA, Electron, MasterCard y VISA de débito o Mastercard de débito.<br>
                                Si Utiliza otra tarjeta (por ejemplo Discover o American Express), por favor pague con <a style="text-decoration:underline;" href="<?php echo LANGPATH; ?>/order/view/13255451340" target="_blank">PayPal</a> en cambio.
                                <br>
                                <br>
                                <strong>60-día Política de Reembolso</strong>
                                Si usted no queda completamente satisfecho con alguno de nuestros productos, puede enviar un email a  
                                <a style="text-decoration:underline;" href="mailto:service@choies.com" target="_blank">service@choies.com</a> 
                                para obtener una autorización de devolución (la dirección de devolución) o cambio dentro 60 días al recibir.
                            </p>
                            <div class="add-payment">
                                <strong>Seguridad de pago adicional con:</strong>
                                <span class="encryption"><b></b>Pago Seguro  256-Bit SSL encriptación por Norton</span>
                                <span>
...
<div class="loading" id="payment_wrap2" style="display:none;">
    <div class="loading-box">
        ...
        <div class="loading-prompt">Cargando, espere un momento!</div>
        </div>
    </div>
</div>
        ...
        <form action="<?php echo LANGPATH; ?>/order/edit_address/<?php echo $order['id']; ?>" method="post" class="form payment-form form1">
            ...
            <ul>
                ...
                <li>
                    ...
                    <label class="error hide" style="display:none;" generated="true" id="guo_fon">Parece que no existen dígitos en el código, por favor revise la exactitud.</label>
