...
<style>
    ...
    .close_btn3 {right: 10px;top: 10px;background: url("<?php echo STATICURL; ?>/ximg/icons.png") no-repeat scroll -34px -568px transparent;cursor: pointer;display: inline-block;height: 24px;position: absolute;width: 24px;}
...
<div class="JS_popwincon1 dwrapper" id="lang_change" style="display:none;">
    ...
    <div class="dcontent">
        <div class="dwrap">
          <p><img src="<?php echo STATICURL; ?>/ximg/daoliu.jpg"></p>
        </div>
        <form action="<?php echo LANGPATH; ?>/site/change_country" method="post">
...
<script>
    $(function(){
        ...
        $("#lang_close, #stay_on").click(function(){
            $.ajax({
                url:'<?php echo LANGPATH; ?>/site/change_country',
                type:'POST',
                data:{
                    lang_close: 1,
                },
