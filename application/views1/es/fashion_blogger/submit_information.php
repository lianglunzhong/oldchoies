			...
			<div class="blogger-img hidden-xs">
				<div class="step-nav step-nav1">
	                <ul class="clearfix">
	                    ...
	                    <li class="current">Presentar Información<em></em><i></i></li>
    ...
    <?php echo Message::get(); ?>
			<article class="row blogger-form">
				...
				<div class="col-sm-8 col-xs-12">
					<div class="fashion-tit">PRESENTAR INFORMACIÓN</div>
					<div>
						<div class="sub-info">
							<form class="form" id="submitInfo" method="post" action="">
								<ul>
									<li>
										<label class="col-sm-2 col-xs-12"><span>*</span> Email:</label>
									...
									<li>
										<label class="col-sm-2 col-xs-12"><span>*</span> Sexo:</label>
										<div class="col-sm-7 col-xs-12">
									...
									<li>
										<label class="col-sm-2 col-xs-12"><span>*</span> País:</label>
										<div class="col-sm-7 col-xs-12">
									...
									<li>
										<table id="tab" class="col-xs-12">
											<tbody>
												<tr>
													<td>
														<label class="col-sm-2 col-xs-12"><span>*</span> Tipo Sitio principal: </label>
														<div class="col-sm-7 col-xs-12">
												...
												<tr>
													<td>
														<label class="col-sm-2 col-xs-12"><span>*</span> URL del sitio principal: </label>
														<div class="col-sm-5 col-xs-12">
															<input type="text" class="sub-info-text col-xs-12" name="sites[url][]" id="url">
														</div>
														<label class="col-sm-2 col-xs-12"><span>*</span> Fans / Seguidores: </label>
									...
									<li style="margin-top:0;">
										...
										<div class="col-sm-7 col-xs-12">
											<input type="button" onclick="AddNewRow()" value="Añadir uno más sitio" class="add-more" name="Submit">
										</div>
									...
									<li>
										<label class="col-sm-2 col-xs-12"><span>*</span> Mensaje:</label>
										<div class="col-sm-7 col-xs-12">
										<?php
										$message_value = 'Escribe algo para presentarse y cuál es su idea de la moda. Gracias!';
										?>
									...
									<li>
										...
										<div class="col-sm-7 col-xs-12">
											<input type="submit" value="PRESENTAR" class="btn btn-primary btn-lg" id="inforSubmit">
										</div>
										<label class="col-sm-3 hidden-xs"></label>
									</li>
								</ul>
...
function findObj(theObj, theDoc) {
	    ...
	    function AddNewRow() {
	        ...
	        for (var i = 0; i < columnLength1; i++) {
	            if (i == 0) {//第一列:序号
	                newTR1.insertCell(i).innerHTML = "<label class='col-sm-2 col-xs-12'><span>*</span>URL del sitio principa:</label><div class='col-sm-5 col-xs-12'><input type='text' id='url_"+i+"' name='sites[url][]' class='sub-info-text col-xs-12'></div><label class='col-sm-2 col-xs-12'><span>*</span>Fans / Seguidores:</label><div class='col-sm-2 col-xs-12'><input id='flow_"+i+"' class='sub-info-text col-xs-12' type='text' name='sites[flow][]'></div><div align='left' class='col-sm-1 col-xs-12'><a style='color:black;text-decoration:underline;' href='javascript:' onclick=\"DeleteSignRow('SignItem" + (rowID+1) + "')\">Borrar</a></div>";
	            } 
	        }
	        //将行号推进下一行
