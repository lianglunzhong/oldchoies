        ...
        <section class="cart">
            <section class="shipping_delivery fix">
                <article class="shipping_delivery_left payment_box">
                    ...
                    <div>
                        ...
                        <div id="payment_address" class="mb25" style="border: 1px solid #D6D5D5;padding: 15px;margin-bottom: 30px;height: 67px;width: 660px;">
                            <div style="background: #f8f8f8;font: bold 16px Arial;margin-bottom: 15px;">DIRECCIÓN DE FACTURACIÓN</div>
                            ...
                            <a href="#" class="a_red JS_popwinbtn1" style="font-style: italic;font-size:12px;margin-left:3px;">Editar</a></dt>
                        </div>
                        ...
                        <div id="payment_wrap">
                            <div class="payment_p">
                                ...
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                    <ul>
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Tipo de Tarjeta de Crédito</label>
                                        ...
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Numero de Tarjeta de Crédito</label>
                                            <div class="payment_card_time" style="margin: 0 0 -10px 15px;">12-19 dígitos, no se permiten espacios</div>
                                            <div class="card_num">
                                            ...
                                            <div class="fix"></div>
                                            <div class="error" id="card_error">El numero de tarjeta de crédito es incorrecto.</div>
                                        </li>
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Fecha de Vencimiento</label>
                                            <?php
                                            $now_month_list = '<option value="0"> Mes </option>';
                                            $all_month_list = '<option value="0"> Mes </option>';
                                            $m = date('m');
                                            ?>
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">Mes</div>
                                            </div>
                                            <div class="fll">/</div>
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">Año</div>
                                            </div>
                                            <div class="fix"></div>
                                            <div class="error" id="expire_error">El mes de la fecha de vencimiento es incorrecto.</div>                                                               
                                        </li>
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Código de Seguridad <span style="font-weight:normal; color:#999">(CVV/CVC)</span></label>
                                            ...
                                            <div class="fix"></div>
                                            <div class="error" id="cvv_error">Por favor introduzca un 3-dígito CVV/CVC código.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="PAGAR AHORA" id="paybutton" name="paybutton" class="btn40_16_red" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                ...
                <div class="order_summary flr">
                    ...
                    <strong style="color:#000;">Tarjetas de crédito acceptadas</strong><br /><br />
                    Aceptamos VISA, Electron, MasterCard y VISA de débito o Mastercard de débito.<br />
                    Utilizar la tarjeta (por ejemplo Discover o American Express) en cambio, usted puede pagar con <a style="text-decoration:underline;" href="/order/view/<?php echo $order['ordernum']; ?>" target="_blank">PayPal</a>.<br /><br />
                    <strong style="color:#000;">60-día Política de Reembolso</strong><br /><br />
                    Si usted no queda completamente satisfecho con alguno de nuestros productos, puede enviar un email a <a style="text-decoration:underline;" href="mailto:service@choies.com" target="_blank">service@choies.com</a> para obtener una autorización de devolución (la dirección de devolución) o cambio dentro 60 días al recibir.
                    </p>
                    <div style="padding:15px;">
                        <strong style="display:block; font-style:italic;">Seguridad de pago adicional con:</strong>
                        <span style="font-size:11px; color:#999;"><img class="mr10" style="vertical-align:middle" src="/images/nor-lock.png" />Pago Seguro  256-Bit SSL encriptación por Norton</span>
...
function checkFormData()
{
    ...
    if(cardNo.length == 0)
    {
        ...
        $popup_message.innerHTML = 'Por favor, introduzca su número de tarjeta.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(month == 0)
    {
        ...
        $popup_message.innerHTML = 'Por favor, seleccione la fecha de vencimiento.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    { 
        $popup_message = document.getElementById('expire_error');
        $popup_message.innerHTML = 'La fecha de vencimiento es invalida.';
        $popup_message.style.display = 'block';
        error = 1;
    }
    ...
    if(cvv2.length != 3 || reg.test(cvv2) != true)
    {
        ...
        $popup_message.innerHTML = 'Por favor introduzca un 3-dígito CVV/CVC código.';
        $popup_message.style.display = 'block';
        error = 1;
    }
