<div class="fix">
        <span class="pr-nums fll"><?php echo $total_items; ?> Registros Encontrados</span>
        <div class="page flr">
                PÁGINA: 
                <?php if ($previous_page !== FALSE): ?>
                        <span class="prev_btn1"><a href="<?php echo $page->url($previous_page); ?>" rel="nofollow">ANTERIOR</a></span>
                <?php endif; ?>
                <?php
                if ($total_pages < 8)
                {
                ...
                <?php if ($next_page !== FALSE): ?>
                        <span class="next_btn1"><a href="<?php echo $page->url($next_page); ?>" rel="nofollow">SIGUIENTE</a></span>
                <?php endif; ?>
        </div>
