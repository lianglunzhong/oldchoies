    ...
    <div style="background:#fff; height: 280px;" id="inline_example2">
        <div class="login">
            ...
            <div class="login_l fll ml10">
                ...
                <form id="loginForm" method="post" action="/customer/login?redirect=activity/matchtowin#step2" class="">
                    <ul>
                        <li>
            ...
            <div class="login_l fll">
                ...
                <form id="registerForm" method="post" action="/customer/register?redirect=activity/matchtowin#step2" class="">
                    <ul>
                        <li>
                            <label><span>*</span> Email:</label>
