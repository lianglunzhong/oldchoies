...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">PÁGINA DE INICIO</a>  >  FLASH SALE</div>
        </div>
    </div>
            ...
            <article class="cate-sales flash_sale_prolist">
                ...
                ?>
                    <li>
                        <div class="JS_shows_btn1">
                            ...
                            <form action="#" method="post" class="JS_shows1 show2 hide">
                                ...
                                if($count_attr == 1 AND strtolower($attributes['Size'][0]) == 'one size')
                                {
                                    ...
                                    $brief = str_replace(array(',', 'Size'), array(', ', 'Talla'), $brief);
                                    echo $brief; 
                                    ?>
                                    </span>
                                    <?php
                        ...
                        <p class="price"><?php echo Site::instance()->price($price, 'code_view'); ?> <span>(<?php echo $off; ?>% MENOS)</span></p>
                        ...
                        if($count_attr == 1)
                        {
                            ...
                            ?>
                            <a class="btn add_to_bag" href="javascript:;" attr-id="<?php echo $w['product_id']; ?>" attr-size="<?php echo $choose_size; ?>">AÑADIR A BOLSA</a>
                            <?php
                        }
                        else
                        {
                            ?>
                            <a class="btn btn1 quick_view" id="<?php echo $w['product_id']; ?>" attr-key="<?php echo $key; ?>" href="javascript:;">Seleccione Talla</a>
                            <?php
                        }
                        ?>
                        <div class="saletime">
                            <div class="JS_daoend<?php echo $key; ?> hide">Tiempo Ha Terminado!</div>
                ...
                <a href="<?php echo $index_banners[1]['link']; ?>" <?php if(strpos($index_banners[1]['link'], 'http') !== False) echo 'target="_blank"'; ?>>
                    <img src="/uploads/1/files/<?php echo $index_banners[1]['image']; ?>" alt="<?php echo $index_banners[1]['alt']; ?>" title="<?php echo $index_banners[1]['title']; ?>" width="1020"  />
                </a>
	            </div>
                ...
                <div class="tab-bottom">
                    ...
                    ?>
                        <div class="v_show" <?php if($key1 > 1) echo 'style="display:none"'; ?>>
                            ...
                            <div>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/<?php echo $usd; ?>" style="color:#ff0000;text-decoration:underline;font-weight:bold;text-align:center;font-size:18px;padding:0 0 15px 0;display:block;" ><i>VER MAS</i></a> 
                            </div>
                        </div>
                    <?php
                    }
            ...
            <div class="myImages fll">
                ...
                ?>
                    <div class="saletime1" id="saletime<?php echo $i; ?>" style="display:none;">
                       <div class="JS_daoend<?php echo $i; ?>" style="display:none;">Tiempo Ha Terminado!</div>
                       <div class="JS_dao<?php echo $i; ?>">¡Tiempo restante:<span style="color:#d8261a;"> <strong class="JS_RemainD<?php echo $i; ?>"></strong>d <strong class="JS_RemainH<?php echo $i; ?>"></strong>h <strong class="JS_RemainM<?php echo $i; ?>"></strong>m <strong class="JS_RemainS<?php echo $i; ?>"></strong>s</span></div>
                    </div>
                <?php
                }
                ?>
        ...
        <dl>
            <dd>
              ...
              <p style="padding-bottom:12px;color:#999;">
                ...
                <span id="jr"><a href="#" target="_blank" id="product_link">Ver Detalles Completos</a></span>
                </p>
                </div>
            </dd>
            ...
            <dd class="last">
                ...
                <div id="action-form">
                    <form action="#" method="post" id="formAdd">
                        ...
                        <div class="total">
                            <input type="submit" class="btn40_16_red" id="addCart" value="AÑADIR A BOLSA">
                        </div> 
                    </form>
                </div>
