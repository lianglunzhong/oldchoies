...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  Find Something</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="fix find">
                <div>
                    <img src="/images/activity/end_1.png" alt="Winner List" usemap="#Map2" style="display:block;"  title="Winner List" border="0"/>
                    ...
                    <a href="https://www.choies.com/find-something" target="_blank"><img src="/images/activity/end_2.jpg" alt="Find Something" style="display:block;" border="0" title="Find Something"/></a>
                    <a href="https://www.choies.com/find-something" target="_blank"><img src="/images/activity/end_3.jpg" alt="Find Something" title="Find Something" style="display:block;" border="0"/></a>
                    <a href="https://www.choies.com/find-something" target="_blank"><img src="/images/activity/end_4.jpg" alt="Find Something" title="Find Something" style="display:block;" border="0"/></a>
                    <img src="/images/activity/end_5.png" alt="" style="display:block;" border="0"/>
                </div>
            </div>
    ...
    <div style="background:#fff; height: 280px;" id="inline_example2">
        <div class="login">
            ...
            <div class="login_l fll ml10">
                ...
                <form id="loginForm" method="post" action="/customer/login?redirect=activity/findsomething#step2" class="">
                    <ul>
                        <li>
            ...
            <div class="login_l fll">
                ...
                <form id="registerForm" method="post" action="/customer/register?redirect=activity/findsomething#step2" class="">
                    <ul>
                        <li>
                            <label><span>*</span> Email:</label>
