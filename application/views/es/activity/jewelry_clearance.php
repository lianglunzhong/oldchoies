...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  Jewelry Clearance</div>
        </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            <div class="lp_jewelry wid805">
                <p class="mb25"><img src="/images/activity/lp_jewelry_img.jpg" /></p>
                <?php
                    ...
                    <div class="pro_listcon">
                        <ul class="fix">
                            ...
                            foreach ($datas as $data):
                                $product = Product::instance($data['product_id']);
                                if (!$product->get('id'))
                                    continue;
...
<!--                                    <span class="outstock">out of stock</span>-->
                ...
                <div class="flv_product_details_nav JS_cart_side" style="position: fixed; top: 210px; right: 98px;">
                    <li onclick="goto(1);"><img src="/images/activity/lp_jewelry_nav1.jpg" /></li>
                    <li onclick="goto(2);"><img src="/images/activity/lp_jewelry_nav2.jpg" /></li>
                    <li onclick="goto(3);"><img src="/images/activity/lp_jewelry_nav3.jpg" /></li>
                    <li onclick="goto(4);"><img src="/images/activity/lp_jewelry_nav4.jpg" /></li>
                    </map>
                </div>
            </div>
        </section>
