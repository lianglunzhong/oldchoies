...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  Giveaway</div>
        </div>
        ...
        <div style="background:#fff; height: 280px;" id="inline_example2">
                <div class="login">
                        ...
                        <div class="login_l fll ml10">
                                ...
                                <form id="loginForm" method="post" action="/customer/login?redirect=<?php echo URL::current(TRUE); ?>#step2" class="">
                                        <ul>
                                                <li>
                        ...
                        <div class="login_l fll">
                                ...
                                <form id="registerForm" method="post" action="/customer/register?redirect=activity/hair_extensions_giveaway#step2" class="">
                                        <ul>
                                                <li>
                                                        <label><span>*</span> Email:</label>
