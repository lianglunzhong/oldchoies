<link rel="canonical" href="/<?php echo $catalog_link; ?>" />
	...
	<div class="grid">	
        ...
        <div class="homecoming-top">
        	<p><img src="/images/activity/homecome-es.jpg" width="1024" height="300"></p>
            <div class="homecoming-filter">
                <p class="filter-instruction">COMPRAR POR CATEGORÍAS</p>
                <ul class="filter-main detail-tab fix">
                    <li class=" current" id="a1" style="width: 198px;margin: 80px 0 -1px 215px;color:#a64384;">VESTIDOS DE FIESTA</li>
                    <li class="" id="a2" style="width: 198px;margin: 80px 0 -1px 0;color:#b75454;">ZAPATOS DE FIESTA</li>
                    <li class="" id="a3" style="width: 198px;margin: 80px 0 -1px 0;color:#466b88;">ACCESORIOS</li>
                    <p style="left: 213px;">
                        <b></b>
                    </p>
                </ul>                     
			...
			<?php
			 foreach ($weekly1 as $key => $w){   
				...
				<li class="pro-item">
					...
					<a href="#" id="<?php echo $product->get('id'); ?>" class="quick_view JS_shows1"><span class="btn-qv">VISTA RÁPIDA</span></a>
					<div class="add-wish">
...
<script type="text/javascript" charset="utf-8" src="/js/lazyload.js"></script>
	...
	$("#a1").click(function(){
    $.post(
        '/activity/ajax_homecome?lang=es',
        {
