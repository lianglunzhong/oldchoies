...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  Informes de Prueba Gratis</div>
        </div>
                ...
                <div class="report_details fix">
                                ...
                                <ul class="fix JS_pro_small">
                                    ...
                                    foreach ($product->images() as $image):
                                        ...
                                        if ($key > 3)
                                            break;
                                        ?>
                                        <li<?php if ($key == 1) echo ' class="current"'; ?>><img src="<?php echo Image::link($image, 3); ?>" imgb="<?php echo Image::link($image, 2); ?>" width="102px" /></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="right">
                        <div class="right_top">
                            ...
                            <span>artículo#: <?php echo $product->get('sku'); ?></span>
                            <p class="price">Precio ahora: <?php echo Site::instance()->price($product->price(), 'code_view'); ?> <a href="<?php echo $product->permalink(); ?>" class="view_btn btn26 btn40">COMPRAR AHORA</a></p>
                        </div>
                        <div class="right_trial">
                            <div class="right_tit"><h4>Informes de Prueba Gratis</h4></div>
                            <div class="right_con">
