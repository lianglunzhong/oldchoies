...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Página de Inicio</a>  >  Prueba Gratuita</div>
        </div>
    </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="trial_winners">
                <h3>Los ganadores de la semana pasada</h3>
                <ul class="fix">
                    <?php
                ...
                <p><a href="mailto:lisaconnor@choies.com" class="a_red" title="Mail to Lisa">Lisa</a> se comunicará con usted más tarde con los detalles.</p>
            </div>
            ...
            foreach ($products as $k => $pid):
                ...
                <div class="report_details fix">
                    ...
                    <div class="right">
                        ...
                        <dl>
                            <dt class="fix">
                            <span class="left">PRUEBA GRATUITA</span>
                            <!-- time left -->
                            <div class="timeleft_box" style="float:right;">
                                <div class="JS_daoend hide">Tiempo ha terminado!</div>
                            ...
                            <dd>
                                <ul class="price">
                                    <li>
                                        <span>Precio: <del><?php echo Site::instance()->price($product->price(), 'code_view'); ?></del></span>
                                        <label class="f00">$0.00</label></li>
                                    <li><span>El costo de envío:</span> <label class="f00">$0.00</label></li>
                                    <li class="m">
                                        <span><em class="f00"><?php echo $chances[$k]; ?></em> Oportunidad<?php echo $chances[$k] > 1 ? 'es' : ''; ?></span>
                                        <label><em class="f00"><?php echo $quantitys[$pid]; ?></em> Aplicaciones</label>
                                    </li>
                                    <li><a href="javascript:;" onclick="show_facebook_div('<?php echo $pid; ?>','1');" class="view_btn btn26 btn40">Aplicar de forma gratuita</a></li>
                            ...
                            <dt>Ansioso por llegar</dt>
                            <dd>
                                <p>¿No puede esperar para conseguir uno?</p>
                                <p><a href="<?php echo $link; ?>" class="view_btn btn26 btn40">COMPRAR AHORA</a></p>
                            </dd>
                            <dt>DESCRIPCIÓN:</dt>
                            <dd>
                                <dl>
            ...
            <div class="trial_report">
                <h2>Feedback de los ganadores</h2>
                    ...
                    if (!empty($reports)):
                        ...
                        foreach ($reports as $report):
                            ...
                            <li>
                                ...
                                <a href="<?php echo LANGPATH; ?>/freetrial/reports/<?php echo $report['id']; ?>" class="view_btn btn26 btn40">VER DETALLES</a>
                            </li>
                            <?php
                        endforeach;
                    endif;
                ...
                <div class="bottom"><a href="<?php echo LANGPATH; ?>/freetrial/reports">VER MAS >></a></div>
            </div>
        </section>
...
<div class="share1" id="share" style="display:none;">
    ...
    <div class="clear">
        <h2 style="font-size: 21px;">Completa los 2 Tareas debajo<br/>para tener una oportunidad de ganar la prueba gratuita!</h2>
    </div>
    <div class="share_main">
        <div class="fix">
            <div class="task_num" style="line-height:114px;">Tarea 1</div>
            <div class="task_share">
                <p>Nos gusta en Facebook</p>
                <img src="/images/choies_fblogo.jpg"/>
                <span>Choies calle Fashion Sketch</span>
                ...
                <p id="trial_facebook_like_error" class="error">Tiene que gustar primero.(Paso 1).</p>
            </div>
        </div>
    </div>
    <div class="share_main">
        <div class="fix">
            <div class="task_num" style="line-height:90px;">Tarea 2</div>
            <div class="task_share">
                <p>Comparte esta versión de prueba gratis</p>
...
<div class="share_success" id="share1" style="display:none;">
    ...
    <div style="margin:0 50px;">
        <h5 class="clear" style="padding-top:0;"><strong>Comparte esto a sus amigos en Facebook</strong></h5>
        <form  method="post" action="#" class="formArea" onsubmit="return false;">
            ...
            <input type="submit" value="ENVIAR" class="btn_post flr" onclick="set_facebook_share();" />
        </form>     
    </div>
</div>
<div class="share_success" id="share2" style="display:<?php echo $show_success ? 'inline' : 'none' ?>;">
    ...
    <div class="suc" style="background:url(/images/freebie/bg_success.jpg) bottom no-repeat;">
        <p style="font:48px/58px Georgia, 'Times New Roman', Times, serif;">¡Felicitaciones!</p>
        <p style="font-size:16px; font-weight:bold;">Ha completado estas tareas con éxito.</p>
        <p style="color:#900;">Se le notificará a través de Email de su cuenta en facebook si usted gana.</p>
    </div>
</div>