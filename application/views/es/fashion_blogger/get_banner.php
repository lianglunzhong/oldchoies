...
<section id="main">
    <div class="layout" style="margin-top:30px;background: #fff;">
        <div class="tit blogger_wanted mb25">
            <span>Blogger De Moda</span><span>Leer La Política</span><span>Presentar Información</span><span class="on">Conseguir Una Bandera</span>
            <img src="/images/de/blogger_wanted4.png" />
        </div>
        <div class="fashion_tit">Conseguir Una Bandera</div>
        <div class="fashion_policy">
            <p>Elige tu favorito VIP Icon de Choies, haga clic en la imagen para obtener el código.</p>
            <p>Si está de acuerdo de añadir choies bandera a la página principal de tu blog, página de lookbook, u otros sitios de plataforma de la manera, obtendrá más regalos. Pero usted debe tener muchos fans. </p>
            <p>Si usted posee una cuenta de youtube donde no se permite la bandera, puede agregar nuestro enlace <a href="<?php echo LANGPATH; ?>/" title="choies.com" class="red"> http://<?php echo $domain; ?></a>.</p>
        </div>
        ...
        <div id="cboxWrapper" style="height: 368px; width: 472px;"><div>
            ...
            <div style="clear: left;"><div id="cboxMiddleLeft" style="float: left; height: 318px;"></div>
                <div id="cboxContent" style="float: left; width: 422px; height: 318px;">
                    ...
                    <div class="closebtn" class="" style="right: 43px;">Cerrar</div>
                </div>
