...
<div class="page">
    ...
    <?php if ($previous_page !== FALSE): ?>
        <a href="<?php echo $page->url($previous_page); ?>" title="<?php echo $previous_page; ?>" class="prev_btn1" rel="nofollow">ANTERIOR</a>
    <?php endif; ?>
    <?php
    if ($total_pages < 8)
    {
    ...
    <?php if ($next_page !== FALSE): ?>
        <a href="<?php echo $page->url($next_page); ?>" title="<?php echo $next_page; ?>" class="next_btn1" rel="nofollow">SIGUIENTE</a>
    <?php endif; ?>
</div>
<?php endif; ?>
