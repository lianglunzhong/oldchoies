                        ...
                        <dd id="select_address" <?php if ($has_address OR empty($addresses)) echo ' class="hide"'; ?>>
                            ...
                            <div class="center">
                                <form action="<?php echo LANGPATH; ?>/cart/edit_address" method="post">
                                    <a class="view_btn btn26 JS_show_btn3">NEUE ADRESSE HINZUFÜGEN</a>
...
//                                if(strpos($message, 'code') !== FALSE)
    ...
    <!--                                        <span class="right flr">
                        ...
                        ?>
                        <dt>BEZAHLEN MIT PUNKTEN <span class="font11">(10 Punkte=$0.1)</span></dt>
                        <dd>
                            ...
                            <div class="points">
                                ...
                                if ($points_avail >= 0):
                                    ?>
                                    Maximale Cantidad der Punkte, die Sie möglicherweise bewerben :<span><?php echo $points_avail; ?> Punkte</span>
                                    <?php
                                else:
                ...
                <div class="order_summary flr">
                    <div class="JS_cart_side cart_side">
                            ...
                            foreach ($cart['products'] as $key => $product):
                                ...
                                <li class="fix">
                                    ...
                                    <div class="right">
                                        ...
                                        <p>Artículo: #<?php echo Product::instance($product['id'])->get('sku'); ?></p>
                                        ...
                                        <p>
                                            ...
                                            if (isset($product['attributes'])):
                                                foreach ($product['attributes'] as $attribute => $option):
                                                    if($attribute == 'Size') $attribute = 'Talla';
                        ...
                        <ul class="total">
                            <li><label>Teilsumme: </label><span><?php echo Site::instance()->price($cart['amount']['items'], 'code_view'); ?></span></li>     
                            ...
                            if ($cart['amount']['coupon_save'] + $cart['amount']['point'] > 0):
                                ?>
                                <li><label>Bezahlen Sie mit Coupons & Punkte: </label><span><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span></li>
                                <?php
                            endif;
                            ...
                            if ($item_saving > 0):
                                ?>
                                <li><label>Artículo Einsparungen: </label><span><?php echo Site::instance()->price($item_saving, 'code_view'); ?></span></li> 
                                <?php
                            endif;
                            ?>
                            <li class="total_num"><label>Gesamtbetrag: </label><span id="totalPrice"><?php echo $cart['amount']['shipping'] ? Site::instance()->price($cart['amount']['total'], 'code_view') : Site::instance()->price($cart['amount']['total'] + $default_shipping, 'code_view'); ?></span></li>
                            <?php
                            if ($saving):
                                ?>
                                <li class="last"><label>Einsparungen: </label><span><?php echo Site::instance()->price($saving, 'code_view'); ?></span></li>
                                <?php
                            endif;
                            ?>
                        </ul>
...
<div class="hide" id="cart_delete" style="position: fixed;padding: 10px 10px 20px; top: 170px;left: 400px; z-index:100px;z-index: 1000; background: #FFFFFF; border-color: #F6F6F7; border:1px solid #cdcdcd;">
    ...
    <div class="order order_addtobag center" style="margin:20px;">
        ...
        <form action="<?php echo LANGPATH; ?>/cart/delete_address" method="post">
            ...
            <a href="#" class="cancel" style="text-decoration:underline;margin-left:10px;">Abbrechen</a>
        </form>
    </div>
