    ...
    <div class="layout">
        ...
        <div class="cart_step">
            ...
            <div class="cart_step_bottom">
                ...
                <span class="on">Confirmación Del Pago</span>
    ...
    <form action="<?php echo LANGPATH; ?>/cart/edit_shipping" method="post" class="form user_share_form user_form" onsubmit="return setShipping(this);">
        ...
        <div class="shipping_methods s_price_list">
            <ul class="fix">
                ...
                {
                    $name1 = '4-7 Días Laborables Envío Exprés';
                    $site_shipping[1]['name'] = $name1;
					$name2 = '10-15 Días Laborables Envío Gratis';
            ...
            <p><input type="submit" value="PRESENTAR" class="btn30_14_black" /></p>
        </div>
    </form>
</div>
<section id="main">
    ...
    <section class="layout">
        <section class="cart fix">
            <article class="shipping_delivery_left">
                ...
                if ($show_address)
                {
                    ...
                    <div id="shippingAddressInfo" <?php if (!$show_address) echo 'style="display:none;"'; ?>>
                        <div class="information_con">
                            ...
                            ?>
                                <dt>
                                    Dirección de Envío  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address(<?php echo $cart['shipping_address']['shipping_address_id']; ?>, 1);">Editar</a>
                                    <?php
                                    if($count_address > 1)
                                    {
                                    ?>
                                        <a href="javascript:;" class="a_red" onclick="return change_address_show();">Cambiar</a>
                                    <?php
                                    }
                                    ?>
                                </dt>
                                <dd class="fix"><label>Nombre:</label><span><?php echo $cart['shipping_address']['shipping_firstname'] . ' ' . $cart['shipping_address']['shipping_lastname']; ?></span></dd>
                                <dd class="fix"><label>Tel:</label><span><?php echo $cart['shipping_address']['shipping_phone']; ?></span></dd>
                                <dd class="fix"><label>Dirección:</label><span><?php echo $cart['shipping_address']['shipping_address'] . ' ' . $cart['shipping_address']['shipping_city'] . ', ' . $cart['shipping_address']['shipping_state'] . ' ' . $shipping_country . ' ' . $cart['shipping_address']['shipping_zip']; ?></span></dd>
                            <?php
                            }
                            ?>
                            </dl>
                            <dl>
                                <dt>Método de Envío   <a href="" class="a_red JS_popwinbtn2" id="ship_edit" <?php if(in_array($cart['shipping_address']['shipping_country'], $no_express_countries)) echo 'style="display:none;"'; ?>>Editar</a></dt>
                                <dd>
                                    Envío:
                    ...
                    <dl class="shipping_add_address">
                        ...
                        <form action="" method="post" name="shipping_address_radio">
                                ...
                                <li id="address_li_<?php echo $value['id']; ?>">
                                    <div class="fix">
                                        ...
                                        <label for="radio<?php echo $key; ?>">
                                            <b class="s1">Dirección<?php echo $key + 1; ?></b>
                                            <div class="flr">
                                            <?php
                                            if ($key == $default_key)
                                            {
                                                ?>
                                                    <span class="b address_detault" id="detault_<?php echo $value['id']; ?>">Defecto</span>
                                                    <a href="javascript:;" class="a_underline address_detault_a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);" style="display:none;">Establecer Defecto</a>
                                                    <a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Editar</a>
                                                    <a href="javascript:;" class="view_btn btn26 delete_address" onclick="delete_address(<?php echo $value['id']; ?>);">Eliminar</a>
                                                <?php
                                            }
                                            else
                                            {
                                                ?>
                                                    <span class="b address_detault" id="detault_<?php echo $value['id']; ?>" style="display:none;">Defecto</span>
                                                    <a href="javascript:;" class="a_underline address_detault_a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);">Establecer Defecto</a>
                                                    <a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Editar</a>
                                                    <a href="javascript:;" class="view_btn btn26 delete_address" onclick="delete_address(<?php echo $value['id']; ?>);">Eliminar</a>
                                                <?php
                                            }
                            ...
                            <ul class="shipping_address" style="margin: 0;padding: 0 10px 10px 10px;">
                                <li class="fix last">
                                    <a href="javascrpt:;" class="a_underline JS_popwinbtn1" id="add_new_address" onclick="return new_address_show();">+Añadir Una Dirección Nueva</a>
                                </li>
                            </ul>
                            </form>
                        </dd>
				...
				<p class="phone_tips">Por favor ingresa 0000, si no se requiere un código postal en tu país.</p>
                            </li>
                            <li>
                        ...
                        <h4 class="mt10">MÉTODOS DE ENVÍO</h4>
                        <div class="shipping_methods s_price_list">
                            <ul class="fix">
                            <?php
                            foreach($site_shipping as $key => $price)
                        ...
                        <p><input id="spgInfoCountinue" type="submit" value="PAGO SEGURO" class="view_btn btn40 font18" /></p>
                    </form>
                </div>
                <div id="paymentInfo" <?php if(!$has_address) echo 'style="display:none;"'; ?>>
                    <h3 class="mt50">PAGO</h3>
                    <div class="shipping_bottom_line">
                        <div class="arrow-down"></div>
                    </div>
                    <form id="payment_form" method="post" action="" class="form form_box">
                        ...
                        ?>
                            <dd class="shipping_methods">
                              ...
                              <label for="radio_2">
                                ...
                                <p>Si no dipones de una cuenta Paypal, puedes pagar con tarjeta de crédito / débito a través de Paypal.</p>
                                <!-- <p>Nota: Puede enviar dinero a <strong> paypal@choies.com</strong> directamente si usted no paga con éxito.</p> -->
                            </dd>
                        <?php
                        }
                        ?>
                            <dd class="shipping_methods">
                              ...
                              <label for="radio_1">
                                <h4>Tarjeta de Crédito o Débito</h4><br />
                                <!-- <p>Aceptamos las siguientes tarjetas de crédito/ débito. Por favor sigue la página próxima para realizar su pago.</p> -->
                        ...
                        <p>
                            <input type="submit" class="btn40_16_red" value="VOY A PAGAR" />
                        </p>
                    </form>
                </div>
            </article>
            ...
            <div class="order_summary flr">
                ...
                <ul class="total">
                    ...
                    <li><label>Envío Estimado: </label><span id="shipping_total"><?php echo $cart_shipping == -1 ? Site::instance()->price($site_shipping[2]['price'], 'code_view') : Site::instance()->price($cart_shipping, 'code_view'); ?></span></li>
                    <?php
                    ...
                    <li id="coupon_points_save" <?php if(!$coupon_points_save) echo 'style="display:none;"'; ?>>
                        <label>Pagar Con Copónes Y Puntos: </label><span id="save_total"><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span>
                    </li>
                    <?php
                    ...
                    if($saving <= 0)
                        $saving = 0;
                    ?>
                    <li class="last red"><label>Ahorros: </label><span id="cart_saving"><?php echo Site::instance()->price($saving, 'code_view'); ?></span></li>
                        
                </ul>       
                <div class="promo-choies">
                    <ul>
                        <li class="promo-code">
                            <div class="pc-apply">¿Tiene un cupón promocional?<a href="javascript:;" title="Aplíquelo ahora">Aplíquelo</a>
                                <em class="icon_tips JS_shows_btn1">
                                    <span class="JS_shows1 icon_tipscon" style="display: none;">
                                        Nota: 1. El producto con el símbolo "% menos" no se puede combinar con cualquier código de cupón.
                                        <i>2. Por favor introduce el código de cupón sin espacio.</i>
                                    </span>
                                </em>
                            </div>
                            <div class="pc-ibutton" style="display:none;">
                                <form method="post" action="/cart/set_coupon" onsubmit="return setCoupon();">
                                    ...
                                    <button type="submit" class="btn-promo-code btn22_black flr">Aplicar</button>
                                </form>
                                <a class="J_pop_btn a_underline flr">Lista de Código</a>
                                <!-- codelist_con -->
                        ...
                        <li class="promo-code">
                            <div class="pc-apply">¿Tiene los puntos de Choies?<a href="javascript:;" title="Utilicelos ahora">Utilicelos</a>
                                <em class="icon_tips JS_shows_btn1">
                                    <span class="JS_shows1 icon_tipscon hide" style="display: none;">Usted puede solicitar los puntos que equivalen a sólo el 10% de valor de su pedido.<br>Completa tu perfil, se le otorgará 500 puntos para canjear tu primer pedido.</span>
                                </em>
                            </div>
                            <div class="pc-ibutton" style="display:none;">
                                <form method="post" action="/cart/point" class="form" id="point_form" onsubmit="return setPoints();">
                                    ...
                                    <button type="submit" class="btn-promo-code btn22_black flr" onclick="return point_redeem();">Canjear</button>
                                </form>
                                ...
                                Ahorrar: <span class="red">$ <span  id="dollar">0</span></span><br>
                                    ...
                                    ?>
                                    <a class="a_underline JS_popwinbtn" style="display: inline;">La política de VIP</a>
                                </div>
                ...
                <div class="additional-payment mt30">
                    <p>Seguridad de pago adicional con:</p>
        ...
        <ul class="add_showcon_boxcon">
            ...
            <li>
                ...
                <div class="right_box">
                    ...
                    <p class="phone_tips">Por favor, deje su número de teléfono correcto y completo para la entrega exacta de cartero</p>
                </div>
            </li>
            <li id="shipping_cpf" class="hide">
                <label><span>*</span>o cadastro de pessoa Física:</label>
            ...
            <li>
              <label>&nbsp;</label>
              <div class="right_box"><input type="submit" value="PRESENTAR" class="btn30_14_black" /></div>
            </li>
        </ul>
        </form>
</div>
<div class="hide" id="cart_delete" style="position: fixed;padding: 10px 10px 20px; top: 170px;left: 400px; z-index:100px;z-index: 1000; background: #FFFFFF; border-color: #F6F6F7; border:1px solid #cdcdcd;">
    ...
    <div class="order order_addtobag center" style="margin:20px;">
        ...
        <form action="<?php echo LANGPATH; ?>/cart/delete_address" method="post" id="delete_address_form" onsubmit="return delete_address_submit();">
            ...
            <input type="submit" class="btn30_14_black" value="ELELIMINAR" />
            <a href="" class="cancel" style="text-decoration:underline;margin-left:10px;" onclick="return delete_close();">Cancelar</a>
        </form>
    </div>
    ...
    <div class="vip">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>$0</td> 
               <td>/</td>
                <td rowspan="6"><div>Se pueden canjear el 10% del valor de su pedido.</div></td>
            ...
            <tr>
                ...
                <td>$1 - $199</td>
                <td>/</td>
                <td rowspan="5"><div>Consigue los puntos comerciales dobles durante los principales días festivos.<br>
            ...
            <tr>
                <td><span class="icon_silver" title="Silber VIP"></span><strong>VIP plata</strong></td>
                <td>$399 - $599</td>
                <td>8% menos</td>
            </tr>
            <tr>
            ...
            <tr>
                <td><span class="icon_diamond" title="Diamant VIP"></span><strong>VIP diamante</strong></td>
                <td>&ge; $1999</td>
                <td>15% menos</td>
            </tr>
        </table>
            ...
            success: function(result){
                if(result.success == 1){
                    ...
                    if(result.count_address > 1)
                        change = '<a href="javascript:;" class="a_red" onclick="change_address_show();">Cambiar</a>';
                    var shipping_address_list = '<dt>Dirección de Envío  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address('+result.address_id+');">Editar</a>'+change+'</dt>'+
                                                ...
                                                '<label for="radio'+result.count_address+'">'+
                                                    ...
                                                    '<div class="flr">'+
                                                        '<span class="b address_detault" id="detault_'+result.address_id+'" style="display:none;">Default</span>'+
                                                            ...
                                                            '<a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address('+result.address_id+', 1);">Editar</a>'+
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.count_address > 1)
                change = '<a href="javascript:;" class="a_red" onclick="change_address_show();">Cambiar</a>';
            var shipping_address_list = '<dt>Dirección de Envío  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address('+res.shipping_address_id+');">Editar</a>'+change+'</dt>'+
...
var re = /.*\d+.*/;
	...
	if(re.test(scon)){	
			$("#guo_don1").show();
			$("#guo_don1").html('¿Condado / Provincia con números? Por favor revise la exactitud.');
		}else{
			$("#guo_don1").hide();
		}	
}
