                ...
                <article class="shipping_delivery_left">
                    ...
                    <div class="information_con">
                        ...
                        if ($has_address AND isset($cart['shipping']['price']))
                        {
                            ...
                            ?>
                            <dl>
                                <dt>Dirección de Envío   <a href="<?php echo LANGPATH; ?>/cart/shipping_billing" class="a_red <?php if(count($addresses) <= 1) echo 'JS_popwinbtn1'; ?>">Editar</a></dt>
                            ...
                            <dl>
                                <dt>Método de Envío   <a href="#" class="a_red JS_popwinbtn2">Editar</a></dt>
                                <dd>
                                    Envío:
                                    <?php
                                    ...
                                    foreach ($site_shipping as $price)
                                    {
                                        if ($price['price'] == $cart_shipping)
                                        {
                                            ...
                                            echo $ship_name . ' ( ' . Site::instance()->price($price['price'], 'code_view') . ' )';
                                        }
                                    }
                                    ?>
                                </dd> 
                    ...
                    <div class="mb25">
                        ...
                        <div class="coupons_box">
                            <form action="<?php echo LANGPATH; ?>/cart/set_coupon" method="post" class="form">
                                ...
                                <input type="submit" value="Aplicar" class="btn22_black mr10" />
                                <a class="J_pop_btn a_underline">Lista de Código </a>
                            </form>
                            <?php
                            if ($cart['coupon']):
                                ?>
                                <div class="color666">
                                    Corriente Código Del Cupón:
                        ...
                        <div class="coupons_box">
                            <form action="<?php echo LANGPATH; ?>/cart/point" method="post" class="form" id="point_form">
                                <label class="left">Choies Puntos:<em class="icon_tips JS_shows_btn1"><span class="JS_shows1 icon_tipscon hide">Usted puede solicitar los puntos que equivalen a sólo el 10% de valor de su pedido.Completa tu perfil, se le otorgará 500 puntos para canjear tu primer pedido.</span></em></label>
                                ...
                                <input type="submit" value="Canjear" class="btn22_black mr10" onclick="return point_redeem();" />
                                Ahorrar: <span class="red">$ <span  id="dollar">0</span></span> 
                                <div class="color666">
                                    (10 Puntos=$0.1)  
                                    <?php
                                    if ($points_avail >= 0):
                                    ...
                                    ?>
                                    <a class="a_underline JS_popwinbtn">La política de VIP</a></div>
                            </form>
