...
<section id="main">
    ...
    <div class="w_index_free">
        <div class="layout index_free">
            ...
            if($user_id){?>
                <a href="<?php echo LANGPATH; ?>/vip-policy" class="a2">PRIMER PEDIDO -15%</a>
            <?php }else{ ?>
                <a href="<?php echo LANGPATH; ?>/customer/login" class="a2">PRIMER PEDIDO -15%</a>
            <?php } ?>
            <a href="<?php echo LANGPATH; ?>/daily-new" class="a3">NOVEDADES -10%</a>
        </div>
    </div>
    ...
    <article class="index_fashion layout">
        <div class="index_tit t1"><p><a href="<?php echo $index_banners[9]['link']; ?>"><span><b>FASHION</b> BUYER’S SHOW</span> <span><?php echo $index_banners[9]['title'];  ?></span></a></p></div>
    ...
    <article class="rows_3 layout">
        <div class="index_tit t2 text_upper"><p><span><b class="font18">DESTACADOS</b></span> <span><b>DE CHOIES</b></span></p></div>
