<style> 
    ...
    .ui_btn_orange { 
        ...
        color: #FEF4E9; border: solid 1px #F47A20; background: #F78D1D; background: -webkit-gradient(linear, left top, left bottom, from(#FAA51A), to(#F47A20)); background: -moz-linear-gradient(top, #FAA51A, #F47A20); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#faa51a', endColorstr='#f47a20'); margin-right:-65px;
    }
                    ...
                    <div>
                        ...
                        <div id="payment_wrap">
                            ...
                            <div class="payment_p">
                                ...
                                <p class="payment_message_p">Por favor seleccione un tipo de tarjeta y complete la siguiente información, entonces haga clic ”PAGAR AHORA”.<br>
                                <span style="font-weight:bold;font-style: italic;">Nota</span>: Por razones de seguridad, la información de su tarjeta de crédito no será archivada.</p>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">          
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Aceptamos:</td>
                                                <td>
                                                    <ul class="payment_ul">
                                                        <ul class="cad">
                                                            <li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="error" id="cvv_error">Por favor introduzca un 3-dígito CVV2 código.</div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                        </tbody>
