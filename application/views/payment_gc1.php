        ...
        <section class="cart">
            <section class="shipping_delivery fix">
                        ...
                        <div id="payment_wrap">
                            <div class="payment_p">
                                ...
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                	<ul>
                                    	<li class="fix">
                                        	<label class="payment_td_right bold"><em>*</em>Credit Card Type</label>
								...
								<div class="error" id="card_error1">Please choose your credit card type.</div> 
                                        </li>
                                        <li class="fix">
                                        	<label class="payment_td_right bold"><em>*</em>Credit Card Number</label>
                                        	<div class="payment_card_time" style="margin: 0 0 -10px 15px;">12-19 digits, spaces are not allowed</div>
                                            <div class="card_num">
                                        ...
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Expiration Date</label>
                                            <?php
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">MONTH</div>
                                            </div>
                                            <div class="fll">/</div>
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">YEAR</div>
                                            </div>
                                            <div class="fix"></div>
                                            <div class="error" id="expire_error">The month of expiry date is incorrect.</div>                                                               
                                        </li>
                                        <li class="fix">
                                      		<label class="payment_td_right bold"><em>*</em>Security Code <span style="font-weight:normal; color:#999">(CVV/CVC)</span></label>
                                            ...
                                            <div class="fix"></div>
                                            <div class="error" id="cvv_error">Please enter a 3-digit CVV/CVC Code.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="PAY NOW" id="paybutton" name="paybutton" class="btn40_16_red" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                ...
                <div class="order_summary flr">
                    ...
                    <strong style="color:#000;">Accepted Credit Cards</strong><br /><br />
                    We accept VISA, Electron, MasterCard and Debit 
                    VISA or Debit MasterCard.<br />
                    If you use another card ( e.g. Maestro  or American 
                    Express) please Pay with <a style="text-decoration:underline;" href="/order/view/<?php echo $order['ordernum']; ?>" target="_blank">PayPal</a> instead.<br /><br />
                    <strong style="color:#000;">60-day Refund Policy</strong><br /><br />
                    If you're not satisfied with your purchase, then 
                    simply email at <a style="text-decoration:underline;" href="mailto:service@choies.com" target="_blank">service@choies.com</a> to get a return 
                    authorization (return address) or exchange authorization within 60 days upon receipt.
                    </p>
                    <div style="padding:15px;">
                    	<strong style="display:block; font-style:italic;">Additional payment security with:</strong>
                        <span style="font-size:11px; color:#999;"><img class="mr10" style="vertical-align:middle" src="/images/nor-lock.png" />Secure Checkout  256-bit SSL encryption by Norton</span>
    ...
    <div class="footer_payment">
        <div class="card">
            ...
            <div style="background-color:#232121;">
                <p class="bottom">
                    Copyright © 2006-2014 Choies.com
                </p>
            </div>
        </div>
    </div>
