...
<div class="layout">
    <div class="crumbs fix">
        <div class="fll"><a href="<?php echo LANGPATH; ?>/">Accueil</a>  >  Réglage de Compte</div>
    </div>
...
<section class="layout fix">
    <article id="container" class="user flr">
        <div class="tit"><h2>Réglage de Compte</h2></div>
        <form action="#" method="post" class="form user_form" id="accountSettings">
            <ul>
                <li class="fix">
                    <label><span>*</span> É-mail:</label>
                ...
                <li class="fix">
                    ...
                    <div class="right" id="gender">
                        <input type="radio" name="gender" value="1" id="radio1" class="radio" <?php if ($customer['gender'] == 1) echo 'checked'; ?> /><label for="radio1" style="float: none;">Féminin</label>
                        <input type="radio" name="gender" value="0" id="radio2" class="radio" <?php if ($customer['gender'] == 0) echo 'checked'; ?> /><label for="radio2" style="float: none;">Masculin</label>
                    </div>
                </li>
                <li class="fix">
                ...
                <li class="fix">
                    <label>&nbsp;</label>
                    <div class="right">
                        <input type="submit" name="" value="GARDER" class="view_btn btn26 btn40" />
                    </div>
                </li>
            </ul>
        </form>
