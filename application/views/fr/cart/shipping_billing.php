    ...
    <div class="layout">
        ...
        <div class="cart_step">
            ...
            <div class="cart_step_bottom">
                <span class="on">Expédition&Livraison</span>
            ...
            <article class="shipping_delivery_left fll">
                            ...
                            <dd>
                                <ul class="shipping_address">
                                        ...
                                        <li class="fix JS_shows_btn1">
                                            <div class="fix">
                                                ...
                                                <div class="flr address_edit JS_shows1">
                                                    ...
                                                    {
                                                        ?>
                                                        <span class="b">Par Défaut</span>
                                                        <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">Rédiger</a>
                                                        <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Supprimer</a>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <a href="<?php echo LANGPATH; ?>/address/set_default/<?php echo $value['id']; ?>" class="a_underline">régler l'adresse par défaut</a>
                                                        <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">Rédiger</a>
                                                        <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Supprimer</a>
                                                        <?php
                                                    }
                                    ...
                                    <li class="fix last">
                                        ...
                                        <label for="radionew" class="a_underline add_new font14">+Ajouter Une Nouvelle Adresse</label>
                                    </li>
                                </ul>
                            </dd>
                        </dl>
                                ...
                                <li class="states2">
                                    ...
                                    foreach ($stateCalled as $name => $called)
                                    {
                                        ...
                                        <div class="call2" id="call2_<?php echo $name; ?>" <?php if ($name != 'Default') echo 'style="display:none;"'; ?>>
                                            <label for="state"><span>*</span> <font id=""><?php echo $called=="County / Province"?"Pays / Région ":$called; ?></font>:</label>
                                        </div>
                                        <?php
                                    }
                    ...
                    <div class="shipping_methods">
                        <ul class="fix">
                            ...
                            foreach ($site_shipping as $key => $price):
                                ...
                                $ship_name = str_replace(array('Working Day Shipping'), array('jours ouvrables de livraison'), $price['name']);
                                ?>
                                <li>
                        ...
                        <p>
                            <input type="submit" value="PROCÉDER AU PAIEMENT" class="btn40_16_red" />
                        </p>
                    </div>
                </form>
                ...
                <div id="edit_address" class="JS_popwincon2 popwincon popwincon_user hide">
                    ...
                    <form action="<?php echo LANGPATH; ?>/cart/edit_address" method="post" class="form user_share_form user_form form1">
                        ...
                        <div class="center" style="margin-left: -63px;"><input type="submit" value="VALIDER" class="btn30_14_black" /></div>
                    </form>
                </div>
            </article>
...
<div class="hide" id="cart_delete" style="position: fixed;padding: 10px 10px 20px; top: 170px;left: 400px; z-index:100px;z-index: 1000; background: #FFFFFF; border-color: #F6F6F7; border:1px solid #cdcdcd;">
    ...
    <div class="order order_addtobag center" style="margin:20px;">
        ...
        <form action="<?php echo LANGPATH; ?>/cart/delete_address" method="post">
            ...
            <input type="submit" class="view_btn btn26" value="Supprimer" />
