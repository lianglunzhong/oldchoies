    ...
    <form action="<?php echo LANGPATH; ?>/cart/edit_shipping" method="post" class="form user_share_form user_form" onsubmit="return setShipping(this);">
        ...
        <div class="shipping_methods s_price_list">
            <ul class="fix">
                ...
                {
                    $name1 = '4-7 jours ouvrables de livraison express';
                    $site_shipping[1]['name'] = $name1;
					$name2 = '10-15 jours ouvrables de livraison gratuite';
    ...
    <section class="layout">
        <section class="cart fix">
            <article class="shipping_delivery_left">
                ...
                if ($show_address)
                {
                    ...
                    <div id="shippingAddressInfo" <?php if (!$show_address) echo 'style="display:none;"'; ?>>
                        <div class="information_con">
                            ...
                            ?>
                                <dt>
                                    Adresse de livraison  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address(<?php echo $cart['shipping_address']['shipping_address_id']; ?>, 1);">Rédiger</a>
                                    <?php
                                    if($count_address > 1)
                                    {
                                    ?>
                                        <a href="javascript:;" class="a_red" onclick="return change_address_show();">Changer</a>
                                    <?php
                                    }
                                    ?>
                                </dt>
                            ...
                            <dl>
                                <dt>Mode De Livraison   <a href="" class="a_red JS_popwinbtn2" id="ship_edit" <?php if(in_array($cart['shipping_address']['shipping_country'], $no_express_countries)) echo 'style="display:none;"'; ?>>Rédiger</a></dt>
                                <dd>
                                    livraison:
                    ...
                    <dl class="shipping_add_address">
                        ...
                        <form action="" method="post" name="shipping_address_radio">
                                ...
                                <li id="address_li_<?php echo $value['id']; ?>">
                                    <div class="fix">
                                        ...
                                        <label for="radio<?php echo $key; ?>">
                                            <b class="s1">Adresse<?php echo $key + 1; ?></b>
                                            <div class="flr">
                                            <?php
                                            if ($key == $default_key)
                                            {
                                                ?>
                                                    <span class="b address_detault" id="detault_<?php echo $value['id']; ?>">Par Défaut</span>
                                                    <a href="javascript:;" class="a_underline address_detault_a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);" style="display:none;">régler l'adresse par défaut</a>
                                                    <a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Rédiger</a>
                                                    <a href="javascript:;" class="view_btn btn26 delete_address" onclick="delete_address(<?php echo $value['id']; ?>);">Supprimer</a>
                                                <?php
                                            }
                                            else
                                            {
                                                ?>
                                                    <span class="b address_detault" id="detault_<?php echo $value['id']; ?>" style="display:none;">Par Défaut</span>
                                                    <a href="javascript:;" class="a_underline address_detault_a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);">régler l'adresse par défaut</a>
                                                    <a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Rédiger</a>
                                                    <a href="javascript:;" class="view_btn btn26 delete_address" onclick="delete_address(<?php echo $value['id']; ?>);">Supprimer</a>
                                                <?php
                                            }
                            ...
                            <ul class="shipping_address" style="margin: 0;padding: 0 10px 10px 10px;">
                                <li class="fix last">
                                    <a href="javascrpt:;" class="a_underline JS_popwinbtn1" id="add_new_address" onclick="return new_address_show();">+Ajouter Une Nouvelle Adresse</a>
                                </li>
                            </ul>
                            </form>
                        </dd>
				...
				<p class="phone_tips">Si votre région n'utilise pas de code postal, veuillez saisir 0000.</p>
                            </li>
                            <li>
                        ...
                        <h4 class="mt10">MÉTHODES de livraison</h4>
                        <div class="shipping_methods s_price_list">
                            <ul class="fix">
                            <?php
                            foreach($site_shipping as $key => $price)
                        ...
                        <p><input id="spgInfoCountinue" type="submit" value="PROCÉDER AU PAIEMENT" class="view_btn btn40 font18" /></p>
                    </form>
                </div>
                <div id="paymentInfo" <?php if(!$has_address) echo 'style="display:none;"'; ?>>
                    <h3 class="mt50">PAIEMENT</h3>
                    <div class="shipping_bottom_line">
                        <div class="arrow-down"></div>
                    </div>
            ...
            <div class="order_summary flr">
                ...
                <ul class="total">
                    ...
                    <li><label>Livraison: </label><span id="shipping_total"><?php echo $cart_shipping == -1 ? Site::instance()->price($site_shipping[2]['price'], 'code_view') : Site::instance()->price($cart_shipping, 'code_view'); ?></span></li>
                    <?php
                    ...
                    <li id="coupon_points_save" <?php if(!$coupon_points_save) echo 'style="display:none;"'; ?>>
                        <label>COUPONS & POINTS: </label><span id="save_total"><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span>
                    </li>
                    <?php
                    ...
                    if($saving <= 0)
                        $saving = 0;
                    ?>
                    <li class="last red"><label>Économiser: </label><span id="cart_saving"><?php echo Site::instance()->price($saving, 'code_view'); ?></span></li>
                        
                </ul>       
                <div class="promo-choies">
                    <ul>
                        <li class="promo-code">
                            <div class="pc-apply">Avez un code Promo?<a href="javascript:;" title="Utilisez maintenant">Utilisez maintenant</a>
                            ...
                            <div class="pc-ibutton" style="display:none;">
                                <form method="post" action="/cart/set_coupon" onsubmit="return setCoupon();">
                                    ...
                                    <button type="submit" class="btn-promo-code btn22_black flr">Appliquer</button>
                                </form>
                                <a class="J_pop_btn a_underline flr">Liste De Code</a>
                                <!-- codelist_con -->
                        ...
                        <li class="promo-code">
                            <div class="pc-apply">Avez des points Choies?<a href="javascript:;" title="Utilisez maintenant">Utilisez maintenant</a>
                                <em class="icon_tips JS_shows_btn1">
                                    <span class="JS_shows1 icon_tipscon hide" style="display: none;">Vous pouvez appliquer les points équivalant à seulement 10% de la valeur de votre commande. <br>Complétez votre profil, vous recevrez 500 points pour racheter votre première commande.</span>
                                </em>
                            </div>
                            <div class="pc-ibutton" style="display:none;">
                                <form method="post" action="/cart/point" class="form" id="point_form" onsubmit="return setPoints();">
                                    ...
                                    <button type="submit" class="btn-promo-code btn22_black flr" onclick="return point_redeem();">Racheter</button>
                                </form>
                                ...
                                Économiser: <span class="red">$ <span  id="dollar">0</span></span><br>
                                    ...
                                    ?>
                                    <a class="a_underline JS_popwinbtn" style="display: inline;">politique vip</a>
                                </div>
                ...
                <div class="additional-payment mt30">
                    <p>Sécurité de paiement supplémentaire avec:</p>
        ...
        <ul class="add_showcon_boxcon">
            ...
            <li>
                ...
                <div class="right_box">
                    ...
                    <p class="phone_tips">Veuillez laisser le numéro de téléphone correct et complet pour la livraison précise du facteur.</p>
                </div>
            </li>
            <li id="shipping_cpf" class="hide">
                <label><span>*</span>o cadastro de pessoa Física:</label>
...
<div class="hide" id="cart_delete" style="position: fixed;padding: 10px 10px 20px; top: 170px;left: 400px; z-index:100px;z-index: 1000; background: #FFFFFF; border-color: #F6F6F7; border:1px solid #cdcdcd;">
    ...
    <div class="order order_addtobag center" style="margin:20px;">
        <div style="font-size:13px;margin-bottom: 20px;">Êtes- vous sûr pour le supprimer? Il ne peut pas d’être révoqué.</div>
        <form action="<?php echo LANGPATH; ?>/cart/delete_address" method="post" id="delete_address_form" onsubmit="return delete_address_submit();">
            ...
            <input type="submit" class="btn30_14_black" value="Supprimer" />
            <a href="" class="cancel" style="text-decoration:underline;margin-left:10px;" onclick="return delete_close();">Annuler</a>
        </form>
    </div>
            ...
            success: function(result){
                if(result.success == 1){
                    ...
                    if(result.count_address > 1)
                        change = '<a href="javascript:;" class="a_red" onclick="change_address_show();">Changer</a>';
                    var shipping_address_list = '<dt>Adresse de livraison  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address('+result.address_id+');">Rédiger</a>'+change+'</dt>'+
                                                ...
                                                '<label for="radio'+result.count_address+'">'+
                                                    ...
                                                    '<div class="flr">'+
                                                        '<span class="b address_detault" id="detault_'+result.address_id+'" style="display:none;">Default</span>'+
                                                            ...
                                                            '<a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address('+result.address_id+', 1);">Rédiger</a>'+
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.count_address > 1)
                change = '<a href="javascript:;" class="a_red" onclick="change_address_show();">Changer</a>';
            var shipping_address_list = '<dt>Adresse de livraison  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address('+res.shipping_address_id+');">Rédiger</a>'+change+'</dt>'+
