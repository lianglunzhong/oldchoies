<div class="fix">
        <span class="pr-nums fll"><?php echo $total_items; ?> Records Trouvés</span>
        <div class="page flr">
                Page: 
                <?php if ($previous_page !== FALSE): ?>
                        <span class="prev_btn1"><a href="<?php echo $page->url($previous_page); ?>" rel="nofollow">Précédent</a></span>
                <?php endif; ?>
                <?php
                if ($total_pages < 8)
                {
                ...
                <?php if ($next_page !== FALSE): ?>
                        <span class="next_btn1"><a href="<?php echo $page->url($next_page); ?>" rel="nofollow">Suivant</a></span>
                <?php endif; ?>
        </div>
