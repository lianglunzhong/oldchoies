...
<style> 
    ...
    /* payment_input */
    #payment_wrap .ui_input { font:12px/25px Verdana; height:25px; color:#666; padding:0 0 0 5px; border:solid 1px #ccc; background:#fefefe; outline:none; margin:10px 15px 0px 15px; display: block; float:left;}
        ...
        <section class="cart">
            <section class="shipping_delivery fix">
                        ...
                        <div id="payment_wrap">
                            <div class="payment_p">
                                ...
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                    <ul>
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Type De Carte De Crédit</label>
                                        ...
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Numéro De Carte De Crédit</label>
                                            <div class="payment_card_time" style="margin: 0 0 -10px 15px;">12-19 chiffres, les espaces ne sont pas autorisés</div>
                                            <div class="card_num">
                                        ...
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Date d'Expiration</label>
                                            <?php
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">Mois</div>
                                            </div>
                                            <div class="fl">/</div>
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">Année</div>
                                            </div>
                                            <div class="fix"></div>
                                            <div class="error" id="expire_error">Le mois de la date d'expiration est incorrect.</div>                                                               
                                        </li>
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Code De Sécurité <span style="font-weight:normal; color:#999">(CVV/CVC)</span></label>
                                            ...
                                            <div class="fix"></div>
                                            <div class="error" id="cvv_error">Veuillez entrer un code CVV/CVC à 3 chiffres.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="PAYER MAINTENANT" id="paybutton" name="paybutton" class="btn40_16_red" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                ...
                <div class="order_summary flr">
                    ...
                    <strong style="color:#000;">Cartes de crédit acceptées</strong><br /><br />
                    Nous acceptons les paiements par VISA, Electron, MasterCard et cartes de crédit VISA ou Mastercard.<br />
                    Si vous utilisez une autre carte (par exemple, Discover ou American Express) veuillez payer par <a style="text-decoration:underline;" href="/order/view/<?php echo $order['ordernum']; ?>" target="_blank">PayPal</a>.<br /><br />
                    <strong style="color:#000;">Remboursement 60-jours</strong><br /><br />
                    Si vous n'êtes pas satisfait de votre achat, simplement nous envoyez un email à <a style="text-decoration:underline;" href="mailto:service@choies.com" target="_blank">service@choies.com</a> afin d'obtenir une autorisation de retour (adresse de retour) ou  une autorisation d'échange dans les 60 jours suivant la réception.
                    </p>
                    <div style="padding:15px;">
                        <strong style="display:block; font-style:italic;">Sécurité de paiement supplémentaire avec:</strong>
                        <span style="font-size:11px; color:#999;"><img class="mr10" style="vertical-align:middle" src="/images/nor-lock.png" />Paiement Sécurisé  cryptage SSL à 256 bits par Norton</span>
