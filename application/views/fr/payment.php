        ...
        <div class="icontainer">
            <div class="login">
                ...
                <div class="cart_paypal">
                    <h2>NUMÉRO DE VOTRE COMMANDE: <span><?php echo $ordernum; ?></span><img src="/images/loading1.gif" /></h2>
                    <p>La page de payement est en chargement, cela vous dépensera quelques secondes.</p>
                    <p>Veuillez ne pas la quitter pour le traitement de votre demande.</p>
                    <p>L'article que vous choisissez est le plus demandé, il n'est réservé que pour le temps limité, ne pas le manquer!</p>
                    <p class="bottom">N'hésitez pas à nous contacter sur <a href="mailto:<?php echo Site::instance()->get('email'); ?>"><?php echo Site::instance()->get('email'); ?></a></p>
                </div>
                <div class="message">
