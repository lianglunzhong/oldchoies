...
<div id="container">
        <div class="fix">
                <div id="main">
                        <div class="crumb"><a class=home href="<?php echo LANGPATH; ?>/">Accueil</a>&gt;<span>Bomb Sale</span></div>
                                        ...
                                        <div class="info flr">
                                                <dl>
                                                        <dd style="position:relative;">
                                                                <h1><?php echo Product::instance($product_id, LANGUAGE)->get('name'); ?></h1>
                                                        ...
                                                        <dd class="clear btn">
                                                                ...
                                                                <div class="shopNow fll"><a href="<?php echo Product::instance($product_id, LANGUAGE)->permalink() . '?' . date('md', strtotime($start_date)); ?>" target="_blank"></a></div>
                                                        </dd>
        ...
        <div style="background:#fff; height: 280px;" id="inline_example2">
                <div class="login" id="login">
                        ...
                        <div class="login_l fll ml10">
                                ...
                                <form id="loginForm" method="post" action="<?php echo LANGPATH; ?>/customer/login?redirect=bombsale/view" class="">
                                        <ul>
                                                <li>
                        ...
                        <div class="login_l fll">
                                ...
                                <form id="registerForm" method="post" action="<?php echo LANGPATH; ?>/customer/register?redirect=bombsale/view" class="">
                                        <ul>
                                                <li>
                                                        <label><span>*</span> Email:</label>
