<style> 
    ...
    .ui_btn_orange { 
        ...
        color: #FEF4E9; border: solid 1px #F47A20; background: #F78D1D; background: -webkit-gradient(linear, left top, left bottom, from(#FAA51A), to(#F47A20)); background: -moz-linear-gradient(top, #FAA51A, #F47A20); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#faa51a', endColorstr='#f47a20'); margin-right:-45px;
    }
            ...
            <section class="shipping_delivery fix">
                <article class="shipping_delivery_left payment_box">
                    ...
                    <div>
                        ...
                        <div id="payment_address" class="mb25" style="border: 1px solid #D6D5D5;padding: 15px;margin-bottom: 30px;height: 67px;width: 660px;">
                          <div style="background: #f8f8f8;font: bold 16px Arial;margin-bottom: 15px;">ADRESSE DE FACTURATION</div>
                          ...
                          <a href="#" class="a_red JS_popwinbtn1" style="font-style: italic;font-size:12px;margin-left:3px;">modifier</a></dt>
                        </div>
                        <div id="payment_wrap">
                            <div class="payment_h1">Paiement par Carte Bancaire</div>
                            <div class="payment_p">
                                <div class="payment_message">
                                    ...
                                    Numéro de la commande:<span class="c_red f16 bold"><?php echo $order['ordernum']; ?></span>
                                </div>
                                <p class="payment_message_p">Priez de sélectionner un type de carte, remplir le formulaire ci-dessous et cliquer sur "PAYER MAINTENANT".<br>
                                <span style="font-weight:bold;font-style: italic;">Remarque</span>: Pour des raisons de sécurité, nous ne conservons pas l'un de vos données de carte de crédit.</p>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">          
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Nous Acceptons:</td>
                                                <td>
                                                    <ul class="payment_ul">
                                                        <ul class="cad">
                                                            <li>
                                                                <label for="card16"><img src="/images/card16.jpg"></label><br />
                                                                <input type="radio" class="radio ml15" id="card16" value="1" checked="" name="card_type">
                                                            </li>
                                                            <li>
                                                                <label for="card15"><img src="/images/card15.jpg"></label><br />
                                                                <input type="radio" class="radio ml15" id="card15" value="3" name="card_type">
                                                            </li>
                                                            <li>
                                                                <label for="card17"><img src="/images/card17.jpg"></label><br />
                                                                <input type="radio" class="radio ml15" id="card17" value="122" name="card_type">
                                                            </li>
                                                            <li>
                                                                <label for="card18"><img src="/images/card18.jpg"></label><br />
                                                                <input type="radio" class="radio ml15" id="card18" value="114" name="card_type">
                                                            </li>
                                                            <li>
                                                                <label for="card19"><img src="/images/card19.jpg"></label><br />
                                                                <input type="radio" class="radio ml15" id="card19" value="119" name="card_type">
                                                            </li>
                                                            <li>
                                                                <label for="card20"><img src="/images/card20.jpg" title="JCB"></label><br />
                                                                <input type="radio" class="radio ml15" id="card20" value="125" name="card_type">
                                                            </li>
                                                            <li>
                                                                <label for="card21"><img src="/images/card21.jpg" title="Discover"></label><br />
                                                                <input type="radio" class="radio ml15" id="card21" value="128" name="card_type">
                                                            </li>
                                                            <li>
                                                                <label for="card22"><img src="/images/card22.jpg" title="Diners Club"></label><br />
                                            ...
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Numéro de Carte:</td>
                                                <td>
                                                    <div class="card_num">
                                                        <input type="text" class="ui_input" style="width:280px; " maxlength="16" name="cardNo" id="cardNo" onclick="error_clean('card_error');">
                                                        <div class="error" id="card_error">Le numéro de carte de crédit est incorrect.</div>     
                                                    </div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Date d'expiration:</td>
                                                <td>
                                                    <?php
                                                    ...
                                                    <select name="cardExpireYear" class="ui_input" id="cardExpireYear" style="width:80px;" onclick="error_clean('expire_error')" onchange="filter_month()">
                                                        <option value="0" selected="selected">Année</option>
                                                    <?php
                                                    $y = date('Y');
                                                    for($i = 0;$i < 18;$i ++)
                                                    {
                                                    ...
                                                    <div class="error" id="expire_error">Le mois de la date d'expiration est incorrect.</div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Code CVV2:</td>    
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="payment_icon_en">
                                                                        <div class="payment_icon_box_en">
                                                                            <div class="payment_icon_box_txt_en">Quel est CVV2 ?</div>
                                                    ...
                                                    <div class="error" id="cvv_error">Veuillez entrer un code CVV2 à 3 chiffres.</div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="487" style="text-align: center;padding-top: 8px;">
                                                    <input type="submit" value="PAYER MAINTENANT" id="paybutton" name="paybutton" class="ui_btn_orange jq_btn01"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                        ...
                        <div class="payment_icon_box_close jq_close01" id="jq_close02"></div>
                            <div class="payment_h1">Chargement en cours</div>
                            <div class="payment_p"><img id="loadingImg" src="/images/gb_loading.gif" width="100" height="68" alt="">  
                            <div style=" line-height:68px;">Chargement en cours, veillez attendre un moment!</div>
                            </div>
                        </div>
                ...
                <div class="order_summary flr">
                    <div class="cart_side">
                        ...
                        <ul class="total">
                            <li class="font14"><label>Sous-total: </label><span><?php echo $currency['code'] . round($order['amount_products'], 2); ?></span></li>     
                            <li><label>Livraison: </label><span><?php echo $currency['code'] . round($order['amount_shipping'], 2); ?></span></li>
                            <?php
                            $amount_point = $order['points'] / 100;
                            if ($order['amount_coupon'] + $amount_point > 0):
                                ?>
                                <li><label>Payer avec Coupons & Points: </label><span><?php echo $currency['code']; ?><?php round($order['amount_coupon'] + $amount_point, 2); ?></span></li>
                                <?php
                            endif;
                            ?>
                            <li class="total_num font14"><label>Total: </label><span class="font18"><?php echo $currency['code'] . round($order['amount'], 2); ?></span></li>
                            <li class="fwb"><i>Sécurité de paiement supplémentaire avec:</i><img src="/images/card11.jpg"></li>
                        </ul>
                    </div>
                </div>
            </section>
...
<div class="JS_popwincon1 popwincon popwincon_user hide">
    ...
    <form action="/order/edit_address/<?php echo $order['id']; ?>" method="post" class="form user_share_form user_form form1">
        ...
        <ul class="add_showcon_boxcon">
            ...
            <li>
              <label>&nbsp;</label>
              <div class="right_box"><input type="submit" value="SOUMETTRE" class="btn30_14_black" /></div>
            </li>
        </ul>
        </form>
</div>
...
function checkFormData()
{
    ...
    else
    {
        ...
        if(month == 0)
        {
            $popup_message.innerHTML = 'Le mois de la date d\'expiration est incorrect';
            $popup_overlay.style.display = 'block';
            $popup_container.style.display = 'block';
            return false;
        }
        else
        {
            ...
            if(year == 0)
            {
                $popup_message.innerHTML = 'L\'année de la date d\'expiration est incorrecte';
                $popup_overlay.style.display = 'block';
                $popup_container.style.display = 'block';
                return false;
            }
            else
            {
                ...
                if(cvv2.length != 3)
                {
                    $popup_message.innerHTML = 'Veuillez entrer un code CVV2 à 3 chiffres';
                    $popup_overlay.style.display = 'block';
                    $popup_container.style.display = 'block';
                    return false;
                }
...
function checkFormData()
{
    ...
    if(cvv2.length != 3 || reg.test(cvv2) != true)
    {
        ...
        $popup_message.innerHTML = 'Veuillez saisir le code CVV2.';
        $popup_message.style.display = 'block';
        error = 1;
    }
