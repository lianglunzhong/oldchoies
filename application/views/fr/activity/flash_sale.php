...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">ACCUEIL</a>  >  FLASH SALE</div>
        </div>
    </div>
            ...
            <article class="cate-sales flash_sale_prolist">
                ...
                ?>
                    <li>
                        ...
                        <p class="price"><?php echo Site::instance()->price($price, 'code_view'); ?> <span>(<?php echo $off; ?>% DE RÉDUCTION)</span></p>
                        ...
                        if($count_attr == 1)
                        {
                            ...
                            ?>
                            <a class="btn add_to_bag" href="javascript:;" attr-id="<?php echo $w['product_id']; ?>" attr-size="<?php echo $choose_size; ?>">Ajouter au panier</a>
                            <?php
                        }
                        else
                        {
                            ?>
                            <a class="btn btn1 quick_view" id="<?php echo $w['product_id']; ?>" attr-key="<?php echo $key; ?>" href="javascript:;">Sélectionner la taille</a>
                            <?php
                        }
                        ?>
                        <div class="saletime">
                            <div class="JS_daoend<?php echo $key; ?> hide">Temps Fini!</div>
                ...
                <div class="tab-bottom">
                    ...
                    ?>
                        <div class="v_show" <?php if($key1 > 1) echo 'style="display:none"'; ?>>
                            ...
                            <div>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/<?php echo $usd; ?>" style="color:#ff0000;text-decoration:underline;font-weight:bold;text-align:center;font-size:18px;padding:0 0 15px 0;display:block;" ><i>VOIR PLUS</i></a> 
                            </div>
                        </div>
                    <?php
                    }
            ...
            <div class="myImages fll">
                ...
                ?>
                    <div class="saletime1" id="saletime<?php echo $i; ?>" style="display:none;">
                       <div class="JS_daoend<?php echo $i; ?>" style="display:none;">Temps Fini!</div>
                       <div class="JS_dao<?php echo $i; ?>">Promo se termine dans:<span style="color:#d8261a;"> <strong class="JS_RemainD<?php echo $i; ?>"></strong>d <strong class="JS_RemainH<?php echo $i; ?>"></strong>h <strong class="JS_RemainM<?php echo $i; ?>"></strong>m <strong class="JS_RemainS<?php echo $i; ?>"></strong>s</span></div>
                    </div>
                <?php
                }
                ?>
        ...
        <dl>
            <dd>
              ...
              <p style="padding-bottom:12px;color:#999;">
                ...
                <span id="jr"><a href="#" target="_blank" id="product_link">VOIR PLUS DE DÉTAILS</a></span>
                </p>
                </div>
            </dd>
            ...
            <dd class="last">
                ...
                <div id="action-form">
                    <form action="#" method="post" id="formAdd">
                        ...
                        <div class="total">
                            <input type="submit" class="btn40_16_red" id="addCart" value="Ajouter au panier">
                        </div> 
                    </form>
                </div>
        ...
        $("#formAdd").submit(function(){
            $.post(
                ...
                function(product)
                {
                    ...
                    cart_view = cart_view.replace('one size', 'taille unique');
