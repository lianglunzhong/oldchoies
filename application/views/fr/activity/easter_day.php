...
<section id="main">
    ...
    <div class="grid">     
        ...
        <div class="fix"></div>
        	...
        	<p><img src="/images/activity/listbanner_fr.jpg" width="1024" height="300"></p>
            <div class="easter-day-filter">
                <p class="filter-instruction">SHOPPER PAR DES COULEURS DE PÂQUES</p>
                <ul class="filter-main detail-tab fix">
                    <li class=" current" style="width: 137px;margin: 45px 0 -30px 80px;" id="Blue">BLEU </li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Green">VERT</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Pink">ROSE</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Yellow">JAUNE</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="White">BLANC</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Purple">VIOLET</li>
                    <p style="left: 78px;">
                        <b></b>
                    </p>
                </ul>
