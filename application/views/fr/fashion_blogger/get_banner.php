...
<div class="layout" style="margin-top:30px;background: #fff;">
    <div class="tit blogger_wanted mb25">
      <span>Programme de Fashion</span><span>Lire les politiques</span><span>Soumettre les informations</span><span class="on">Obtenir un banner</span>
      <img src="/images/<?php echo LANGUAGE; ?>/blogger_wanted4.png" />
    </div>  
    <div class="fashion_tit">Obtenir a banner</div>
    <div class="fashion_policy">
        <p>Choisir votre Choies VIP idole favori, cliquer l'image pour obtenir le code.</p>
        <p>Si vous êtes d'accord pour ajouter choies bannière à la page d'accueil de votre blog, page lookbook, ou d'autres sites de la plate-forme de la mode, vous obtiendrez plus de cadeaux si vous avez plus de fans.</p>
        <p>Si vous possédez un compte de Youtube, où la bannière n'est pas autorisé, vous pouvez ajouter notre lien <a href="<?php echo LANGPATH; ?>/" title="choies.com" class="red"> http://<?php echo $domain; ?></a> à la place.</p>
    </div>
