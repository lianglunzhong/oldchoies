    ...
    <section class="layout fix">
        <section class="cart">
            <article class="shipping_delivery_left fll">
                ...
                <form action="/cart/edit_shipping" method="post" class="form form_box form2" id="addNew">
                <?php
                ...
                ?>
                        ...
                        <dd>
                            <ul class="shipping_address">
                                ...
                                foreach ($addresses as $key => $value)
                                {
                                    ...
                                    <li class="fix JS_shows_btn1">
                                        <div class="fix">
                                            ...
                                            <label for="radio<?php echo $key; ?>"><b class="s1">Address<?php echo $key + 1; ?></b></label>
                                            ...
                                            if ($key == $default_key)
                                            {
                                                ?>
                                                    ...
                                                    <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">Edit</a>
                                                    <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Delete</a>
                                                <?php
                                            }
                                            else
                                            {
                                                ?>
                                                    <a href="/address/set_default/<?php echo $value['id']; ?>" class="a_underline">Set Default</a>
                                                    <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">Edit</a>
                                                    <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Delete</a>
                                                <?php
                                            }
                                ...
                                <li class="fix last">
                                    ...
                                    <label for="radionew" class="a_underline add_new font14">+Add a New Address</label>
                                </li>
                            </ul>
                        </dd>
                    </dl>
                    ...
                    <div class="shipping_methods">
                        ...
                        <p>
                            <input type="submit" value="secure checkout" class="btn40_16_red" />
                        </p>
                    </div>
                </form>
                ...
                <div id="edit_address" class="JS_popwincon2 popwincon popwincon_user hide">
                    ...
                    <form action="/cart/edit_address" method="post" class="form user_share_form user_form form1">
                        ...
                        <ul class="add_showcon_boxcon">
                            ...
                            <li>
                                <label><span>*</span> Country:</label>
                                <select name="shipping_country" id="e_country" class="select_style selected304" onchange="changeSelectCountry1();$('#billing_country').val($(this).val());">
                                    <option value="">SELECT A COUNTRY</option>
                                    <?php foreach ($countries as $country): ?>
