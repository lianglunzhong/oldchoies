<link type="text/css" rel="stylesheet" href="/css/all.css" media="all" id="mystyle"  />
<script type="text/javascript" src="/js/jquery.js"></script>
<script type="text/javascript" src="/js/jquery.validate.js"></script>
<div class="eddit_address">
        <div class="tit">Edit Shipping Address</div>
        <form id="shippingAddress" method="post" action="<?php echo LANGPATH; ?>/cart/edit_address" class="formArea" style="overflow: hidden;">
                <input type="hidden" name="shipping_address_id" value="<?php echo $address['id']; ?>" />
                <input type="hidden" name="shipping_method" value="<?php echo $carrier; ?>" />
                ...
                <input type="submit" value="Save & Shipping To This Address" class="form_btn2 ship_btn ml10" id="shippingAddressSubmit" />
        </form>
</div>
