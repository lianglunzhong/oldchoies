...
<script language="javascript" type="text/javascript">
    ...
    function AddNewRow() {
        ...
        lastTd.innerHTML = "<div align='left' style='width:40px;'><a href='javascript:' onclick=\"DeleteSignRow('SignItem" + rowID + "')\">Удалить</a></div>";
        //将行号推进下一行
...
<section id="main">
    ...
    <section class="layout fix">
        ...
        <span>Модные программы</span><span>Читать политики</span><span class="on">Представить информацию</span><span>Получить Баннер</span>
      <img src="/images/<?php echo LANGUAGE; ?>/blogger_wanted3.png" />
    </div>  
        <?php echo Message::get(); ?>
        <article style="margin-top:30px;background: #fff;">
            <div class="fashion_tit" style="margin-left:39px">Представить информацию</div>
            <div class="fll" style="padding-left:70px;">
                <div class="sub_info">
                    <form action="" method="post" id="submitInfo" class="form">
                        <ul>
                            <li>
                                <label style="margin-left:38px"><span class="red">*</span> Адрес Электронной Почты:</label>
                                <input type="text" id="email" name="email" class="sub_info_text" />
                                <span class="errorInfo"></span>
                            </li>
                            <li>
                                <label style="margin-left:38px"><span class="red">*</span> Пол:</label>
                            ...
                            <li>
                                <label style="margin-left:38px"><span class="red">*</span> Страна:</label>
                                ...
                                <div style="overflow: auto; width:100%; padding:0 10px; float:left">
                                    <table cellpadding="1" id="tab" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <label><span class="red mb10">*</span> Тип Основной Сайта: </label>
                                                <select maxlength="16" id="type" name="sites[type][]">
                                                    <option value="lookbook">Look Book</option>
                                                    <option value="personal Blog">Личный Блог</option>
                                                ...
                                                <br/><label><span class='red'>*</span> URL Основной Сайта: </label>
                                                <input type='text' id='url' name='sites[url][]' class='sub_info_text' />
                                                <label><span class='red'>*</span> Поклонники/ Последователи: </label>
                                    ...
                                    <table cellpadding="1" cellspacing="0" style="text-align: center; display:block;">
                                        <tr>
                                            <td>
                                                <input type="button" name="Submit" class="add_more" style=" margin-left:139px;" value="Добавить еще один сайт" onclick="AddNewRow()" />
                                            </td>
                                            <td>
                            ...
                            <li>
                                <label  style="margin-left:39px"><span class="red">*</span> Сообщение:</label>
                                <textarea name="comment" id="input_comment" rows="10" class="input textarea sub_info_text3" onblur="this.value=(this.value=='')?'Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!':this.value" value="Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!" onfocus="this.value=(this.value=='Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!')?'':this.value">Напишите что-нибудь рассказать о себе? И какие ваши идеи о моде. Спасибо!</textarea>
                            </li>
                            <li>
                                <input type="submit" id="inforSubmit" class="form_btn view_btn btn30_14_red" style="width: 100px;height: 38px;" value="BESTÄTIGEN"/>
                            </li>
                        </ul>
                        <script type="text/javascript">
                            $("#submitInfo").validate({
