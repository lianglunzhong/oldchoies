...
<div class="layout">
    <div class="crumbs fix">
        <div class="fll"><a href="<?php echo LANGPATH; ?>/">Home</a>  >  Настройка профиля</div>
    </div>
...
<section class="layout fix">
    <article id="container" class="user flr">
        <div class="tit"><h2>Настройка профиля</h2></div>
            ...
            <ul>
                ...
                <li class="fix">
                    ...
                    <div class="right" id="gender">
                        <input type="radio" name="gender" value="1" id="radio1" class="radio" <?php if ($customer['gender'] == 1) echo 'checked'; ?> /><label for="radio1" style="float: none;">Женщина</label>
                        <input type="radio" name="gender" value="0" id="radio2" class="radio" <?php if ($customer['gender'] == 0) echo 'checked'; ?> /><label for="radio2" style="float: none;">Мужчина</label>
                    </div>
                </li>
                <li class="fix">
                ...
                <li class="fix">
                    <label>&nbsp;</label>
                    <div class="right">
                        <input type="submit" name="" value="Сохранить" class="view_btn btn26 btn40" />
                    </div>
                </li>
            </ul>
        </form>
