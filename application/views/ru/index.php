...
<section id="main">
    ...
    <article class="index_fashion layout">
        <div class="index_tit t1"><p><a href="<?php echo $index_banners[9]['link']; ?>"><span><b>FASHION</b> Шоу наших покупателей</span> <span><?php echo $index_banners[9]['title'];  ?></span></a></p></div>
    ...
    <article class="rows_3 layout">
        <div class="index_tit t2 text_upper"><p>
            <span><b>CHOIES</b></span>
            <span><b class="font18">Особенные Рекомендуемые</b></span>
            </p>
        </div>
