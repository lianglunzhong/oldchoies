...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">ДОМ</a>  >  FLASH SALE</div>
        </div>
    </div>
                ...
                ?>
                    <li>
                        ...
                        if($count_attr == 1)
                        {
                            ...
                            ?>
                            <a class="btn add_to_bag" href="javascript:;" attr-id="<?php echo $w['product_id']; ?>" attr-size="<?php echo $choose_size; ?>">Добавить в корзину</a>
                            <?php
                        }
                        else
                        {
                            ?>
                            <a class="btn btn1 quick_view" id="<?php echo $w['product_id']; ?>" attr-key="<?php echo $key; ?>" href="javascript:;">Размеры</a>
                            <?php
                        }
                        ?>
                        <div class="saletime">
                            <div class="JS_daoend<?php echo $key; ?> hide">Время Кончилось!</div>
                ...
                <div class="tab-bottom">
                    ...
                    ?>
                        <div class="v_show" <?php if($key1 > 1) echo 'style="display:none"'; ?>>
                            ...
                            <div>
                                <a target="_blank" href="<?php echo LANGPATH; ?>/<?php echo $usd; ?>" style="color:#ff0000;text-decoration:underline;font-weight:bold;text-align:center;font-size:18px;padding:0 0 15px 0;display:block;" ><i>СМОТРЕТЬ БОЛЕЕ</i></a> 
                            </div>
                        </div>
                    <?php
                    }
            ...
            <div class="myImages fll">
                ...
                ?>
                    <div class="saletime1" id="saletime<?php echo $i; ?>" style="display:none;">
                       <div class="JS_daoend<?php echo $i; ?>" style="display:none;">Время Кончилось!</div>
                       <div class="JS_dao<?php echo $i; ?>">Распродажа закончится:<span style="color:#d8261a;"> <strong class="JS_RemainD<?php echo $i; ?>"></strong>d <strong class="JS_RemainH<?php echo $i; ?>"></strong>h <strong class="JS_RemainM<?php echo $i; ?>"></strong>m <strong class="JS_RemainS<?php echo $i; ?>"></strong>s</span></div>
                    </div>
                <?php
                }
                ?>
            ...
            <dd class="last">
                ...
                <div id="action-form">
                    <form action="#" method="post" id="formAdd">
                        ...
                        <div class="total">
                            <input type="submit" class="btn40_16_red" id="addCart" value="Добавить в корзину">
                        </div> 
                    </form>
                </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $('#addCart').live("click",function(){
            ...
            if(btn_size && !size)
            {
                alert('пожалуйста ' + $('#select_size').html());
                return false;
            }
        })
        $("#formAdd").submit(function(){
            $.post(
                ...
                function(product)
                {
                    ...
                    cart_view = cart_view.replace('one size', 'только один размер');
