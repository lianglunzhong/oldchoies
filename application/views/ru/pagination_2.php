<span class="n_border">Всего найдено:<span><?php echo $total_items; ?></span></span>
<?php if($total_items > 0): ?>
<div class="page">
    Страницы: 
    <?php if ($previous_page !== FALSE): ?>
        <a href="<?php echo $page->url($previous_page); ?>" title="<?php echo $previous_page; ?>" class="prev_btn1" rel="nofollow">Предыдущая</a>
    <?php endif; ?>
    <?php
    if ($total_pages < 8)
    {
    ...
    <?php if ($next_page !== FALSE): ?>
        <a href="<?php echo $page->url($next_page); ?>" title="<?php echo $next_page; ?>" class="next_btn1" rel="nofollow">Следующая</a>
    <?php endif; ?>
</div>
<?php endif; ?>
