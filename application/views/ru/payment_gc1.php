        ...
        <section class="cart">
            <section class="shipping_delivery fix">
                        ...
                        <div id="payment_wrap">
                            <div class="payment_p">
                                ...
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">    
                                    <ul>
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Тип Кредитной Карты</label>
                                        ...
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Номер Кредитной Карты</label>
                                            <div class="payment_card_time" style="margin: 0 0 -10px 15px;">12-19 цифр, пробелы не допускаются</div>
                                            <div class="card_num">
                                        ...
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Дата истечения срока</label>
                                            <?php
                                            ...
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">Месяц</div>
                                            </div>
                                            <div class="fll">/</div>
                                            <div class="fll" style="width:100px;">
                                                ...
                                                <div class="payment_card_time fl ml20">Год</div>
                                            </div>
                                            <div class="fix"></div>
                                            <div class="error" id="expire_error">Год Даты окончания неверен.</div>                                                               
                                        </li>
                                        <li class="fix">
                                            <label class="payment_td_right bold"><em>*</em>Код Безопасности <span style="font-weight:normal; color:#999">(CVV/CVC)</span></label>
                                            ...
                                            <div class="fix"></div>
                                            <div class="error" id="cvv_error">Пожалуйста, введите 3-цифра CVV/CVC-код.</div>
                                        </li>
                                    </ul>      
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="text-align: left;padding: 30px 0 30px 15px;" width="487">
                                                    <input value="Платить Сейчас" id="paybutton" name="paybutton" class="btn40_16_red" type="submit"></td>
                                                <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                ...
                <div class="order_summary flr">
                    ...
                    <strong style="color:#000;">Принимаемые Кредитные Карты</strong><br /><br />
                    Мы принимаем VISA, Electron, MasterCard и Дебет VISA или Дебет MasterCard.<br />
                    Если вы используете другой карты(например, Discover или American Express) Пожалуйста, платите с <a style="text-decoration:underline;" href="/order/view/<?php echo $order['ordernum']; ?>" target="_blank">PayPal</a> вместо.<br /><br />
                    <strong style="color:#000;">Политики о 60-дневном возврате</strong><br /><br />
                    Если Вы не удовлетворяетесь с вашей покупкой, то просто напишите на <a style="text-decoration:underline;" href="mailto:service@choies.com" target="_blank">service@choies.com</a> чтобы получить право на возврат (адрес возврата) или обмен авторизации в течение 60 дней после получения.
                    </p>
                    <div style="padding:15px;">
                        <strong style="display:block; font-style:italic;">Дополнительная безопасность платежа с:</strong>
                        <span style="font-size:11px; color:#999;"><img class="mr10" style="vertical-align:middle" src="/images/nor-lock.png" />Безопасно Оформить Заказ  256-bit SSL-шифрование по Norton</span>
...
function checkFormData()
{
    ...
    { 
        $popup_message = document.getElementById('expire_error');
        $popup_message.innerHTML = 'Дата истечения срока действия является недопустимым.';
        $popup_message.style.display = 'block';
        error = 1;
    }
