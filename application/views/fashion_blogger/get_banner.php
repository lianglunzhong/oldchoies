...
<div class="layout" style="margin-top:30px;background: #fff;">
    <div class="tit blogger_wanted mb25"><img src="/images/blogger_wanted4.png" /></div>
    <div class="fashion_tit">Get A Banner</div>
    <div class="fashion_policy">
        ...
        <p>If you own a youtube account where banner is not allowed, you can add our link  <a href="<?php echo LANGPATH; ?>/" title="choies.com" class="red"> http://<?php echo $domain; ?></a> instead.</p>
    </div>
