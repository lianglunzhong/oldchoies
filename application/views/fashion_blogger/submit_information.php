    ...
    function AddNewRow() {
        ...
        for (var i = 0; i < columnLength; i++) {
            if (i == 0) {//第一列:序号
                ...
                newTR.insertCell(i).innerHTML = "<label><span class='red mb10'>*</span> Main Site Type: </label><select id='type_"+i+"' name='sites[type][]'><option value='Look Book'>Look Book</option><option value='Personal Blog'>Personal Blog</option><option value='Facebook'>Facebook</option><option value='Youtube'>Youtube</option><option value='Chictopia'>Chictopia</option><option value='Pinterest'>Pinterest</option><option value='Instagram'>Instagram</option><option value='Tumblr'>Tumblr</option><option value='Twitter'>Twitter</option></select><br><label><span class='red'>*</span> Main Site URL: </label><input type='text' id='url_"+i+"' name='sites[url][]' class='sub_info_text' style='margin-right:3px;' /><label><span class='red'>*</span> Fans/ Followers: </label><input type='text' id='flow_"+i+"' name='sites[flow][]' class='sub_info_text2 mb10' style='width:120px; margin-left:5px;' />";
            }
            else if (i >= 2) {
        ...
        lastTd.innerHTML = "<div align='left' style='width:40px;'><a href='javascript:' onclick=\"DeleteSignRow('SignItem" + rowID + "')\">Delete</a></div>";
        //将行号推进下一行
...
<section id="main">
    ...
    <section class="layout fix">
        <div class="tit blogger_wanted mb25"><img src="/images/blogger_wanted3.png" /></div> 
        <?php echo Message::get(); ?>
        <article style="margin-top:30px;background: #fff;">
            <div class="fashion_tit" style="margin-left:39px">Submit Information</div>
            <div class="fll" style="padding-left:70px;">
                <div class="sub_info">
                    <form action="" method="post" id="submitInfo" class="form">
                        <ul>
                            <li>
                                <label style="margin-left:38px"><span class="red">*</span> Email Address:</label>
                                <input type="text" id="email" name="email" class="sub_info_text" />
                                <span class="errorInfo"></span>
                            </li>
                            <li>
                                <label style="margin-left:38px"><span class="red">*</span> Gender:</label>
                            ...
                            <li>
                                <label style="margin-left:38px"><span class="red">*</span> Country:</label>
                                ...
                                <div style="overflow: auto; width:100%; padding:0 10px; float:left">
                                    <table cellpadding="1" id="tab" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <label><span class="red mb10">*</span> Main Site Type: </label>
                                                ...
                                                <br/><label><span class='red'>*</span> Main Site URL: </label>
                                                <input type='text' id='url' name='sites[url][]' class='sub_info_text' />
                                                <label><span class='red'>*</span> Fans/ Followers: </label>
                                    ...
                                    <table cellpadding="1" cellspacing="0" style="text-align: center; display:block;">
                                        <tr>
                                            <td>
                                                <input type="button" name="Submit" class="add_more" style=" margin-left:139px;" value="add one more site" onclick="AddNewRow()" />
                                            </td>
                                            <td>
                            ...
                            <li>
                                ...
                                <textarea name="comment" id="input_comment" rows="10" class="input textarea sub_info_text3" onblur="this.value=(this.value=='')?'Write something to intraduce yourself ,and what\'s your idea about fashion. Thank you !':this.value" value="Write something to intraduce yourself ,and what’s your idea about fashion. Thank you !" onfocus="this.value=(this.value=='Write something to intraduce yourself ,and what\'s your idea about fashion. Thank you !')?'':this.value">Write something to intraduce yourself ,and what's your idea about fashion. Thank you !</textarea>
                            </li>
                            <li>
                                <input type="submit" id="inforSubmit" class="form_btn view_btn btn30_14_red" style="width: 100px;" value="SUBMIT"/>
                            </li>
                        </ul>
                        <script type="text/javascript">
                            $("#submitInfo").validate({
