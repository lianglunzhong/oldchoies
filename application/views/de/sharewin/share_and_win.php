        ...
        $.ajax({
            ...
            success:function(json){
                if(json==1){
                    ...
                    alert('Anmelden Fehler, versuchen Sie es bitte noch einmal.');
                }
            }
        })
    }
                ...
                $.ajax({
                    ...
                    success:function(result){
                        if(result.status==2||result.status==1){
                            if(result.status==2){
                                alert("Es tut uns leid, dass Sie diesen Artikel bereits geteilt haben!");
                                return false;
                            }else{
                                if(rep.length != 0){
                                    ...
                                    $("#facebook_input_goods_id").val(goods_id);
                                    $("#facebook_input_comment").val('');
                                    alert("Sie müssen auf „Gefällt mir“ klicken(Schritt 1).");
                                    return false;
                                }
                            }
...
function set_facebook_share() {
    ...
    if (con_ent.length < 20) {
        $("#post_facebook_error").html("Ihr Kommentar soll nicht weniger als 20 Zeichen sein.");
        $("#post_facebook_error").show();
        return false;
    }else if(goods_id == 0 || isNaN(goods_id)){
        $("#post_facebook_error").html("Dieses Produkt existiert nicht.");
        $("#post_facebook_error").show();
        return false;
    }else{
...
<section id="main">
  ...
  <div class="layout">
    <div class="crumbs fix">
      <div class="fll"><a href="/">HOMEPAGE</a>  >  Teilen und Gewinnen</div>
      <div class="flr"></div>
    </div>
  </div> 
  <section class="layout fix">
    <div><img src="/images/de/share_01.jpg" height="282px" width="1024px" /></div>
    <script type="text/javascript" >
  $(function(){
    ...
    <div class="tab mt20">
      <div class="tab_menu">
        <ul>
          <li class="selected">Beliebteste dieser Woche</li>
          <li>Top 10 Beliebteste</li>
      ...
      <div class="tab_box"> 
         <div class="swrapp">
           <div class="fll">
             <h3>BELIEBTESTE DIESER WOCHE</h3>
             <div class="s4">
             <ul>
            ...
            $qty=$val['qty'];
              ...
              ?>
               <li>
                 ...
                 <div class="mt10 smi">
                   <p><strong><?php echo $qty; ?></strong> haben es geteilt!</p>
                   <p>Wollen Sie es KOSTENLOS erhalten?</p>
                   <p class="mt10"><a href="javascript:;" onclick="show_facebook_div_to('<?php echo $product->get('id'); ?>');"><img src="http://www.choies.com/images/de/share_win.png"/></a></p>
                 ...
                 <div class="mt10" style="height:105px">
                  ...
                  <p class="sbuy"><a href="<?php echo $link; ?>">JETZT KAUFEN</a></p>
                 </div>
               </li> 
               <?php }} ?>              
             </ul>
           ...
           <div class="fll">
             <h3><i>Liste der Gewinnern</i></h3>
             <div class="fbr ">
               <div class="prize_info">Jede Woche, wir wählen nach dem Zufallsprinzip drei Gewinnern aus allen Kunden, die die meisten geteilten Artikel innerhalb einer Woche angeklickt haben. Der Hauptpreis wird die meisten geteilten Artikel sein, auf der sie geklickt haben. Falls Ihre Facebook Freunde Ihre Post angeklickt haben und sich in diesem Spiel beteiligten, wenn sie einen Preis gewinnen, werden Sie ihn auch gewinnen.</div>
               <ul id="share_winner">
         ...
         <div class="swrapp hide">
           ...
           <?php foreach($allproducts as $value){
            ...
            $qty=$value['qty'];
             ...
             <li>
               <div><a href="<?php echo $link; ?>"><img src="<?php echo Image::link($product->cover_image(), 2); ?>" width="240px" height="320px" /></a></div>
               <p class="mt10"><strong><?php echo $qty; ?></strong> haben es geteilt!</p>
               <p class="mt5"><a href="javascript:;" onclick="show_facebook_div_to('<?php echo $product->get('id'); ?>');"><img src="/images/de/share_win.png"/></a></p>
             </li>
             <?php }}?>
           </ul>
           </div>
         ...
         <div class="swrapp hide">
           <h3>AGB</h3>
           <h4>1. Wie nehmen Sie Choies Giveaway Aktivität teil?</h4>
           <p>Sie können jeden Artikel wählen, den Sie möchten, und gehen Sie in die Produktdetailseite.</p>
           <p>Klicken Sie einfach auf "Teilen und Gewinnen" Taste auf alle Artikel, die Sie möchten, befolgen Sie den Anweisungen:</p>
           <p>Zuerst klicken Sie „Gefällt mir“ auf unsere Facebook Seite, dann teilen Sie den Artikel über Facebook.</p>
           <p>Die drei Gewinnern werden nach dem Zufallsprinzip aus allen Kunden gewählt, die die meisten geteilten Artikel geteilt haben, und der Preis wird die meisten geteilten Artikel sein, auf der sie geklickt haben..</p>
           <h4>2. Wie wählen wir den Gewinner?</h4>
           <p> Wir wählen zufällig drei Gewinnern aus allen Kunden, die die beliebtesten Artikel teilten. Falls Ihre Facebook Freunde Ihre Post teilen und sich in dieser Veranstaltung beteiligen, und wenn sie den Preis gewinnen, gewinnen Sie ihn auch. Es ist wirklich so einfach!</p>
           <p> Tipp: Um Ihre Chancen(Ihr Lieblingsprodukts kostenlos gewinnen) zu verbessern, teilen Sie sich die Artikel mit so vielen Freunden wie möglich!</p>
           <h4>3. Wie schicken wir den Preis an die Gewinnern?</h4>
           <p> Die Gewinnern werden jeden Mittwoch auf dieser Seite bekannt gegeben werden, denken Sie bitte daran, wieder zu kommen und zu überprüfen! Drei Gewinnern werden auch per E-Mail benachrichtigt und darüber informiert, wie Sie Ihre Preise zurücknehmen. Produktberichte werden aufgefordert, nachdem die Gewinnern den kostenlosen Artikel erhalten. (Exzellente Berichte werden Ihnen mehr Chancen bringen, um mehr kostenlosen Artikel beim nächsten Mal zu gewinnen.) Wir würden sehr froh sein, wenn die Gewinnern Bilder ihrer Preisen auch auf Facebook Seite veröffentlichen, sodass andere Menschen sie sehen können. Diejenigen, die Text und Foto Rezension liefern oder ein Post auf Facebook senden, werden 500 Choies Punkte vergeben werden.</p>
         </div>
      </div>
    </div> 
...
<div class="share1 wwrapper" id="share" style="display:none;">
  ...
  <div class="wcontent">
    <h3>Führen Sie die folgenden Schritte aus, um kostenlosen Artikel zu gewinnen</h3>
    <div class="wwp">
      <div class="fll mt5"><img src="/images/de/step_01.jpg" /></div>
      <div class="fll ml10">
        <h4>Klicken Sie auf „Gefällt mir“ auf Facebook</h4>
        <div class="wc mt5">
        ...
        <p class="red mt10">* Erinnern Sie sich, auf „Gefällt mir“ zu klicken im ersten Schritt</p>
      </div>
    </div>
    <div class="wwp">
      <div class="fll mt5"><img src="/images/de/step_02.jpg" /></div>
      <div class="fll ml10">
        <h4>Diesen Artikel Teilen</h4>
        <div class="wc mt5"><a href="javascript:;" onclick="show_facebook_div();"><img src="/images/de/share_fb.jpg" /></a></div>
      </div>
    </div> 
    <div class="wwp">
      <div class="fll mt5"><img src="/images/de/step_04.jpg" /></div>
      <div class="fll ml10">
        <h4>Warten Sie auf Gewinnerliste an jedem Mittwoch</h4>
        <div class="wc mt5"><img src="/images/de/step_06.jpg"></div>
      </div>
    </div>
  </div>
</div>
<div class="share_success" id="share1" style="display:none;">
    ...
    <div style="margin:0 50px;">
        <h5 class="clear"><strong>TeilenSie dies mit Ihren Freunden auf Facebook</strong></h5>
...
<div class="share_success" id="share2" style="display:<?php echo $show_success ? 'inline' : 'none' ?>;">
    ...
    <div class="suc" style="background:url(/images/freebie/bg_success.jpg) bottom no-repeat;">
        <p style="font:48px/58px Georgia, 'Times New Roman', Times, serif;">Herzlichen Glückwunsch!</p>
        <p style="font-size:16px; font-weight:bold;">Sie haben diese 2 Aufgaben erfolgreich abgeschlossen.</p>
        <p style="color:#900;">Sie werden per Ihr Facebook Konto E-Mail benachrichtigt werden, wenn Sie gewinnen.</p>
    </div>
</div>