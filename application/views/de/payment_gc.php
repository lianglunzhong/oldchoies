<style> 
    ...
    #payment_wrap .payment_ul li { float:left; margin-right:8px; line-height: 15px;}
                    ...
                    <div>
                        ...
                        <div id="payment_wrap">
                            ...
                            <div class="payment_p">
                                ...
                                <p class="payment_message_p">Bitte wählen Sie einen Kartentyp, füllen Sie die unten stehenden Informationen, und klicken Sie auf "JETZT BEZAHLEN".<br>
                                <span style="font-weight:bold;font-style: italic;">Hinweis</span>: Aus Sicherheitsgründen werden wir keine Ihre Kreditkartendaten sparen.</p>
                                <form action="" id="sendFrm" name="send" method="post" autocomplete="off" onsubmit="return checkFormData();">          
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="payment_td_right"><em>*</em>Zahlungsmethode:</td>
                                                <td>
                                                    <ul class="payment_ul">
                                                        <ul class="cad">
                                                            <li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="error" id="cvv_error">Bitte geben Sie eine dreistellige CVV2-Code ein.</div>
                                                </td>
                                                <td class="c_red">&nbsp;</td>
                                            </tr>
                                        </tbody>
                ...
                <div class="order_summary flr">
                    <div class="cart_side">
                        ...
                        <ul class="total">
                            ...
                            <li class="fwb"><i>Zusätzliche Zahlungssicherheit mit:</i><img src="/images/card11.jpg"></li>
                        </ul>
                    </div>
                </div>
            </section>
