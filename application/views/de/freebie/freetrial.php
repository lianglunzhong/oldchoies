...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Homepage</a>  >  Free Trial</div>
        </div>
    </div>
    ...
    <section class="layout fix">
        <section id="container" class="flr">
            ...
            <div class="trial_winners">
                <h3>GEWINNER IN LETZTER WOCHE</h3>
                <ul class="fix">
                    <?php
                ...
                <p><a href="mailto:lisaconnor@choies.com" class="a_red" title="Mail to Lisa">Lisa</a> wird Ihnen später mit den Details kontaktieren.</p>
            </div>
            ...
            foreach ($products as $k => $pid):
                ...
                <div class="report_details fix">
                    ...
                    <div class="right">
                        ...
                        <dl>
                            <dt class="fix">
                            <span class="left">KOSTENLOSE PROBE</span>
                            <!-- time left -->
                            ...
                            <dd>
                                <ul class="price">
                                    <li>
                                        <span>Preis: <del><?php echo Site::instance()->price($product->price(), 'code_view'); ?></del></span>
                                        <label class="f00">$0.00</label></li>
                                    <li><span>Versandkosten:</span> <label class="f00">$0.00</label></li>
                                    <li class="m">
                                        <span><em class="f00"><?php echo $chances[$k]; ?></em> Chancen<?php echo $chances[$k] > 1 ? 's' : ''; ?></span>
                                        <label><em class="f00"><?php echo $quantitys[$pid]; ?></em> Applikationen</label>
                                    </li>
                                    <li><a href="javascript:;" onclick="show_facebook_div('<?php echo $pid; ?>','1');" class="view_btn btn26 btn40">KOSTENLOS BEWERBEN</a></li>
                            ...
                            <dt>BEGIERIG ZU BEKOMMEN</dt>
                            <dd>
                                <p>Kann nicht warten, um eins zu bekommen?</p>
                                <p><a href="<?php echo $link; ?>" class="view_btn btn26 btn40">JETZT KAUFEN</a></p>
                            </dd>
                            <dt>BESCHREIBUNG:</dt>
                            <dd>
                                <dl>
            ...
            <div class="trial_report">
                    ...
                    if (!empty($reports)):
                        ...
                        foreach ($reports as $report):
                            ...
                            <li>
                                ...
                                <a href="<?php echo LANGPATH; ?>/freetrial/reports/<?php echo $report['id']; ?>" class="view_btn btn26 btn40">DETAILS SEHEN</a>
                            </li>
                            <?php
                        endforeach;
                    endif;
                ...
                <div class="bottom"><a href="<?php echo LANGPATH; ?>/freetrial/reports">MEHR SEHEN >></a></div>
            </div>
        </section>
...
<div class="share1" id="share" style="display:none;">
    ...
    <div class="clear">
        <h2 style="font-size: 21px;">Vervollständigen Sie die 2 Aufgaben unten<br/>um eine Chance zu haben, kostenlose Probe zu gewinnen!</h2>
    </div>
    <div class="share_main">
        <div class="fix">
            <div class="task_num" style="line-height:114px;">Aufgabe 1</div>
            <div class="task_share">
                <p>Gefällt uns auf Facebook</p>
                <img src="/images/choies_fblogo.jpg"/>
                <span>Choies Straße Fashion Sketch</span>
                ...
                <p id="trial_facebook_like_error" class="error">Sie müssen zuerst „Gefällt mir" klicken.(Schritt 1).</p>
            </div>
        </div>
    </div>
    <div class="share_main">
        <div class="fix">
            <div class="task_num" style="line-height:90px;">Aufgabe 2</div>
            <div class="task_share">
                <p>Teilen Sie diese kostenlose Probe</p>
...
<div class="share_success" id="share1" style="display:none;">
    ...
    <div style="margin:0 50px;">
        <h5 class="clear" style="padding-top:0;"><strong>Teilen Sie dies mit Ihren Freunden auf Facebook</strong></h5>
