...
<div class="page">
    ...
    <?php if ($previous_page !== FALSE): ?>
        <a href="<?php echo $page->get_url($previous_page); ?>" class="prev_btn1" rel="nofollow">FRÜHER</a>
    <?php endif; ?>
    <?php
    if ($total_pages < 8)
    {
    ...
    <?php if ($next_page !== FALSE): ?>
        <a href="<?php echo $page->get_url($next_page); ?>" class="next_btn1" rel="nofollow">NÄCHSTE</a>
    <?php endif; ?>
</div>
<?php endif; ?>
