    ...
    <div class="layout">
        ...
        <div class="cart_step">
            ...
            <div class="cart_step_bottom">
                <span class="on">VERSAND & LIEFERUNG</span>
            ...
            <article class="shipping_delivery_left fll">
                            ...
                            <dd>
                                <ul class="shipping_address">
                                    ...
                                    foreach ($addresses as $key => $value)
                                    {
                                        ...
                                        <li class="fix JS_shows_btn1">
                                            <div class="fix">
                                                ...
                                                <label for="radio<?php echo $key; ?>"><b class="s1">Adresse<?php echo $key + 1; ?></b></label>
                                                <div class="flr address_edit JS_shows1">
                                                    ...
                                                    if ($key == $default_key)
                                                    {
                                                        ...
                                                        <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">EDITIEREN</a>
                                                        <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Löschen</a>
                                                        <?php
                                                    }
                                                    else
                                                    {
                                                        ?>
                                                        <a href="<?php echo LANGPATH; ?>/address/set_default/<?php echo $value['id']; ?>" class="a_underline">Set Default</a>
                                                        <a href="#" class="btn22_black JS_popwinbtn1 edit_address" id="<?php echo $value['id']; ?>">EDITIEREN</a>
                                                        <a href="#" class="btn22_gray delete_address" title="<?php echo $value['id']; ?>">Löschen</a>
                                                        <?php
                                                    }
                                    ...
                                    <li class="fix last">
                                        ...
                                        <label for="radionew" class="a_underline add_new font14">+NEUE ADRESSE HINZUFÜGEN</label>
                                    </li>
                                </ul>
                            </dd>
                        </dl>
                    ...
                    <div class="shipping_methods">
                        <ul class="fix">
                            ...
                            foreach ($site_shipping as $key => $price):
                                ...
                                $ship_name = str_replace(array('Working Day Shipping'), array('Arbeitstage Versand'), $price['name']);
                                ?>
                                <li>
                        ...
                        <p>
                            <input type="submit" value="ZU SICHERN KASSE" class="btn40_16_red" />
                        </p>
                    </div>
                </form>
                ...
                <div id="edit_address" class="JS_popwincon2 popwincon popwincon_user hide">
                    ...
                    <form action="<?php echo LANGPATH; ?>/cart/edit_address" method="post" class="form user_share_form user_form form1">
                        ...
                        <div class="center" style="margin-left: -63px;"><input type="submit" value="SENDEN" class="btn30_14_black" /></div>
                    </form>
                </div>
            </article>
