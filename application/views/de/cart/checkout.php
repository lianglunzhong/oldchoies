    ...
    <form action="<?php echo LANGPATH; ?>/cart/edit_shipping" method="post" class="form user_share_form user_form" onsubmit="return setShipping(this);">
        ...
        <div class="shipping_methods s_price_list">
            <ul class="fix">
                ...
                {
                    $name1 = '4-7 Arbeitstage Express Versand';
                    $site_shipping[1]['name'] = $name1;
					$name2 = '10-15 Arbeitstage Kostenloser Versand';
        ...
        <section class="cart fix">
            <article class="shipping_delivery_left">
                ...
                if ($show_address)
                {
                    ...
                    <div id="shippingAddressInfo" <?php if (!$show_address) echo 'style="display:none;"'; ?>>
                        <div class="information_con">
                            ...
                            ?>
                                <dt>
                                    Lieferadresse  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address(<?php echo $cart['shipping_address']['shipping_address_id']; ?>, 1);">Editieren</a>
                                    <?php
                                    if($count_address > 1)
                                    {
                                    ?>
                                        <a href="javascript:;" class="a_red" onclick="return change_address_show();">Wechseln</a>
                                    <?php
                                    }
                                    ?>
                                </dt>
                            ...
                            <dl>
                                <dt>Versandarten   <a href="javacript:;" class="a_red JS_popwinbtn2" id="ship_edit" <?php if(in_array($cart['shipping_address']['shipping_country'], $no_express_countries)) echo 'style="display:none;"'; ?>>Editieren</a></dt>
                                <dd>
                                    Versand:
                    ...
                    <dl class="shipping_add_address">
                        ...
                        <form action="" method="post" name="shipping_address_radio">
                                        ...
                                        <label for="radio<?php echo $key; ?>">
                                            ...
                                            if ($key == $default_key)
                                            {
                                                ?>
                                                    ...
                                                    <a href="javascript:;" class="a_underline address_detault_a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);" style="display:none;">Als Default festlegen</a>
                                                    <a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Editieren</a>
                                                    <a href="javascript:;" class="view_btn btn26 delete_address" onclick="delete_address(<?php echo $value['id']; ?>);">Löschen</a>
                                                <?php
                                            }
                                            else
                                            {
                                                ?>
                                                    ...
                                                    <a href="javascript:;" class="a_underline address_detault_a" id="address_detault_<?php echo $value['id']; ?>" onclick="default_address(<?php echo $value['id']; ?>);">Als Default festlegen</a>
                                                    <a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address(<?php echo $value['id']; ?>, 1);">Editieren</a>
                                                    <a href="javascript:;" class="view_btn btn26 delete_address" onclick="delete_address(<?php echo $value['id']; ?>);">Löschen</a>
                                                <?php
                                            }
                            ...
                            <ul class="shipping_address" style="margin: 0;padding: 0 10px 10px 10px;">
                                <li class="fix last">
                                    <a href="javascript:;" class="a_underline JS_popwinbtn1" id="add_new_address" onclick="return new_address_show();">+NEUE ADRESSE HINZUFÜGEN</a>
                                </li>
                            </ul>
                            </form>
                        </dd>
				...
				<p class="phone_tips">Bitte geben Sie Ihre Postleitzahl ein (oder 0000, wenn keine Postleitzahl in Ihrem Land erforderlich ist).</p>	
                        ...
                        <p><input id="spgInfoCountinue" type="submit" value="ZU SICHERN KASSE" class="view_btn btn40 font18" /></p>
                    </form>
                </div>
                <div id="paymentInfo" <?php if(!$has_address) echo 'style="display:none;"'; ?>>
                    <h3 class="mt50">BEZAHLUNG</h3>
                    <div class="shipping_bottom_line">
                        <div class="arrow-down"></div>
                    </div>
            ...
            <div class="order_summary flr">
                ...
                <ul class="total">
                    ...
                    <li><label>Verpackung & Versand: </label><span id="shipping_total"><?php echo $cart_shipping == -1 ? Site::instance()->price($site_shipping[2]['price'], 'code_view') : Site::instance()->price($cart_shipping, 'code_view'); ?></span></li>
                    <?php
                    ...
                    <li id="coupon_points_save" <?php if(!$coupon_points_save) echo 'style="display:none;"'; ?>>
                        <label>Gutscheine & Punkte eingelöst: </label><span id="save_total"><?php echo Site::instance()->price($cart['amount']['coupon_save'] + $cart['amount']['point'], 'code_view'); ?></span>
                    </li>
                    <?php
                    ...
                    ?>
                    <li class="total_num font14"><label>Gesamtbetrag: </label><span id="totalPrice" class="font18"><?php echo $cart['amount']['shipping'] ? Site::instance()->price($cart['amount']['total'], 'code_view') : Site::instance()->price($cart['amount']['total'] + $default_shipping, 'code_view'); ?></span></li>
                    <?php
                    $saving += $p_saving;
                    if($saving <= 0)
                        $saving = 0;
                    ?>
                    <li class="last red"><label>Sparend: </label><span id="cart_saving"><?php echo Site::instance()->price($saving, 'code_view'); ?></span></li>
                        
                </ul>       
                <div class="promo-choies">
                    <ul>
                        <li class="promo-code">
                            <div class="pc-apply">Haben Sie einen Promotion Code?<a href="javascript:;" title="Bewerben Sie es jetzt">Bewerben</a>
                            ...
                            <div class="pc-ibutton" style="display:none;">
                                <form method="post" action="/cart/set_coupon" onsubmit="return setCoupon();">
                                    ...
                                    <button type="submit" class="btn-promo-code btn22_black flr">BEWERBEN</button>
                                </form>
                                <a class="J_pop_btn a_underline flr">Codeliste</a>
                                <!-- codelist_con -->
                        ...
                        <li class="promo-code">
                            <div class="pc-apply">Haben Sie Choies Punkte? <a href="javascript:;" title="Verwenden Sie es jetzt">Verwenden</a>
                                <em class="icon_tips JS_shows_btn1">
                                    <span class="JS_shows1 icon_tipscon hide" style="display: none;">Sie können Punkte bis zu insgesamt 10% des Auftragswertes anwenden.<br> Vervollständigen Sie Ihr Profil, werden Sie 500 Punkte erhalten, um Ihre erste Bestellung zu machen.</span>
                                </em>
                            </div>
                            <div class="pc-ibutton" style="display:none;">
                                <form method="post" action="/cart/point" class="form" id="point_form" onsubmit="return setPoints();">
                                    ...
                                    <button type="submit" class="btn-promo-code btn22_black flr" onclick="return point_redeem();">WECHSELN</button>
                                </form>
                                ...
                                Speichern: <span class="red">$ <span  id="dollar">0</span></span><br>
                                    ...
                                    ?>
                                    <a class="a_underline JS_popwinbtn" style="display: inline;">VIP Politik</a>
                                </div>
                ...
                <div class="additional-payment mt30">
                    <p>Zusätzliche Zahlungssicherheit mit:</p>
...
<div class="JS_popwincon1 popwincon popwincon_user hide" id="new_address_list">
    ...
    <form onsubmit="return update_address(this);" method="post" class="form user_share_form user_form form1">
        ...
        <ul class="add_showcon_boxcon">
            ...
            <li>
              <label>&nbsp;</label>
              <div class="right_box"><input type="submit" value="BESTÄTIGEN" class="btn30_14_black" /></div>
            </li>
        </ul>
        </form>
</div>
<div class="hide" id="cart_delete" style="position: fixed;padding: 10px 10px 20px; top: 170px;left: 400px; z-index:100px;z-index: 1000; background: #FFFFFF; border-color: #F6F6F7; border:1px solid #cdcdcd;">
    <div style="font-size: 1.4em;margin-top:0px;border-bottom: 2px solid #F4F4F4;">AKTION BESTÄTIGEN</div>

    <div class="order order_addtobag center" style="margin:20px;">
        <div style="font-size:13px;margin-bottom: 20px;">Sind Sie sicher, dass Sie diese Adresse löschen wollen? Es kann nicht rückgängig gemacht werden.</div>
        <form action="<?php echo LANGPATH; ?>/cart/delete_address" method="post" id="delete_address_form" onsubmit="return delete_address_submit();">
            ...
            <input type="submit" class="btn30_14_black" value="LÖSCHEN" />
            <a href="" class="cancel" style="text-decoration:underline;margin-left:10px;" onclick="return delete_close();">Abbrechen</a>
        </form>
    </div>
            ...
            success: function(result){
                if(result.success == 1){
                    ...
                    if(result.count_address > 1)
                        change = '<a href="javascript:;" class="a_red" onclick="change_address_show();">Wechseln</a>';
                    var shipping_address_list = '<dt>Lieferadresse  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address('+result.address_id+');">Editieren</a>'+change+'</dt>'+
                                                ...
                                                '<label for="radio'+result.count_address+'">'+
                                                    ...
                                                    '<div class="flr">'+
                                                        '<span class="b address_detault" id="detault_'+result.address_id+'" style="display:none;">Default</span>'+
                                                            ...
                                                            '<a href="javascript:;" class="view_btn btn40 JS_popwinbtn1" onclick="edit_address('+result.address_id+', 1);">Editieren</a>'+
                                                            '<a href="javascript:;" class="view_btn btn26 delete_address" onclick="delete_address('+result.address_id+');">Löschen</a>'+
                                                    '</div>'+
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            if(res.count_address > 1)
                change = '<a href="javascript:;" class="a_red" onclick="change_address_show();">Wechseln</a>';
            var shipping_address_list = '<dt>Lieferadresse  <a href="javascript:;" class="a_red JS_popwinbtn1" onclick="return edit_address('+res.shipping_address_id+');">Editieren</a>'+change+'</dt>'+
