        ...
        <div class="icontainer">
            <div class="login">
                ...
                <div class="cart_paypal">
                    <h2>Ihre Bestellnummer: <span><?php echo $ordernum; ?></span><img src="/images/loading1.gif" /></h2>
                    <p>Die Bezahlung Seite wird geladen zu kommen, es wird ein paar Sekunden oder länger dauern.</p>
                    <p>Bitte gehen Sie nicht aus, Ihre Anfrage wird bearbeitet.</p>
                    <p>Die Artikel(n), die Sie wählen, sind sehr beliebt, und werden nur für begrenzte Zeit reserviert, verpassen Sie nicht!</p>
                    <p class="bottom">Bitte fühlen Sie sich frei und kontaktieren Sie uns zu jederzeit <a href="mailto:service_de@choies.com">service_de@choies.com</a></p>
                </div>
                <div class="message">
