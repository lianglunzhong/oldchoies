...
<section id="main">
    <div class="layout" style="margin-top:30px;background: #fff;">
        ...
        <div class="fashion_policy">
            ...
            <p>Wenn Sie ein YouTube-Konto haben, wo Banner nicht zulässig ist, stattdessen können Sie unseren Link <a href="<?php echo LANGPATH; ?>/" title="choies.com" class="red"><?php echo BASEURL ;?></a> hinzufügen.</p>
        </div>
