...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">Homepage</a>  >  Halloween Match</div>
        </div>
                                        ...
                                        <li>
                                                ...
                                                <div class="share_con">
                                                        <p>
                                                                ...
                                                                <a rel="nofollow" target="_blank" class="share1"  href="http://www.facebook.com/sharer.php?u=<?php echo urlencode(BASEURL . '/activity/halloween_match'); ?>"> FACEBOOK</a>
                                                                <a rel="nofollow" target="_blank" class="share2"  href="http://twitter.com/share?url=<?php echo urlencode(BASEURL . '/activity/halloween_match'); ?>"> TWITTER</a>
                                                                <a rel="nofollow" target="_blank" class="share3"  href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(BASEURL . '/activity/halloween_match'); ?>&media=BASEURL . /images/activity/match_img1.jpg&description=<?php  echo urlencode("Choies \"Let's Play & Win\" Season 2 --- Play the game and win free items + points ! Don't miss it!"); ?>"> PIN IT</a>
                                                        </p>
