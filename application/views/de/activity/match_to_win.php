...
<!--                                                <div class="bottom">SKU of the item that you match:<input type="text" name="sku3" value="" class="text" /></div>-->
                    ...
                    <?php $domain = Site::instance()->get('domain'); ?>
                                                                                    ...
                                                                                    <a rel="nofollow" target="_blank" class="share3"  href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(BASEURL . '/activity/matchtowin'); ?>&media=BASEURL . /images/activity/match_img1.jpg&description=<?php echo urlencode("Choies \"Let's Play & Win\" Season 2 --- Play the game and win free items + points ! Don't miss it!"); ?>"> PIN IT</a>
                                                                            </p>
