...
<section id="main">
    ...
    <div class="grid">     
        ...
        <div class="fix"></div>
        	...
        	<p><img src="/images/activity/listbanner_de.jpg" width="1024" height="300"></p>
            <div class="easter-day-filter">
                <p class="filter-instruction">BUNTE ARTIKEL FÜR OSTERN KAUFEN</p>
                <ul class="filter-main detail-tab fix">
                    <li class=" current" style="width: 137px;margin: 45px 0 -30px 80px;" id="Blue">BLAU</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Green">GRÜN</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Pink">ROSA</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Yellow">GELB</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="White">WEISS</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Purple">LILA</li>
                    <p style="left: 78px;">
                        <b></b>
                    </p>
                </ul>
