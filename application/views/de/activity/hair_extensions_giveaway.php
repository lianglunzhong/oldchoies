...
<!--                                <div>
                                ...
                                <div><img src="/images/activity/winner_list5.jpg" /></div>
<!--                                <div class="step1">
...
<!--                                                <div style="font:1.5em/1.8em Arial, Helvetica, sans-serif; border-bottom:#CCC 3px solid; margin-bottom:5px;">Prizes for the Giveaway:</div>
                                                <ul class="fix" id="product">
                                                        <li><a href="#" title="WIGEX00075-3"><img src="/images/activity/WIGEX00075-3.jpg" alt="WIGEX00075-3"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00075-3" />
                                                                        WIGEX00075-3</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00070-3"><img src="/images/activity/WIGEX00070-3.jpg" alt="WIGEX00070-3"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00070-3" />
                                                                        WIGEX00070-3</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00070-5"><img src="/images/activity/WIGEX00070-5.jpg" alt="WIGEX00070-5"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00070-5" />
                                                                        WIGEX00070-5</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00075-5"><img src="/images/activity/WIGEX00075-5.jpg" alt="WIGEX00075-5"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00075-3" />
                                                                        WIGEX00075-5</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00070-9"><img src="/images/activity/WIGEX00070-9.jpg" alt="WIGEX00070-9"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00070-9" />
                                                                        WIGEX00070-9</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00070-8"><img src="/images/activity/WIGEX00070-8.jpg" alt="WIGEX00070-8"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00070-8" />
                                                                        WIGEX00070-8</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00075-7"><img src="/images/activity/WIGEX00075-7.jpg" alt="WIGEX00075-7"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00075-7" />
                                                                        WIGEX00075-7</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00070-10"><img src="/images/activity/WIGEX00070-10.jpg" alt="WIGEX00070-10"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" name="SKU" value="WIGEX00070-10" />
                                                                        WIGEX00070-10</div>
                                                        </li>
                                                        <li><a href="#" title="WIGEX00070-11"><img src="/images/activity/WIGEX00070-11.jpg" alt="WIGEX00070-11"/></a>
                                                                <div class="sku mt5">
                                        ...
                                        <img src="/images/activity/hair_banner.jpg" />
                                </div>
                                                ...
                                                <div class="shareto mt10">
                                                        <div class="fix mt15 ml10">
                                                                ...
                                                                <div class="fll mr10 ml5"><span class="shareto1 fll"></span>
                                                                        <a rel="nofollow" target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo urlencode(BASEURL . '/activity/hair_extensions_giveaway'); ?>"> FACEBOOK</a>                                                                </div>
                                                                <div class="fll mr10 ml5"><span class="shareto2 fll"></span><a rel="nofollow" target="_blank" href="http://twitter.com/share?url=<?php echo urlencode(BASEURL . '/activity/hair_extensions_giveaway'); ?>"> TWITTER</a></div>
                                                                <div class="fll mr10 ml5"><span class="shareto3 fll"></span><a rel="nofollow" target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(BASEURL . '/activity/hair_extensions_giveaway'); ?>&media=http://www.choies.com/images/activity/giveaway1.jpg&description=giveaway"> PIN IT</a></div>
                                                        </div>
...
<!--                                <div class="step4">
                                        ...
                                        <div><a href="https://www.facebook.com/choiescloth/app_200328890006489" target="_blank"><img src="/images/activity/enterbtn.jpg" width="760" height="100" /></a></div>
                                        <span class="red" style="margin-left: 88px;">(* To Get the Chance to win, you must take part in the Lucky Draw!)</span>
                                </div>
                                <div>
                                        <img src="/images/activity/goodluckbtn.jpg" width="760" height="95" usemap="#Goodluck" />
