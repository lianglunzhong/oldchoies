...
<section id="main">
	...
	<img src="/images/activity/skirt_looks/de_skirt_look.jpg" border="0" usemap="#Map" />
            <map name="Map" id="Map">
<area shape="rect" coords="0,0,510,299" href="<?php echo BASEURL ;?>/de/skirt?sort=1" />
<area shape="rect" coords="515,1,1023,298" href="<?php echo BASEURL ;?>/de/skirt?sort=2" />
            </map>
    </div>
    ...
    <div class="layout">
        ...
        <!--<div class="skirtban"><a target="_blank" href="<?php echo BASEURL ;?>/skirt?ap0926"><img src="/images/activity/skirt_looks/skirt-05.jpg" /></a></div>	-->
    </div>
</section>
