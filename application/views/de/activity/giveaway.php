...
<!--                                <div><img src="/images/activity/giveaway1.jpg" /></div>
                                ...
                                <div class="step2">
                                        ...
                                        <div class="pro pl90">
                                                <ul id="product">
                                                        <li><a href="#" title="CTZY0131"><img src="<?php echo BASEURL ;?>/pimages/36249/1.jpg" alt="CTZY0131" title="CTZY0131"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CTZY0131" name="SKU" />
                                                                        CTZY0131
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CDDL0188"><img src="<?php echo BASEURL ;?>/pimages/13745/1.jpg" alt="CDDL0188"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CDDL0188" name="SKU" />
                                                                        CDDL0188
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CSDL1820"><img src="<?php echo BASEURL ;?>/pimages/30139/1.jpg" alt="CSDL1820 "/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CSDL1820" name="SKU" />
                                                                        CSDL1820
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CDWC1087"><img src="<?php echo BASEURL ;?>/pimages/31783/1.jpg" alt="CDWC1087"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CDWC1087" name="SKU" />
                                                                        CDWC1087
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CSWC1210"><img src="<?php echo BASEURL ;?>/pimages/32759/1.jpg" alt="CSWC1210"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CSWC1210" name="SKU" />
                                                                        CSWC1210
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CDDL2231"><img src="<?php echo BASEURL ;?>/pimages/33594/1.jpg" alt="CDDL2231"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CDDL2231" name="SKU" />
                                                                        CDDL2231
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CDDL0457"><img src="<?php echo BASEURL ;?>/pimages/18448/1.jpg" alt="CDDL0457 "/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CDDL0457" name="SKU" />
                                                                        CDDL0457
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CDDL0292"><img src="<?php echo BASEURL ;?>/pimages/15833/1.jpg" alt="CDDL0292  "/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CDDL0292" name="SKU" />
                                                                        CDDL0292 
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CDDL0424"><img src="<?php echo BASEURL ;?>/pimages/36693/1.jpg" alt="CDDL0424"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CDDL0424" name="SKU" />
                                                                        CDDL0424
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CKWC1351"><img src="<?php echo BASEURL ;?>/pimages/33753/1.jpg" alt="CKWC1351"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CKWC1351" name="SKU" />
                                                                        CKWC1351
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CSZY0011"><img src="<?php echo BASEURL ;?>/pimages/42483/1.jpg" alt="CSZY0011"/></a>
                                                                <div class="sku mt5">
                                                                        <input type="radio" value="CSZY0011" name="SKU" />
                                                                        CSZY0011
                                                                </div>
                                                        </li>
                                                        <li><a href="#" title="CSDL2281"><img src="<?php echo BASEURL ;?>/pimages/34043/1.jpg" alt="CSDL2281"/></a>
                                                                <div class="sku mt5">
                                        ...
                                        <form id="giveawayForm" method="post" action="" class="formArea pl90">
                                                ...
                                                <div class="shareto mt10">
                                                        <div class="fix mt15 ml10">
                                                                ...
                                                                <div class="fll mr10 ml5"><span class="shareto3 fll"></span><a rel="nofollow" target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode('<?php echo BASEURL ;?>/activity/giveaway'); ?>&media=<?php echo BASEURL ;?>/images/activity/giveaway1.jpg&description=giveaway"> PIN IT</a></div>
                                                        </div>
