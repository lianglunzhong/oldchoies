...
<section id="main">
    ...
    <div class="w_index_free">
        <div class="layout index_free">
            ...
            if($user_id){?>
                <a href="<?php echo LANGPATH; ?>/vip-policy" class="a2">15% SPAREN BEI ERSTER BESTELLUNG</a>
            <?php }else{ ?>
    ...
    <article class="index_fashion layout">
        <div class="index_tit t1"><p><a href="<?php echo $index_banners[9]['link']; ?>"><span><b>MODESCHAU</b> DER KÄUFER</span> <span><?php echo $index_banners[9]['title'];  ?></span></a></p></div>
    ...
    <article class="rows_3 layout">
        <div class="index_tit t2 text_upper"><p><span><b>CHOIES</b></span> <span><b class="font18">BESONDERHEIT</b></span></p></div>
