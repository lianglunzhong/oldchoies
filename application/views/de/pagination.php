<div class="fix">
        <span class="pr-nums fll"><?php echo $total_items; ?> Rekord Gefunden</span>
        <div class="page flr">
                SEITE: 
                <?php if ($previous_page !== FALSE): ?>
                        <span class="prev_btn1"><a href="<?php echo $page->url($previous_page); ?>" rel="nofollow">FRÜHER</a></span>
                <?php endif; ?>
                <?php
                if ($total_pages < 8)
                {
                ...
                <?php if ($next_page !== FALSE): ?>
                        <span class="next_btn1"><a href="<?php echo $page->url($next_page); ?>" rel="nofollow">NÄCHSTE</a></span>
                <?php endif; ?>
        </div>
