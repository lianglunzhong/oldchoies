...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">home</a>  >  Free Trial</div>
        </div>
    </div>
                                ...
                                <ul class="fix JS_pro_small">
                                    ...
                                    foreach ($product->images() as $image):
                                        ...
                                        if ($key > 4)
                                            break;
                                        ?>
                                        <li class="<?php if ($key == 1) echo 'current'; ?>"><img src="<?php echo Image::link($image, 3); ?>" imgb="<?php echo Image::link($image, 2); ?>"/></li>
                                        <?php
                                    endforeach;
                                    ?>
                                </ul>
                        ...
                        <dl>
                            ...
                            <dd>
                                <ul class="price">
                                    ...
                                    <li>
                                        <a href="javascript:;" onclick="show_facebook_div('<?php echo $pid; ?>','1');" class="view_btn btn26 btn40">apply for free</a>
