...
<section id="main">
    ...
    <div class="layout">
        <div class="crumbs fix">
            <div class="fll"><a href="<?php echo LANGPATH; ?>/">home</a>  >  Freetrial Reports</div>
        </div>
                ...
                <div class="report_details fix">
                    ...
                    <div class="right">
                        <div class="right_top">
                            ...
                            <p class="price">Price Now: <?php echo Site::instance()->price($product->price(), 'code_view'); ?> <a href="<?php echo $product->permalink(); ?>" class="view_btn btn26 btn40">buy now</a></p>
                        </div>
                        <div class="right_trial">
                            <div class="right_tit"><h4>Trial Report</h4></div>
                            <div class="right_con">
