                ...
                <div id="main">
                        ...
                        <div class="help">
                                ...
                                <div class="corp-con">
                                        ...
                                        <h4>250*250</h4>
                                        <div><a class="join_us" href="#"><img src="<?php echo BASEURL ;?>/images/follow4.jpg" title="follow4" alt="Choies-The latest street fashion" /></a></div>
                                        <h4>300*250</h4>
                                        <div><a class="join_us" href="#"><img src="<?php echo BASEURL ;?>/images/follow5.jpg" title="follow5" alt="Choies-The latest street fashion" /></a></div>
                                        <h4>300*300</h4>
                                        <div><a class="join_us" href="#"><img src="<?php echo BASEURL ;?>/images/follow6.jpg" title="follow6" alt="Choies-The latest street fashion" /></a></div>
                                        <h4>Logo</h4>
                                        <div><a class="join_us" href="#"><img src="<?php echo BASEURL ;?>/images/logo.gif" title="Choies" alt="Choies-The latest street fashion" /></a></div>
                                </div>
                                <div class="tar mt20">
                                <?php
...
<script type="text/javascript">
        ...
        $(function(){
                $(".join_us").live("click",function(){
                        ...
                        var img = '<img src="<?php echo BASEURL ;?>/images/'+follow+'.jpg" title="Choies" alt="Choies-The latest street fashion" />'
                        var link_text = '<a href="<?php echo BASEURL ;?>">' + img + '</a>';
