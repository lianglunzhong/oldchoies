...
<section id="main">
    ...
    <div class="grid">     
        ...
        <div class="fix"></div>
        	...
        	<p><img src="/images/activity/easter-day-banner.jpg" width="1024" height="300"></p>
            <div class="easter-day-filter">
                <p class="filter-instruction">SHOP BY EASTER COLORS</p>
                <ul class="filter-main detail-tab fix">
                    <li class=" current" style="width: 137px;margin: 45px 0 -30px 80px;" id="Blue">BLUE</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Green">GREEN</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Pink">PINK</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Yellow">YELLOW</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="White">WHITE</li>
                    <li class="" style="width: 137px;margin: 45px 0 -1px 0;" id="Purple">PURPLE</li>
                    <p style="left: 78px;">
                        <b></b>
                    </p>
                </ul>
