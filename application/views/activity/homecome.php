<link rel="canonical" href="/<?php echo $catalog_link; ?>" />
	...
	<div class="grid">	
        ...
        <div class="homecoming-top">
        	<p><img src="/images/activity/homecoming-banner.jpg" width="1024" height="300"></p>
            <div class="homecoming-filter">
                <p class="filter-instruction">SHOP BY CATEGORIES</p>
                <ul class="filter-main detail-tab fix">
                    <li class=" current" id="a1" style="width: 198px;margin: 80px 0 -1px 215px;color:#a64384;">HOMECOMING DRESSES</li>
                    <li class="" id="a2" style="width: 198px;margin: 80px 0 -1px 0;color:#b75454;">PARTY SHOES</li>
