...
//                var_dump($access_token != $this->getApplicationAccessToken());
//                exit;
        ...
        protected function getFromUrl($url)
        {
                ...
                // rebuild
                return isset($parts['path']) ? $protocol.$parts['host'].$port.$parts['path'].$query : $protocol.$parts['host'].$port.$query;
        }

        public function getFromLoginUrl($url, $params=array( ))
        {
                $this->establishCSRFTokenState();
                $currentUrl = $this->getFromUrl($url);
