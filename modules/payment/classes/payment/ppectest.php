...
//			'VERSION' => Site::instance()->get('pp_api_version'),
            ...
            'RETURNURL' => BASEURL . '/payment/ppec_response_test',
            'CANCELURL' => Site::instance()->get('pp_cancel_return_url'),
            'NOTIFYURL' => BASEURL . '/payment/ppec_notify_test',
...
//        }
        ...
        kohana::$log->add('ppectest_url',$post_var);
...
//           $result = Toolkit::curl_pay_fk('local.manage.com/pp', $post_var);
            if(!$result)
            {
                try {
                    $local_directory = '/home/choies/project/www.choies.com/fengkong';
//                    $local_directory = 'D:/wamp/www/new.choies.com/fengkong/';
        ...
        kohana::$log->add('ppecttest_test',$result);
        return 'success';
...
//                $result = Toolkit::curl_pay('local.manage.com/pp', $post_var);
                kohana::$log->add('ppecttest_test',$result);
                if (is_array($result))
                {
