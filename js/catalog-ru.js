$(function(){
        ...
        $('.quick_view').live("click",function(){
            ...
            function(product)
            {
                ...
                {
                    $(".btn_size").html('');
                    $(".btn_size").append('<input type="hidden" name="attributes[Size]" value="" class="s-size" /><div id="select_size" class="mb10">Размеры:</div>');
                    var attribute = product['attributeSize'].replace('value="one size"', 'value="только один размер"');
                ...
                {
                    $(".btn_color").html('');
                    $(".btn_color").append('<input type="hidden" name="attributes[Color]" value="" class="s-color" /><div id="select_color" class="mb10">Выберите Цвет:</div>');
                ...
                {
                    $(".btn_type").html('');
                    $(".btn_type").append('<input type="hidden" name="attributes[Type]" value="" class="s-type" /><div id="select_type" class="mb10">Выберите Тип:</div>');
                ...
                {
                    $("#outofstock").html('(Теперь Только ' + product['stock'] + ' !)');
                }
        ...
        $(".btn_size input").live("click",function(){
            ...
            $("#select_size").html('Размеры: '+$(this).val());
        ...
        $(".btn_color input").live("click",function(){
            ...
            $(this).siblings().removeClass('btn_size_select');
            $(this).addClass('btn_size_select');
            $("#select_color").html('Цвет: '+$(this).val());
        })
        ...
        $('#addWishList').live("click",function(){
            ...
            window.location.href = '/ru/wishlist/add/'+id;
            return false;
        })
